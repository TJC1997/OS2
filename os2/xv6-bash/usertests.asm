...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
       9:	c7 44 24 04 96 51 00 	movl   $0x5196,0x4(%esp)
      10:	00 
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      24:	00 
      25:	c7 04 24 aa 51 00 00 	movl   $0x51aa,(%esp)
      2c:	e8 b1 3c 00 00       	call   3ce2 <open>
      31:	85 c0                	test   %eax,%eax
      33:	78 19                	js     4e <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
      35:	c7 44 24 04 14 59 00 	movl   $0x5914,0x4(%esp)
      3c:	00 
  ...
  close(open("usertests.ran", O_CREATE));
      ...
      55:	00 
      56:	c7 04 24 aa 51 00 00 	movl   $0x51aa,(%esp)
...
00000130 <iputtest>:
{
  ...
  printf(stdout, "iput test ok\n");
    ...
    printf(stdout, "mkdir failed\n");
     1a6:	a1 24 62 00 00       	mov    0x6224,%eax
     1ab:	c7 44 24 04 a8 41 00 	movl   $0x41a8,0x4(%esp)
     1b2:	00 
    ...
    printf(stdout, "chdir / failed\n");
     1c0:	a1 24 62 00 00       	mov    0x6224,%eax
     1c5:	c7 44 24 04 f3 41 00 	movl   $0x41f3,0x4(%esp)
     1cc:	00 
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1da:	a1 24 62 00 00       	mov    0x6224,%eax
     1df:	c7 44 24 04 d7 41 00 	movl   $0x41d7,0x4(%esp)
     1e6:	00 
    ...
    printf(stdout, "chdir iputdir failed\n");
     1f4:	a1 24 62 00 00       	mov    0x6224,%eax
     1f9:	c7 44 24 04 b6 41 00 	movl   $0x41b6,0x4(%esp)
     200:	00 
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     216:	a1 24 62 00 00       	mov    0x6224,%eax
     21b:	c7 44 24 04 03 42 00 	movl   $0x4203,0x4(%esp)
     222:	00 
  ...
  printf(stdout, "exitiput test ok\n");
     275:	a1 24 62 00 00       	mov    0x6224,%eax
     27a:	c7 44 24 04 26 42 00 	movl   $0x4226,0x4(%esp)
     281:	00 
     ...
     28c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(stdout, "unlink ../iputdir failed\n");
     290:	a1 24 62 00 00       	mov    0x6224,%eax
     295:	c7 44 24 04 d7 41 00 	movl   $0x41d7,0x4(%esp)
     29c:	00 
    ...
    printf(stdout, "fork failed\n");
     2aa:	a1 24 62 00 00       	mov    0x6224,%eax
     2af:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
     2b6:	00 
    ...
    exit();
     ...
     2c4:	a1 24 62 00 00       	mov    0x6224,%eax
     2c9:	c7 44 24 04 12 42 00 	movl   $0x4212,0x4(%esp)
     2d0:	00 
     ...
     2d9:	e8 c4 39 00 00       	call   3ca2 <exit>
      printf(stdout, "mkdir failed\n");
     2de:	a1 24 62 00 00       	mov    0x6224,%eax
     2e3:	c7 44 24 04 a8 41 00 	movl   $0x41a8,0x4(%esp)
     2ea:	00 
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     306:	a1 24 62 00 00       	mov    0x6224,%eax
     30b:	c7 44 24 04 38 42 00 	movl   $0x4238,0x4(%esp)
     312:	00 
     313:	89 04 24             	mov    %eax,(%esp)
     316:	e8 f5 3a 00 00       	call   3e10 <printf>
  if(mkdir("oidir") < 0){
     31b:	c7 04 24 47 42 00 00 	movl   $0x4247,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     349:	00 
     34a:	c7 04 24 47 42 00 00 	movl   $0x4247,(%esp)
     351:	e8 8c 39 00 00       	call   3ce2 <open>
    if(fd >= 0){
     356:	85 c0                	test   %eax,%eax
     358:	78 6e                	js     3c8 <openiputtest+0xc8>
      printf(stdout, "open directory for write succeeded\n");
     35a:	a1 24 62 00 00       	mov    0x6224,%eax
     35f:	c7 44 24 04 cc 51 00 	movl   $0x51cc,0x4(%esp)
     366:	00 
  ...
  if(unlink("oidir") != 0){
     384:	c7 04 24 47 42 00 00 	movl   $0x4247,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     399:	a1 24 62 00 00       	mov    0x6224,%eax
     39e:	c7 44 24 04 70 42 00 	movl   $0x4270,0x4(%esp)
     3a5:	00 
    ...
    printf(stdout, "unlink failed\n");
     3b0:	a1 24 62 00 00       	mov    0x6224,%eax
     3b5:	c7 44 24 04 61 42 00 	movl   $0x4261,0x4(%esp)
     3bc:	00 
    ...
    printf(stdout, "mkdir oidir failed\n");
     3cd:	a1 24 62 00 00       	mov    0x6224,%eax
     3d2:	c7 44 24 04 4d 42 00 	movl   $0x424d,0x4(%esp)
     3d9:	00 
    ...
    printf(stdout, "fork failed\n");
     3e7:	a1 24 62 00 00       	mov    0x6224,%eax
     3ec:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
     3f3:	00 
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     416:	a1 24 62 00 00       	mov    0x6224,%eax
     41b:	c7 44 24 04 82 42 00 	movl   $0x4282,0x4(%esp)
     422:	00 
  ...
  fd = open("echo", 0);
     ...
     432:	00 
     433:	c7 04 24 8d 42 00 00 	movl   $0x428d,(%esp)
  ...
  fd = open("doesnotexist", 0);
     ...
     452:	00 
     453:	c7 04 24 a5 42 00 00 	movl   $0x42a5,(%esp)
     45a:	e8 83 38 00 00       	call   3ce2 <open>
  if(fd >= 0){
     45f:	85 c0                	test   %eax,%eax
     461:	79 31                	jns    494 <opentest+0x84>
  printf(stdout, "open test ok\n");
     463:	a1 24 62 00 00       	mov    0x6224,%eax
     468:	c7 44 24 04 d0 42 00 	movl   $0x42d0,0x4(%esp)
     46f:	00 
    ...
    printf(stdout, "open echo failed!\n");
     47a:	a1 24 62 00 00       	mov    0x6224,%eax
     47f:	c7 44 24 04 92 42 00 	movl   $0x4292,0x4(%esp)
     486:	00 
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     494:	a1 24 62 00 00       	mov    0x6224,%eax
     499:	c7 44 24 04 b2 42 00 	movl   $0x42b2,0x4(%esp)
     4a0:	00 
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     4b8:	a1 24 62 00 00       	mov    0x6224,%eax
     4bd:	c7 44 24 04 de 42 00 	movl   $0x42de,0x4(%esp)
     4c4:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4d4:	00 
     4d5:	c7 04 24 ef 42 00 00 	movl   $0x42ef,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4eb:	a1 24 62 00 00       	mov    0x6224,%eax
  for(i = 0; i < 100; i++){
     4f0:	31 db                	xor    %ebx,%ebx
    printf(stdout, "creat small succeeded; ok\n");
     4f2:	c7 44 24 04 f5 42 00 	movl   $0x42f5,0x4(%esp)
     4f9:	00 
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     50f:	00 
     510:	c7 44 24 04 2c 43 00 	movl   $0x432c,0x4(%esp)
     517:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     530:	00 
     531:	c7 44 24 04 37 43 00 	movl   $0x4337,0x4(%esp)
     538:	00 
  ...
  printf(stdout, "writes ok\n");
     552:	a1 24 62 00 00       	mov    0x6224,%eax
     557:	c7 44 24 04 42 43 00 	movl   $0x4342,0x4(%esp)
     55e:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     576:	00 
     577:	c7 04 24 ef 42 00 00 	movl   $0x42ef,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     58d:	a1 24 62 00 00       	mov    0x6224,%eax
     592:	c7 44 24 04 4d 43 00 	movl   $0x434d,0x4(%esp)
     599:	00 
  ...
  i = read(fd, buf, 2000);
     ...
     5a9:	00 
     5aa:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
     5b1:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     5c5:	a1 24 62 00 00       	mov    0x6224,%eax
     5ca:	c7 44 24 04 81 43 00 	movl   $0x4381,0x4(%esp)
     5d1:	00 
  ...
  if(unlink("small") < 0){
     5e2:	c7 04 24 ef 42 00 00 	movl   $0x42ef,(%esp)
     5e9:	e8 04 37 00 00       	call   3cf2 <unlink>
     5ee:	85 c0                	test   %eax,%eax
     5f0:	0f 88 8c 00 00 00    	js     682 <writetest+0x1d2>
  printf(stdout, "small file test ok\n");
     5f6:	a1 24 62 00 00       	mov    0x6224,%eax
     5fb:	c7 44 24 04 a9 43 00 	movl   $0x43a9,0x4(%esp)
     602:	00 
     ...
     612:	a1 24 62 00 00       	mov    0x6224,%eax
     617:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     61b:	c7 44 24 04 f0 51 00 	movl   $0x51f0,0x4(%esp)
     622:	00 
     ...
     630:	a1 24 62 00 00       	mov    0x6224,%eax
     635:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     639:	c7 44 24 04 14 52 00 	movl   $0x5214,0x4(%esp)
     640:	00 
    ...
    printf(stdout, "error: open small failed!\n");
     64e:	a1 24 62 00 00       	mov    0x6224,%eax
     653:	c7 44 24 04 66 43 00 	movl   $0x4366,0x4(%esp)
     65a:	00 
    ...
    printf(stdout, "read failed\n");
     668:	a1 24 62 00 00       	mov    0x6224,%eax
    ...
    printf(stdout, "unlink small failed\n");
     682:	a1 24 62 00 00       	mov    0x6224,%eax
     687:	c7 44 24 04 94 43 00 	movl   $0x4394,0x4(%esp)
     68e:	00 
    ...
    printf(stdout, "error: creat small failed!\n");
     69c:	a1 24 62 00 00       	mov    0x6224,%eax
     6a1:	c7 44 24 04 10 43 00 	movl   $0x4310,0x4(%esp)
     6a8:	00 
...
000006c0 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     6c8:	a1 24 62 00 00       	mov    0x6224,%eax
     6cd:	c7 44 24 04 bd 43 00 	movl   $0x43bd,0x4(%esp)
     6d4:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6e4:	00 
     6e5:	c7 04 24 37 44 00 00 	movl   $0x4437,(%esp)
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     707:	00 
     708:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
     70f:	00 
     710:	89 34 24             	mov    %esi,(%esp)
    ((int*)buf)[0] = i;
     713:	89 1d 00 8a 00 00    	mov    %ebx,0x8a00
    if(write(fd, buf, 512) != 512){
  ...
  fd = open("big", O_RDONLY);
     ...
     743:	00 
     744:	c7 04 24 37 44 00 00 	movl   $0x4437,(%esp)
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n){
     76b:	a1 00 8a 00 00       	mov    0x8a00,%eax
    ...
    i = read(fd, buf, 512);
     ...
     782:	00 
     783:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
     78a:	00 
  ...
  if(unlink("big") < 0){
     7ab:	c7 04 24 37 44 00 00 	movl   $0x4437,(%esp)
     7b2:	e8 3b 35 00 00       	call   3cf2 <unlink>
     7b7:	85 c0                	test   %eax,%eax
     7b9:	0f 88 d0 00 00 00    	js     88f <writetest1+0x1cf>
  printf(stdout, "big files ok\n");
     7bf:	a1 24 62 00 00       	mov    0x6224,%eax
     7c4:	c7 44 24 04 5e 44 00 	movl   $0x445e,0x4(%esp)
     7cb:	00 
     ...
     7db:	a1 24 62 00 00       	mov    0x6224,%eax
     7e0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     7e4:	c7 44 24 04 e7 43 00 	movl   $0x43e7,0x4(%esp)
     7eb:	00 
     ...
     7fd:	a1 24 62 00 00       	mov    0x6224,%eax
     802:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     806:	c7 44 24 04 38 52 00 	movl   $0x5238,0x4(%esp)
     80d:	00 
     ...
     81f:	a1 24 62 00 00       	mov    0x6224,%eax
     824:	c7 44 24 04 3b 44 00 	movl   $0x443b,0x4(%esp)
     82b:	00 
     ...
     839:	a1 24 62 00 00       	mov    0x6224,%eax
     83e:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
     845:	00 
     846:	c7 44 24 04 1e 44 00 	movl   $0x441e,0x4(%esp)
     84d:	00 
    ...
    printf(stdout, "error: open big failed!\n");
     85b:	a1 24 62 00 00       	mov    0x6224,%eax
     860:	c7 44 24 04 05 44 00 	movl   $0x4405,0x4(%esp)
     867:	00 
    ...
    printf(stdout, "error: creat big failed!\n");
     875:	a1 24 62 00 00       	mov    0x6224,%eax
     87a:	c7 44 24 04 cd 43 00 	movl   $0x43cd,0x4(%esp)
     881:	00 
    ...
    printf(stdout, "unlink big failed\n");
     88f:	a1 24 62 00 00       	mov    0x6224,%eax
     894:	c7 44 24 04 4b 44 00 	movl   $0x444b,0x4(%esp)
     89b:	00 
     ...
     8b4:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     8bc:	a1 24 62 00 00       	mov    0x6224,%eax
     8c1:	c7 44 24 04 58 52 00 	movl   $0x5258,0x4(%esp)
     8c8:	00 
     8c9:	89 04 24             	mov    %eax,(%esp)
     8cc:	e8 3f 35 00 00       	call   3e10 <printf>
  name[0] = 'a';
     8d1:	c6 05 00 aa 00 00 61 	movb   $0x61,0xaa00
  name[2] = '\0';
     8d8:	c6 05 02 aa 00 00 00 	movb   $0x0,0xaa02
     8df:	90                   	nop
    fd = open(name, O_CREATE|O_RDWR);
     8e0:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     8e7:	00 
     8e8:	c7 04 24 00 aa 00 00 	movl   $0xaa00,(%esp)
    name[1] = '0' + i;
     8ef:	88 1d 01 aa 00 00    	mov    %bl,0xaa01
  ...
  name[0] = 'a';
     90a:	c6 05 00 aa 00 00 61 	movb   $0x61,0xaa00
  name[2] = '\0';
     911:	bb 30 00 00 00       	mov    $0x30,%ebx
     916:	c6 05 02 aa 00 00 00 	movb   $0x0,0xaa02
     91d:	8d 76 00             	lea    0x0(%esi),%esi
    name[1] = '0' + i;
     920:	88 1d 01 aa 00 00    	mov    %bl,0xaa01
     926:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     929:	c7 04 24 00 aa 00 00 	movl   $0xaa00,(%esp)
     930:	e8 bd 33 00 00       	call   3cf2 <unlink>
  for(i = 0; i < 52; i++){
     935:	80 fb 64             	cmp    $0x64,%bl
     938:	75 e6                	jne    920 <createtest+0x70>
  printf(stdout, "many creates, followed by unlink; ok\n");
     93a:	a1 24 62 00 00       	mov    0x6224,%eax
     93f:	c7 44 24 04 80 52 00 	movl   $0x5280,0x4(%esp)
     946:	00 
...
00000960 <dirtest>:
{
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     9d5:	c3                   	ret    
    printf(stdout, "mkdir failed\n");
     9d6:	a1 24 62 00 00       	mov    0x6224,%eax
     9db:	c7 44 24 04 a8 41 00 	movl   $0x41a8,0x4(%esp)
     9e2:	00 
    ...
    printf(stdout, "unlink dir0 failed\n");
     9f0:	a1 24 62 00 00       	mov    0x6224,%eax
     9f5:	c7 44 24 04 a1 44 00 	movl   $0x44a1,0x4(%esp)
     9fc:	00 
    ...
    printf(stdout, "chdir .. failed\n");
     a0a:	a1 24 62 00 00       	mov    0x6224,%eax
     a0f:	c7 44 24 04 90 44 00 	movl   $0x4490,0x4(%esp)
     a16:	00 
    ...
    printf(stdout, "chdir dir0 failed\n");
     a24:	a1 24 62 00 00       	mov    0x6224,%eax
     a29:	c7 44 24 04 7d 44 00 	movl   $0x447d,0x4(%esp)
     a30:	00 
...
00000a40 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     a46:	a1 24 62 00 00       	mov    0x6224,%eax
     a4b:	c7 44 24 04 c4 44 00 	movl   $0x44c4,0x4(%esp)
     a52:	00 
     a53:	89 04 24             	mov    %eax,(%esp)
     a56:	e8 b5 33 00 00       	call   3e10 <printf>
  if(exec("echo", echoargv) < 0){
     a5b:	c7 44 24 04 28 62 00 	movl   $0x6228,0x4(%esp)
     a62:	00 
     a63:	c7 04 24 8d 42 00 00 	movl   $0x428d,(%esp)
    ...
    printf(stdout, "exec echo failed\n");
     a75:	a1 24 62 00 00       	mov    0x6224,%eax
     a7a:	c7 44 24 04 cf 44 00 	movl   $0x44cf,0x4(%esp)
     a81:	00 
...
00000a90 <pipe1>:
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae0:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
     ae7:	00 
     ...
     b0a:	38 9c 0b 00 8a 00 00 	cmp    %bl,0x8a00(%ebx,%ecx,1)
     ...
     b31:	c7 44 24 04 fe 44 00 	movl   $0x44fe,0x4(%esp)
     b38:	00 
     ...
     b5a:	89 f0                	mov    %esi,%eax
{
     ...
     b66:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     b68:	88 9c 18 00 8a 00 00 	mov    %bl,0x8a00(%eax,%ebx,1)
     ...
     b82:	00 
     b83:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
     b8a:	00 
  ...
  printf(1, "pipe1 ok\n");
     bc4:	c7 44 24 04 23 45 00 	movl   $0x4523,0x4(%esp)
     bcb:	00 
     ...
     be0:	c7 44 24 04 0c 45 00 	movl   $0x450c,0x4(%esp)
     be7:	00 
    ...
    printf(1, "pipe() failed\n");
     bfa:	c7 44 24 04 e1 44 00 	movl   $0x44e1,0x4(%esp)
     c01:	00 
    ...
    printf(1, "fork() failed\n");
     c13:	c7 44 24 04 2d 45 00 	movl   $0x452d,0x4(%esp)
     c1a:	00 
    ...
    exit();
     ...
     c2c:	c7 44 24 04 f0 44 00 	movl   $0x44f0,0x4(%esp)
     c33:	00 
...
00000c50 <preempt>:
{
  ...
  printf(1, "preempt: ");
     c59:	c7 44 24 04 3c 45 00 	movl   $0x453c,0x4(%esp)
     c60:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     cb8:	00 
     cb9:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
     cc0:	00 
     ...
     cce:	c7 44 24 04 46 45 00 	movl   $0x4546,0x4(%esp)
     cd5:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     d04:	00 
     d05:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
     d0c:	00 
    ...
    printf(1, "preempt read error");
     d1a:	c7 44 24 04 5a 45 00 	movl   $0x455a,0x4(%esp)
     d21:	00 
  ...
  printf(1, "kill... ");
     d41:	c7 44 24 04 6d 45 00 	movl   $0x456d,0x4(%esp)
     d48:	00 
  ...
  printf(1, "wait... ");
     d6d:	c7 44 24 04 76 45 00 	movl   $0x4576,0x4(%esp)
     d74:	00 
  ...
  printf(1, "preempt ok\n");
     d95:	c7 44 24 04 7f 45 00 	movl   $0x457f,0x4(%esp)
     d9c:	00 
...
00000db0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ddb:	79 e3                	jns    dc0 <exitwait+0x10>
      printf(1, "fork failed\n");
     ddd:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
     de4:	00 
     ...
     df8:	c7 44 24 04 8b 45 00 	movl   $0x458b,0x4(%esp)
     dff:	00 
  ...
  printf(1, "exitwait ok\n");
     e18:	c7 44 24 04 9b 45 00 	movl   $0x459b,0x4(%esp)
     e1f:	00 
...
00000e40 <mem>:
{
  ...
  printf(1, "mem test\n");
     e49:	c7 44 24 04 a8 45 00 	movl   $0x45a8,0x4(%esp)
     e50:	00 
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     e83:	e8 38 32 00 00       	call   40c0 <malloc>
    ...
    wait();
     ...
     ef0:	c7 44 24 04 b2 45 00 	movl   $0x45b2,0x4(%esp)
     ef7:	00 
...
00000f20 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fb6:	c7 44 24 04 d4 52 00 	movl   $0x52d4,0x4(%esp)
     fbd:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     fe9:	00 
     fea:	c7 04 24 e3 45 00 00 	movl   $0x45e3,(%esp)
  ...
  unlink("sharedfd");
    106c:	c7 04 24 e3 45 00 00 	movl   $0x45e3,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    108b:	c7 44 24 04 ec 45 00 	movl   $0x45ec,0x4(%esp)
    1092:	00 
    ...
    10a7:	c7 44 24 04 a8 52 00 	movl   $0x52a8,0x4(%esp)
    10ae:	00 
    ...
    10c3:	c7 44 24 04 f4 52 00 	movl   $0x52f4,0x4(%esp)
    10ca:	00 
    ...
    10e7:	c7 44 24 04 f9 45 00 	movl   $0x45f9,0x4(%esp)
    10ee:	00 
...
00001100 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1105:	be 0e 46 00 00       	mov    $0x460e,%esi
{
    110a:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    110b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    1110:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
    1117:	00 
    1118:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  char *names[] = { "f0", "f1", "f2", "f3" };
    111f:	c7 45 d8 0e 46 00 00 	movl   $0x460e,-0x28(%ebp)
    1126:	c7 45 dc 57 47 00 00 	movl   $0x4757,-0x24(%ebp)
    112d:	c7 45 e0 5b 47 00 00 	movl   $0x475b,-0x20(%ebp)
    1134:	c7 45 e4 11 46 00 00 	movl   $0x4611,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1182:	c7 45 d4 0e 46 00 00 	movl   $0x460e,-0x2c(%ebp)
    fd = open(fname, 0);
    ...
    11a7:	00 
    11a8:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    11af:	00 
    ...
    11be:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    11c0:	0f be 8a 00 8a 00 00 	movsbl 0x8a00(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    11fa:	c7 44 24 04 52 46 00 	movl   $0x4652,0x4(%esp)
    1201:	00 
    ...
    1221:	e9 63 ff ff ff       	jmp    1189 <fourfiles+0x89>
          printf(1, "wrong char\n");
    1226:	c7 44 24 04 35 46 00 	movl   $0x4635,0x4(%esp)
    122d:	00 
    ...
    126c:	00 
    126d:	c7 04 24 00 8a 00 00 	movl   $0x8a00,(%esp)
    ...
    128c:	00 
    128d:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    1294:	00 
    ...
    12a8:	c7 44 24 04 24 46 00 	movl   $0x4624,0x4(%esp)
    12af:	00 
    ...
    12c5:	c7 44 24 04 41 46 00 	movl   $0x4641,0x4(%esp)
    12cc:	00 
    ...
    12d9:	e8 c4 29 00 00       	call   3ca2 <exit>
      printf(1, "fork failed\n");
    12de:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
    12e5:	00 
    ...
    12f7:	c7 44 24 04 af 48 00 	movl   $0x48af,0x4(%esp)
    12fe:	00 
    ...
    1316:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    131b:	c7 44 24 04 60 46 00 	movl   $0x4660,0x4(%esp)
    1322:	00 
  ...
  printf(1, "createdelete ok\n");
    1415:	c7 44 24 04 73 46 00 	movl   $0x4673,0x4(%esp)
    141c:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    14bc:	c7 44 24 04 61 42 00 	movl   $0x4261,0x4(%esp)
    14c3:	00 
    ...
    14dc:	c7 44 24 04 20 53 00 	movl   $0x5320,0x4(%esp)
    14e3:	00 
    ...
    14f0:	e8 ad 27 00 00       	call   3ca2 <exit>
          printf(1, "create failed\n");
    14f5:	c7 44 24 04 af 48 00 	movl   $0x48af,0x4(%esp)
    14fc:	00 
    ...
    1509:	e8 94 27 00 00       	call   3ca2 <exit>
      printf(1, "fork failed\n");
    150e:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
    1515:	00 
    ...
    152b:	c7 44 24 04 44 53 00 	movl   $0x5344,0x4(%esp)
    1532:	00 
...
00001550 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    1558:	c7 44 24 04 84 46 00 	movl   $0x4684,0x4(%esp)
    155f:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1573:	00 
    1574:	c7 04 24 95 46 00 00 	movl   $0x4695,(%esp)
  ...
  write(fd, "hello", 5);
    ...
    1591:	00 
    1592:	c7 44 24 04 ba 46 00 	movl   $0x46ba,0x4(%esp)
    1599:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    15b1:	00 
    15b2:	c7 04 24 95 46 00 00 	movl   $0x4695,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    15c8:	c7 04 24 95 46 00 00 	movl   $0x4695,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15e3:	00 
    15e4:	c7 04 24 95 46 00 00 	movl   $0x4695,(%esp)
    15eb:	e8 f2 26 00 00       	call   3ce2 <open>
  write(fd1, "yyy", 3);
    15f0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15f7:	00 
    15f8:	c7 44 24 04 f2 46 00 	movl   $0x46f2,0x4(%esp)
    15ff:	00 
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1619:	00 
    161a:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    1621:	00 
  ...
  if(buf[0] != 'h'){
    1633:	80 3d 00 8a 00 00 68 	cmpb   $0x68,0x8a00
    163a:	75 7e                	jne    16ba <unlinkread+0x16a>
  if(write(fd, buf, 10) != 10){
    163c:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1643:	00 
    1644:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    164b:	00 
  ...
  unlink("unlinkread");
    1661:	c7 04 24 95 46 00 00 	movl   $0x4695,(%esp)
    1668:	e8 85 26 00 00       	call   3cf2 <unlink>
  printf(1, "unlinkread ok\n");
    166d:	c7 44 24 04 3d 47 00 	movl   $0x473d,0x4(%esp)
    1674:	00 
    ...
    1688:	c7 44 24 04 a0 46 00 	movl   $0x46a0,0x4(%esp)
    168f:	00 
    ...
    16a1:	c7 44 24 04 24 47 00 	movl   $0x4724,0x4(%esp)
    16a8:	00 
    ...
    16ba:	c7 44 24 04 0d 47 00 	movl   $0x470d,0x4(%esp)
    16c1:	00 
    ...
    16d3:	c7 44 24 04 f6 46 00 	movl   $0x46f6,0x4(%esp)
    16da:	00 
    ...
    16ec:	c7 44 24 04 d8 46 00 	movl   $0x46d8,0x4(%esp)
    16f3:	00 
    ...
    1705:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
    170c:	00 
...
00001720 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1778:	00 
    1779:	c7 44 24 04 ba 46 00 	movl   $0x46ba,0x4(%esp)
    1780:	00 
  ...
  fd = open("lf2", 0);
    ...
    17e5:	00 
    17e6:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1803:	00 
    1804:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    180b:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    1825:	c7 44 24 04 5a 47 00 	movl   $0x475a,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
    1834:	e8 c9 24 00 00       	call   3d02 <link>
    1839:	85 c0                	test   %eax,%eax
    183b:	0f 89 a1 00 00 00    	jns    18e2 <linktest+0x1c2>
  unlink("lf2");
    1841:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
    1848:	e8 a5 24 00 00       	call   3cf2 <unlink>
  if(link("lf2", "lf1") >= 0){
    184d:	c7 44 24 04 56 47 00 	movl   $0x4756,0x4(%esp)
    1854:	00 
    1855:	c7 04 24 5a 47 00 00 	movl   $0x475a,(%esp)
    185c:	e8 a1 24 00 00       	call   3d02 <link>
    1861:	85 c0                	test   %eax,%eax
    1863:	79 64                	jns    18c9 <linktest+0x1a9>
  if(link(".", "lf1") >= 0){
    1865:	c7 44 24 04 56 47 00 	movl   $0x4756,0x4(%esp)
    186c:	00 
    186d:	c7 04 24 1e 4a 00 00 	movl   $0x4a1e,(%esp)
    1874:	e8 89 24 00 00       	call   3d02 <link>
    1879:	85 c0                	test   %eax,%eax
    187b:	79 33                	jns    18b0 <linktest+0x190>
  printf(1, "linktest ok\n");
    187d:	c7 44 24 04 f4 47 00 	movl   $0x47f4,0x4(%esp)
    1884:	00 
    ...
    1897:	c7 44 24 04 5e 47 00 	movl   $0x475e,0x4(%esp)
    189e:	00 
    ...
    18b0:	c7 44 24 04 d8 47 00 	movl   $0x47d8,0x4(%esp)
    18b7:	00 
    ...
    18c9:	c7 44 24 04 8c 53 00 	movl   $0x538c,0x4(%esp)
    18d0:	00 
    ...
    18e2:	c7 44 24 04 ba 47 00 	movl   $0x47ba,0x4(%esp)
    18e9:	00 
    ...
    18fb:	c7 44 24 04 a9 47 00 	movl   $0x47a9,0x4(%esp)
    1902:	00 
    ...
    1914:	c7 44 24 04 98 47 00 	movl   $0x4798,0x4(%esp)
    191b:	00 
    ...
    192d:	c7 44 24 04 64 53 00 	movl   $0x5364,0x4(%esp)
    1934:	00 
    ...
    1946:	c7 44 24 04 83 47 00 	movl   $0x4783,0x4(%esp)
    194d:	00 
    ...
    195f:	c7 44 24 04 71 47 00 	movl   $0x4771,0x4(%esp)
    1966:	00 
    ...
    1985:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    198b:	c7 44 24 04 01 48 00 	movl   $0x4801,0x4(%esp)
    1992:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1a34:	c7 04 24 11 48 00 00 	movl   $0x4811,(%esp)
  ...
  for(i = 0; i < 40; i++){
    1a4c:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1a4f:	c7 04 24 11 48 00 00 	movl   $0x4811,(%esp)
  ...
  fd = open(".", 0);
    ...
    1a8d:	00 
    1a8e:	c7 04 24 1e 4a 00 00 	movl   $0x4a1e,(%esp)
  ...
  printf(1, "concreate ok\n");
    1bf0:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
    1bf7:	00 
    ...
    1c0b:	c3                   	ret    
      printf(1, "fork failed\n");
    1c0c:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
    1c13:	00 
    ...
    1c29:	c7 44 24 04 14 48 00 	movl   $0x4814,0x4(%esp)
    1c30:	00 
    ...
    1c49:	c7 44 24 04 30 48 00 	movl   $0x4830,0x4(%esp)
    1c50:	00 
    ...
    1c62:	c7 44 24 04 b0 53 00 	movl   $0x53b0,0x4(%esp)
    1c69:	00 
    ...
    1c82:	c7 44 24 04 49 48 00 	movl   $0x4849,0x4(%esp)
    1c89:	00 
...
00001ca0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ca9:	c7 44 24 04 74 48 00 	movl   $0x4874,0x4(%esp)
    1cb0:	00 
    1cb1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cb8:	e8 53 21 00 00       	call   3e10 <printf>
  unlink("x");
    1cbd:	c7 04 24 01 4b 00 00 	movl   $0x4b01,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1cfb:	74 7b                	je     1d78 <linkunlink+0xd8>
      unlink("x");
    1cfd:	c7 04 24 01 4b 00 00 	movl   $0x4b01,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1d30:	00 
    1d31:	c7 04 24 01 4b 00 00 	movl   $0x4b01,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d56:	c7 44 24 04 89 48 00 	movl   $0x4889,0x4(%esp)
    1d5d:	00 
    ...
    1d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("cat", "x");
    1d78:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
    1d7f:	00 
    1d80:	c7 04 24 85 48 00 00 	movl   $0x4885,(%esp)
    1d87:	e8 76 1f 00 00       	call   3d02 <link>
    1d8c:	e9 78 ff ff ff       	jmp    1d09 <linkunlink+0x69>
    printf(1, "fork failed\n");
    1d91:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
    1d98:	00 
...
00001db0 <bigdir>:
{
  ...
  close(fd);
    ...
    1e1f:	c7 04 24 a5 48 00 00 	movl   $0x48a5,(%esp)
    name[0] = 'x';
  ...
  unlink("bd");
    1e45:	c7 04 24 a5 48 00 00 	movl   $0x48a5,(%esp)
  for(i = 0; i < 500; i++){
  ...
  printf(1, "bigdir ok\n");
    1e8d:	c7 44 24 04 e7 48 00 	movl   $0x48e7,0x4(%esp)
    1e94:	00 
    ...
    1ea8:	c7 44 24 04 be 48 00 	movl   $0x48be,0x4(%esp)
    1eaf:	00 
    ...
    1ec1:	c7 44 24 04 d2 48 00 	movl   $0x48d2,0x4(%esp)
    1ec8:	00 
    ...
    1eda:	c7 44 24 04 a8 48 00 	movl   $0x48a8,0x4(%esp)
    1ee1:	00 
...
00001f00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1f07:	c7 44 24 04 f2 48 00 	movl   $0x48f2,0x4(%esp)
    1f0e:	00 
    1f0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f16:	e8 f5 1e 00 00       	call   3e10 <printf>
  unlink("ff");
    1f1b:	c7 04 24 7b 49 00 00 	movl   $0x497b,(%esp)
    1f22:	e8 cb 1d 00 00       	call   3cf2 <unlink>
  if(mkdir("dd") != 0){
    1f27:	c7 04 24 18 4a 00 00 	movl   $0x4a18,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f42:	00 
    1f43:	c7 04 24 51 49 00 00 	movl   $0x4951,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    1f60:	00 
    1f61:	c7 44 24 04 7b 49 00 	movl   $0x497b,0x4(%esp)
    1f68:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1fa8:	00 
    1fa9:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    1fc6:	00 
    1fc7:	c7 44 24 04 6f 49 00 	movl   $0x496f,0x4(%esp)
    1fce:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1fe6:	00 
    1fe7:	c7 04 24 72 49 00 00 	movl   $0x4972,(%esp)
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2004:	00 
    2005:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    200c:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20d6:	00 
    20d7:	c7 04 24 b2 49 00 00 	movl   $0x49b2,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    20f4:	00 
    20f5:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    20fc:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    211d:	00 
    211e:	c7 04 24 4e 49 00 00 	movl   $0x494e,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2139:	00 
    213a:	c7 04 24 66 4a 00 00 	movl   $0x4a66,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2155:	00 
    2156:	c7 04 24 8b 4a 00 00 	movl   $0x4a8b,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2171:	00 
    2172:	c7 04 24 18 4a 00 00 	movl   $0x4a18,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    218d:	00 
    218e:	c7 04 24 18 4a 00 00 	movl   $0x4a18,(%esp)
  ...
  printf(1, "subdir ok\n");
    ...
    231c:	c7 44 24 04 97 49 00 	movl   $0x4997,0x4(%esp)
    2323:	00 
    ...
    2335:	c7 44 24 04 f2 49 00 	movl   $0x49f2,0x4(%esp)
    233c:	00 
    ...
    234e:	c7 44 24 04 bd 49 00 	movl   $0x49bd,0x4(%esp)
    2355:	00 
    ...
    2367:	c7 44 24 04 6f 4a 00 	movl   $0x4a6f,0x4(%esp)
    236e:	00 
    ...
    2380:	c7 44 24 04 54 54 00 	movl   $0x5454,0x4(%esp)
    2387:	00 
    ...
    2399:	c7 44 24 04 03 4b 00 	movl   $0x4b03,0x4(%esp)
    23a0:	00 
    ...
    23b2:	c7 44 24 04 c4 54 00 	movl   $0x54c4,0x4(%esp)
    23b9:	00 
    ...
    23cb:	c7 44 24 04 7e 49 00 	movl   $0x497e,0x4(%esp)
    23d2:	00 
    ...
    23e4:	c7 44 24 04 57 49 00 	movl   $0x4957,0x4(%esp)
    23eb:	00 
    ...
    23fd:	c7 44 24 04 20 4a 00 	movl   $0x4a20,0x4(%esp)
    2404:	00 
    ...
    2416:	c7 44 24 04 0c 54 00 	movl   $0x540c,0x4(%esp)
    241d:	00 
    ...
    242f:	c7 44 24 04 a0 54 00 	movl   $0x54a0,0x4(%esp)
    2436:	00 
    ...
    2448:	c7 44 24 04 7c 54 00 	movl   $0x547c,0x4(%esp)
    244f:	00 
    ...
    2461:	c7 44 24 04 df 4a 00 	movl   $0x4adf,0x4(%esp)
    2468:	00 
    ...
    247a:	c7 44 24 04 c6 4a 00 	movl   $0x4ac6,0x4(%esp)
    2481:	00 
    ...
    2493:	c7 44 24 04 b0 4a 00 	movl   $0x4ab0,0x4(%esp)
    249a:	00 
    ...
    24ac:	c7 44 24 04 94 4a 00 	movl   $0x4a94,0x4(%esp)
    24b3:	00 
    ...
    24c5:	c7 44 24 04 d5 49 00 	movl   $0x49d5,0x4(%esp)
    24cc:	00 
    ...
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    24de:	c7 44 24 04 30 54 00 	movl   $0x5430,0x4(%esp)
    24e5:	00 
    ...
    24f7:	c7 44 24 04 33 49 00 	movl   $0x4933,0x4(%esp)
    24fe:	00 
    ...
    2510:	c7 44 24 04 e4 53 00 	movl   $0x53e4,0x4(%esp)
    2517:	00 
    ...
    2529:	c7 44 24 04 17 49 00 	movl   $0x4917,0x4(%esp)
    2530:	00 
    ...
    2542:	c7 44 24 04 ff 48 00 	movl   $0x48ff,0x4(%esp)
    2549:	00 
    ...
    255b:	c7 44 24 04 e8 4b 00 	movl   $0x4be8,0x4(%esp)
    2562:	00 
    ...
    2574:	c7 44 24 04 d3 4b 00 	movl   $0x4bd3,0x4(%esp)
    257b:	00 
    ...
    258d:	c7 44 24 04 e8 54 00 	movl   $0x54e8,0x4(%esp)
    2594:	00 
    ...
    25a6:	c7 44 24 04 be 4b 00 	movl   $0x4bbe,0x4(%esp)
    25ad:	00 
    ...
    25bf:	c7 44 24 04 a6 4b 00 	movl   $0x4ba6,0x4(%esp)
    25c6:	00 
    ...
    25d8:	c7 44 24 04 8e 4b 00 	movl   $0x4b8e,0x4(%esp)
    25df:	00 
    ...
    25f1:	c7 44 24 04 72 4b 00 	movl   $0x4b72,0x4(%esp)
    25f8:	00 
    ...
    260a:	c7 44 24 04 56 4b 00 	movl   $0x4b56,0x4(%esp)
    2611:	00 
    ...
    2623:	c7 44 24 04 39 4b 00 	movl   $0x4b39,0x4(%esp)
    262a:	00 
    ...
    263c:	c7 44 24 04 1e 4b 00 	movl   $0x4b1e,0x4(%esp)
    2643:	00 
    ...
    2655:	c7 44 24 04 4b 4a 00 	movl   $0x4a4b,0x4(%esp)
    265c:	00 
    ...
    266e:	c7 44 24 04 33 4a 00 	movl   $0x4a33,0x4(%esp)
    2675:	00 
    ...
    2695:	bb f3 01 00 00       	mov    $0x1f3,%ebx
{
  ...
  unlink("bigwrite");
    ...
    26e2:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    26e9:	00 
    ...
    26fa:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    2701:	00 
  ...
  printf(1, "bigwrite ok\n");
    ...
    2753:	c7 44 24 04 35 4c 00 	movl   $0x4c35,0x4(%esp)
    275a:	00 
    ...
    276c:	c7 44 24 04 1d 4c 00 	movl   $0x4c1d,0x4(%esp)
    2773:	00 
...
00002790 <bigfile>:
{
  ...
  if(fd < 0){
    ...
    27ec:	c7 04 24 00 8a 00 00 	movl   $0x8a00,(%esp)
    27f3:	e8 38 13 00 00       	call   3b30 <memset>
    if(write(fd, buf, 600) != 600){
    27f8:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    27ff:	00 
    2800:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    2807:	00 
  ...
  fd = open("bigfile", 0);
    ...
    2832:	00 
    2833:	c7 04 24 70 4c 00 00 	movl   $0x4c70,(%esp)
  ...
  if(fd < 0){
    ...
    285b:	0f be 05 00 8a 00 00 	movsbl 0x8a00,%eax
    2862:	89 fa                	mov    %edi,%edx
    2864:	d1 fa                	sar    %edx
    2866:	39 d0                	cmp    %edx,%eax
    2868:	75 6f                	jne    28d9 <bigfile+0x149>
    286a:	0f be 15 2b 8b 00 00 	movsbl 0x8b2b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2885:	00 
    2886:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    288d:	00 
  ...
  unlink("bigfile");
    28b1:	c7 04 24 70 4c 00 00 	movl   $0x4c70,(%esp)
    28b8:	e8 35 14 00 00       	call   3cf2 <unlink>
  printf(1, "bigfile test ok\n");
    28bd:	c7 44 24 04 ff 4c 00 	movl   $0x4cff,0x4(%esp)
    28c4:	00 
    ...
    28d9:	c7 44 24 04 cc 4c 00 	movl   $0x4ccc,0x4(%esp)
    28e0:	00 
    ...
    28f2:	c7 44 24 04 b8 4c 00 	movl   $0x4cb8,0x4(%esp)
    28f9:	00 
    ...
    290b:	c7 44 24 04 a3 4c 00 	movl   $0x4ca3,0x4(%esp)
    2912:	00 
    ...
    2924:	c7 44 24 04 78 4c 00 	movl   $0x4c78,0x4(%esp)
    292b:	00 
    ...
    293d:	c7 44 24 04 8e 4c 00 	movl   $0x4c8e,0x4(%esp)
    2944:	00 
    ...
    2956:	c7 44 24 04 62 4c 00 	movl   $0x4c62,0x4(%esp)
    295d:	00 
    ...
    296f:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    2976:	00 
...
00002990 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29d9:	00 
    29da:	c7 04 24 58 55 00 00 	movl   $0x5558,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29fd:	00 
    29fe:	c7 04 24 c8 55 00 00 	movl   $0x55c8,(%esp)
  ...
  printf(1, "fourteen ok\n");
    ...
    2a50:	c7 44 24 04 1f 4d 00 	movl   $0x4d1f,0x4(%esp)
    2a57:	00 
    ...
    2a69:	c7 44 24 04 84 56 00 	movl   $0x5684,0x4(%esp)
    2a70:	00 
    ...
    2a82:	c7 44 24 04 34 56 00 	movl   $0x5634,0x4(%esp)
    2a89:	00 
    ...
    2a9b:	c7 44 24 04 f8 55 00 	movl   $0x55f8,0x4(%esp)
    2aa2:	00 
    ...
    2ab4:	c7 44 24 04 88 55 00 	movl   $0x5588,0x4(%esp)
    2abb:	00 
    ...
    2acd:	c7 44 24 04 28 55 00 	movl   $0x5528,0x4(%esp)
    2ad4:	00 
...
00002af0 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    2bb8:	c7 44 24 04 78 4d 00 	movl   $0x4d78,0x4(%esp)
    2bbf:	00 
    ...
    2bd1:	c7 44 24 04 f9 4d 00 	movl   $0x4df9,0x4(%esp)
    2bd8:	00 
    ...
    2bea:	c7 44 24 04 e1 4d 00 	movl   $0x4de1,0x4(%esp)
    2bf1:	00 
    ...
    printf(1, "unlink dots/. worked!\n");
    2c03:	c7 44 24 04 c2 4d 00 	movl   $0x4dc2,0x4(%esp)
    2c0a:	00 
    ...
    printf(1, "chdir / failed\n");
    2c1c:	c7 44 24 04 f3 41 00 	movl   $0x41f3,0x4(%esp)
    2c23:	00 
    ...
    printf(1, "rm .. worked!\n");
    2c35:	c7 44 24 04 ac 4d 00 	movl   $0x4dac,0x4(%esp)
    2c3c:	00 
    ...
    printf(1, "rm . worked!\n");
    2c4e:	c7 44 24 04 9e 4d 00 	movl   $0x4d9e,0x4(%esp)
    2c55:	00 
    ...
    2c67:	c7 44 24 04 8b 4d 00 	movl   $0x4d8b,0x4(%esp)
    2c6e:	00 
...
00002c80 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2c87:	c7 44 24 04 18 4e 00 	movl   $0x4e18,0x4(%esp)
    2c8e:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2ca2:	00 
    2ca3:	c7 04 24 25 4e 00 00 	movl   $0x4e25,(%esp)
  ...
  if(chdir("dirfile") == 0){
    2cbf:	c7 04 24 25 4e 00 00 	movl   $0x4e25,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2cda:	00 
    2cdb:	c7 04 24 5e 4e 00 00 	movl   $0x4e5e,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2d6a:	00 
    2d6b:	c7 04 24 1e 4a 00 00 	movl   $0x4a1e,(%esp)
  ...
  fd = open(".", 0);
    ...
    2d86:	00 
    2d87:	c7 04 24 1e 4a 00 00 	movl   $0x4a1e,(%esp)
    2d8e:	e8 4f 0f 00 00       	call   3ce2 <open>
  if(write(fd, "x", 1) > 0){
    2d93:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2d9a:	00 
    2d9b:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
    2da2:	00 
  ...
  printf(1, "dir vs file OK\n");
    2db9:	c7 44 24 04 f5 4e 00 	movl   $0x4ef5,0x4(%esp)
    2dc0:	00 
    ...
    2dd3:	c7 44 24 04 69 4e 00 	movl   $0x4e69,0x4(%esp)
    2dda:	00 
    ...
    2dec:	c7 44 24 04 44 4e 00 	movl   $0x4e44,0x4(%esp)
    2df3:	00 
    ...
    2e05:	c7 44 24 04 2d 4e 00 	movl   $0x4e2d,0x4(%esp)
    2e0c:	00 
    ...
    2e1e:	c7 44 24 04 e1 4e 00 	movl   $0x4ee1,0x4(%esp)
    2e25:	00 
    ...
    2e37:	c7 44 24 04 d8 56 00 	movl   $0x56d8,0x4(%esp)
    2e3e:	00 
    ...
    2e50:	c7 44 24 04 c9 4e 00 	movl   $0x4ec9,0x4(%esp)
    2e57:	00 
    ...
    2e69:	c7 44 24 04 b8 56 00 	movl   $0x56b8,0x4(%esp)
    2e70:	00 
    ...
    2e82:	c7 44 24 04 a4 4e 00 	movl   $0x4ea4,0x4(%esp)
    2e89:	00 
    ...
    2e9b:	c7 44 24 04 87 4e 00 	movl   $0x4e87,0x4(%esp)
    2ea2:	00 
    ...
    2ec4:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2f4f:	00 
    2f50:	c7 04 24 00 4b 00 00 	movl   $0x4b00,(%esp)
  ...
  printf(1, "empty file name OK\n");
    ...
    2fa3:	c7 44 24 04 1c 4f 00 	movl   $0x4f1c,0x4(%esp)
    2faa:	00 
    ...
    2fbc:	c7 44 24 04 30 4f 00 	movl   $0x4f30,0x4(%esp)
    2fc3:	00 
    ...
    2fe4:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2fe9:	c7 44 24 04 58 4f 00 	movl   $0x4f58,0x4(%esp)
    2ff0:	00 
  ...
  printf(1, "fork test OK\n");
    3042:	c7 44 24 04 8a 4f 00 	movl   $0x4f8a,0x4(%esp)
    3049:	00 
    ...
    3060:	c7 44 24 04 f8 56 00 	movl   $0x56f8,0x4(%esp)
    3067:	00 
    ...
    3079:	c7 44 24 04 63 4f 00 	movl   $0x4f63,0x4(%esp)
    3080:	00 
    ...
    3092:	c7 44 24 04 77 4f 00 	movl   $0x4f77,0x4(%esp)
    3099:	00 
    ...
    30b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    30bb:	a1 24 62 00 00       	mov    0x6224,%eax
    30c0:	c7 44 24 04 98 4f 00 	movl   $0x4f98,0x4(%esp)
    30c7:	00 
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    331a:	a1 24 62 00 00       	mov    0x6224,%eax
    331f:	c7 44 24 04 40 50 00 	movl   $0x5040,0x4(%esp)
    3326:	00 
    ...
    335c:	00 
    335d:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
    3364:	00 
    ...
    3382:	a1 24 62 00 00       	mov    0x6224,%eax
    3387:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    338b:	89 74 24 08          	mov    %esi,0x8(%esp)
    338f:	c7 44 24 04 a3 4f 00 	movl   $0x4fa3,0x4(%esp)
    3396:	00 
    ...
    33a4:	a1 24 62 00 00       	mov    0x6224,%eax
    33a9:	c7 44 24 04 25 50 00 	movl   $0x5025,0x4(%esp)
    33b0:	00 
    ...
    printf(1, "pipe() failed\n");
    33be:	c7 44 24 04 e1 44 00 	movl   $0x44e1,0x4(%esp)
    33c5:	00 
    ...
    33de:	c7 44 24 04 0c 50 00 	movl   $0x500c,0x4(%esp)
    33e5:	00 
    33e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
    33ea:	a1 24 62 00 00       	mov    0x6224,%eax
    ...
    33ff:	e8 9e 08 00 00       	call   3ca2 <exit>
      printf(stdout, "fork failed\n");
    3404:	a1 24 62 00 00       	mov    0x6224,%eax
    3409:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
    3410:	00 
    ...
    3422:	a1 24 62 00 00       	mov    0x6224,%eax
    3427:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    342b:	c7 44 24 04 ec 57 00 	movl   $0x57ec,0x4(%esp)
    3432:	00 
    ...
    3440:	a1 24 62 00 00       	mov    0x6224,%eax
    3445:	c7 44 24 04 bc 57 00 	movl   $0x57bc,0x4(%esp)
    344c:	00 
    ...
    345a:	a1 24 62 00 00       	mov    0x6224,%eax
    345f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    3463:	89 74 24 08          	mov    %esi,0x8(%esp)
    3467:	c7 44 24 04 94 57 00 	movl   $0x5794,0x4(%esp)
    346e:	00 
    ...
    3480:	a1 24 62 00 00       	mov    0x6224,%eax
    3485:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    3489:	c7 44 24 04 5c 57 00 	movl   $0x575c,0x4(%esp)
    3490:	00 
    ...
    349e:	a1 24 62 00 00       	mov    0x6224,%eax
    34a3:	c7 44 24 04 f1 4f 00 	movl   $0x4ff1,0x4(%esp)
    34aa:	00 
    ...
    34b8:	a1 24 62 00 00       	mov    0x6224,%eax
    34bd:	c7 44 24 04 1c 57 00 	movl   $0x571c,0x4(%esp)
    34c4:	00 
    ...
    34d2:	a1 24 62 00 00       	mov    0x6224,%eax
    34d7:	c7 44 24 04 d5 4f 00 	movl   $0x4fd5,0x4(%esp)
    34de:	00 
    ...
    34ec:	a1 24 62 00 00       	mov    0x6224,%eax
    34f1:	c7 44 24 04 be 4f 00 	movl   $0x4fbe,0x4(%esp)
    34f8:	00 
    ...
    3525:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(stdout, "validate test\n");
    352a:	a1 24 62 00 00       	mov    0x6224,%eax
    352f:	c7 44 24 04 4e 50 00 	movl   $0x504e,0x4(%esp)
    3536:	00 
    ...
    3574:	c7 04 24 5d 50 00 00 	movl   $0x505d,(%esp)
  ...
  printf(stdout, "validate ok\n");
    3593:	a1 24 62 00 00       	mov    0x6224,%eax
    3598:	c7 44 24 04 81 50 00 	movl   $0x5081,0x4(%esp)
    359f:	00 
    ...
    35af:	a1 24 62 00 00       	mov    0x6224,%eax
    35b4:	c7 44 24 04 68 50 00 	movl   $0x5068,0x4(%esp)
    35bb:	00 
...
000035d0 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    3613:	a1 24 62 00 00       	mov    0x6224,%eax
    3618:	c7 44 24 04 a9 50 00 	movl   $0x50a9,0x4(%esp)
    361f:	00 
    ...
    362a:	a1 24 62 00 00       	mov    0x6224,%eax
    362f:	c7 44 24 04 98 50 00 	movl   $0x5098,0x4(%esp)
    3636:	00 
...
00003650 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3656:	c7 04 24 b6 50 00 00 	movl   $0x50b6,(%esp)
  ...
  fd = open("bigarg-ok", 0);
    ...
    3682:	00 
    3683:	c7 04 24 b6 50 00 00 	movl   $0x50b6,(%esp)
  ...
  unlink("bigarg-ok");
    369f:	c7 04 24 b6 50 00 00 	movl   $0x50b6,(%esp)
    ...
    36b0:	c7 04 85 40 62 00 00 	movl   $0x5810,0x6240(,%eax,4)
    36b7:	10 58 00 00 
    ...
    36c3:	a1 24 62 00 00       	mov    0x6224,%eax
    36c8:	c7 44 24 04 c0 50 00 	movl   $0x50c0,0x4(%esp)
    36cf:	00 
    args[MAXARG-1] = 0;
    36d0:	c7 05 bc 62 00 00 00 	movl   $0x0,0x62bc
    36d7:	00 00 00 
    printf(stdout, "bigarg test\n");
    36da:	89 04 24             	mov    %eax,(%esp)
    36dd:	e8 2e 07 00 00       	call   3e10 <printf>
    exec("echo", args);
    36e2:	c7 44 24 04 40 62 00 	movl   $0x6240,0x4(%esp)
    36e9:	00 
    36ea:	c7 04 24 8d 42 00 00 	movl   $0x428d,(%esp)
    36f1:	e8 e4 05 00 00       	call   3cda <exec>
    printf(stdout, "bigarg test ok\n");
    36f6:	a1 24 62 00 00       	mov    0x6224,%eax
    36fb:	c7 44 24 04 cd 50 00 	movl   $0x50cd,0x4(%esp)
    3702:	00 
    ...
    3712:	00 
    3713:	c7 04 24 b6 50 00 00 	movl   $0x50b6,(%esp)
    ...
    372c:	a1 24 62 00 00       	mov    0x6224,%eax
    3731:	c7 44 24 04 f6 50 00 	movl   $0x50f6,0x4(%esp)
    3738:	00 
    ...
    3746:	a1 24 62 00 00       	mov    0x6224,%eax
    374b:	c7 44 24 04 dd 50 00 	movl   $0x50dd,0x4(%esp)
    3752:	00 
    ...
    3766:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    376b:	c7 44 24 04 0b 51 00 	movl   $0x510b,0x4(%esp)
    3772:	00 
    ...
    printf(1, "writing %s\n", name);
    3790:	c7 44 24 04 18 51 00 	movl   $0x5118,0x4(%esp)
    3797:	00 
    ...
    3849:	00 
    384a:	c7 44 24 04 00 8a 00 	movl   $0x8a00,0x4(%esp)
    3851:	00 
    ...
    3865:	c7 44 24 04 34 51 00 	movl   $0x5134,0x4(%esp)
    386c:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3894:	c7 44 24 04 24 51 00 	movl   $0x5124,0x4(%esp)
    389b:	00 
  ...
  printf(1, "fsfull test finished\n");
    3941:	c7 44 24 04 44 51 00 	movl   $0x5144,0x4(%esp)
    3948:	00 
...
00003960 <uio>:
{
  ...
  printf(1, "uio test\n");
    3966:	c7 44 24 04 5a 51 00 	movl   $0x515a,0x4(%esp)
    396d:	00 
  ...
  printf(1, "uio test done\n");
    398a:	c7 44 24 04 64 51 00 	movl   $0x5164,0x4(%esp)
    3991:	00 
    ...
    39ae:	c7 44 24 04 f0 58 00 	movl   $0x58f0,0x4(%esp)
    39b5:	00 
    ...
    printf (1, "fork failed\n");
    39c7:	c7 44 24 04 e9 50 00 	movl   $0x50e9,0x4(%esp)
    39ce:	00 
...
000039e0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    39ee:	00 
    39ef:	c7 04 24 73 51 00 00 	movl   $0x5173,(%esp)
  ...
  printf(1, "arg test passed\n");
    3a2c:	c7 44 24 04 85 51 00 	movl   $0x5185,0x4(%esp)
    3a33:	00 
    ...
    3a46:	c7 44 24 04 78 51 00 	movl   $0x5178,0x4(%esp)
    3a4d:	00 
...
00003a60 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3a60:	69 05 20 62 00 00 0d 	imul   $0x19660d,0x6220,%eax
    3a67:	66 19 00 
{
    3a6a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3a73:	a3 20 62 00 00       	mov    %eax,0x6220
}
    3a78:	c3                   	ret    
...
SYSCALL(halt)
    ...
    3d5f:	cd 40                	int    $0x40
    3d61:	c3                   	ret    
    3d62:	66 90                	xchg   %ax,%ax
    3d64:	66 90                	xchg   %ax,%ax
    3d66:	66 90                	xchg   %ax,%ax
    3d68:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3da9:	0f b6 92 47 59 00 00 	movzbl 0x5947(%edx),%edx
  }while((x /= base) != 0);
    ...
    3e1e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3e31:	e9 ca 00 00 00       	jmp    3f00 <printf+0xf0>
    3e36:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    3e38:	83 fa 25             	cmp    $0x25,%edx
    3e3b:	0f 84 c7 00 00 00    	je     3f08 <printf+0xf8>
  write(fd, &c, 1);
    3e41:	8d 45 e0             	lea    -0x20(%ebp),%eax
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3e64:	0f 84 96 00 00 00    	je     3f00 <printf+0xf0>
    if(state == 0){
    ...
    3e74:	75 e5                	jne    3e5b <printf+0x4b>
      if(c == 'd' || c == 'u'){
    3e76:	83 fa 75             	cmp    $0x75,%edx
    3e79:	0f 84 99 00 00 00    	je     3f18 <printf+0x108>
    3e7f:	83 fa 64             	cmp    $0x64,%edx
    3e82:	0f 84 90 00 00 00    	je     3f18 <printf+0x108>
          // added unsigned - RJC
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3e88:	25 f7 00 00 00       	and    $0xf7,%eax
    3e8d:	83 f8 70             	cmp    $0x70,%eax
    3e90:	0f 84 aa 00 00 00    	je     3f40 <printf+0x130>
    ...
    3e96:	83 fa 73             	cmp    $0x73,%edx
    3e99:	0f 84 e9 00 00 00    	je     3f88 <printf+0x178>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3e9f:	83 fa 63             	cmp    $0x63,%edx
    3ea2:	0f 84 2b 01 00 00    	je     3fd3 <printf+0x1c3>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3ea8:	83 fa 25             	cmp    $0x25,%edx
    3eab:	0f 84 4f 01 00 00    	je     4000 <printf+0x1f0>
  write(fd, &c, 1);
    3eb1:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3eb4:	83 c3 01             	add    $0x1,%ebx
    3eb7:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ebe:	00 
      } else {
      ...
      state = 0;
    3ebf:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    3ec1:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ec5:	89 34 24             	mov    %esi,(%esp)
    3ec8:	89 55 d0             	mov    %edx,-0x30(%ebp)
    3ecb:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
    3ecf:	e8 ee fd ff ff       	call   3cc2 <write>
        putc(fd, c);
    3ed4:	8b 55 d0             	mov    -0x30(%ebp),%edx
  write(fd, &c, 1);
    3ed7:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3eda:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ee1:	00 
    3ee2:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ee6:	89 34 24             	mov    %esi,(%esp)
        putc(fd, c);
    3ee9:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3eec:	e8 d1 fd ff ff       	call   3cc2 <write>
  for(i = 0; fmt[i]; i++){
    3ef1:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3ef5:	84 d2                	test   %dl,%dl
    3ef7:	0f 85 6d ff ff ff    	jne    3e6a <printf+0x5a>
    ...
    3f07:	c3                   	ret    
        state = '%';
    3f08:	bf 25 00 00 00       	mov    $0x25,%edi
    3f0d:	e9 49 ff ff ff       	jmp    3e5b <printf+0x4b>
    3f12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    3f18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3f1f:	b9 0a 00 00 00       	mov    $0xa,%ecx
        printint(fd, *ap, 16, 0);
    3f24:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      state = 0;
    3f27:	31 ff                	xor    %edi,%edi
        printint(fd, *ap, 16, 0);
    3f29:	8b 10                	mov    (%eax),%edx
    3f2b:	89 f0                	mov    %esi,%eax
    3f2d:	e8 3e fe ff ff       	call   3d70 <printint>
        ap++;
    3f32:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3f36:	e9 20 ff ff ff       	jmp    3e5b <printf+0x4b>
    3f3b:	90                   	nop
    3f3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3f40:	8d 45 e1             	lea    -0x1f(%ebp),%eax
    3f43:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f4a:	00 
    3f4b:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f4f:	89 34 24             	mov    %esi,(%esp)
    3f52:	c6 45 e1 30          	movb   $0x30,-0x1f(%ebp)
    3f56:	e8 67 fd ff ff       	call   3cc2 <write>
    3f5b:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    3f5e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f65:	00 
    3f66:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f6a:	89 34 24             	mov    %esi,(%esp)
    3f6d:	c6 45 e2 78          	movb   $0x78,-0x1e(%ebp)
    3f71:	e8 4c fd ff ff       	call   3cc2 <write>
        printint(fd, *ap, 16, 0);
    3f76:	b9 10 00 00 00       	mov    $0x10,%ecx
    3f7b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3f82:	eb a0                	jmp    3f24 <printf+0x114>
    3f84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3f88:	8b 45 d4             	mov    -0x2c(%ebp),%eax
        ap++;
    3f8b:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
        s = (char*)*ap;
    3f8f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    3f91:	b8 40 59 00 00       	mov    $0x5940,%eax
    3f96:	85 ff                	test   %edi,%edi
    3f98:	0f 44 f8             	cmove  %eax,%edi
        while(*s != 0){
    3f9b:	0f b6 07             	movzbl (%edi),%eax
    3f9e:	84 c0                	test   %al,%al
    3fa0:	74 2a                	je     3fcc <printf+0x1bc>
    3fa2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3fa8:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    3fab:	8d 45 e3             	lea    -0x1d(%ebp),%eax
          s++;
    3fae:	83 c7 01             	add    $0x1,%edi
  write(fd, &c, 1);
    3fb1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3fb8:	00 
    3fb9:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fbd:	89 34 24             	mov    %esi,(%esp)
    3fc0:	e8 fd fc ff ff       	call   3cc2 <write>
        while(*s != 0){
    3fc5:	0f b6 07             	movzbl (%edi),%eax
    3fc8:	84 c0                	test   %al,%al
    3fca:	75 dc                	jne    3fa8 <printf+0x198>
      state = 0;
    3fcc:	31 ff                	xor    %edi,%edi
    3fce:	e9 88 fe ff ff       	jmp    3e5b <printf+0x4b>
        putc(fd, *ap);
    3fd3:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      state = 0;
    3fd6:	31 ff                	xor    %edi,%edi
        putc(fd, *ap);
    3fd8:	8b 00                	mov    (%eax),%eax
  write(fd, &c, 1);
    3fda:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3fe1:	00 
    3fe2:	89 34 24             	mov    %esi,(%esp)
        putc(fd, *ap);
    3fe5:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    3fe8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    3feb:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fef:	e8 ce fc ff ff       	call   3cc2 <write>
        ap++;
    3ff4:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3ff8:	e9 5e fe ff ff       	jmp    3e5b <printf+0x4b>
    3ffd:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    4000:	8d 45 e5             	lea    -0x1b(%ebp),%eax
      state = 0;
    4003:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    4005:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    400c:	00 
    400d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4011:	89 34 24             	mov    %esi,(%esp)
    4014:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
    4018:	e8 a5 fc ff ff       	call   3cc2 <write>
    401d:	e9 39 fe ff ff       	jmp    3e5b <printf+0x4b>
    4022:	66 90                	xchg   %ax,%ax
    4024:	66 90                	xchg   %ax,%ax
    4026:	66 90                	xchg   %ax,%ax
    4028:	66 90                	xchg   %ax,%ax
    402a:	66 90                	xchg   %ax,%ax
    402c:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4031:	a1 c0 62 00 00       	mov    0x62c0,%eax
{
    4036:	89 e5                	mov    %esp,%ebp
    4038:	57                   	push   %edi
    4039:	56                   	push   %esi
    403a:	53                   	push   %ebx
    403b:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    403e:	8b 08                	mov    (%eax),%ecx
  bp = (Header*)ap - 1;
    4040:	8d 53 f8             	lea    -0x8(%ebx),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4043:	39 d0                	cmp    %edx,%eax
    4045:	72 11                	jb     4058 <free+0x28>
    4047:	90                   	nop
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4048:	39 c8                	cmp    %ecx,%eax
    404a:	72 04                	jb     4050 <free+0x20>
    404c:	39 ca                	cmp    %ecx,%edx
    404e:	72 10                	jb     4060 <free+0x30>
    4050:	89 c8                	mov    %ecx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4052:	39 d0                	cmp    %edx,%eax
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4054:	8b 08                	mov    (%eax),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4056:	73 f0                	jae    4048 <free+0x18>
    4058:	39 ca                	cmp    %ecx,%edx
    405a:	72 04                	jb     4060 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    405c:	39 c8                	cmp    %ecx,%eax
    405e:	72 f0                	jb     4050 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    4060:	8b 73 fc             	mov    -0x4(%ebx),%esi
    4063:	8d 3c f2             	lea    (%edx,%esi,8),%edi
    4066:	39 cf                	cmp    %ecx,%edi
    4068:	74 1e                	je     4088 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    406a:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    406d:	8b 48 04             	mov    0x4(%eax),%ecx
    4070:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    4073:	39 f2                	cmp    %esi,%edx
    4075:	74 28                	je     409f <free+0x6f>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  ...
  freep = p;
    4079:	a3 c0 62 00 00       	mov    %eax,0x62c0
}
    407e:	5b                   	pop    %ebx
    407f:	5e                   	pop    %esi
    4080:	5f                   	pop    %edi
    ...
    4082:	c3                   	ret    
    4083:	90                   	nop
    4084:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
    4088:	03 71 04             	add    0x4(%ecx),%esi
    408b:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    408e:	8b 08                	mov    (%eax),%ecx
    4090:	8b 09                	mov    (%ecx),%ecx
    4092:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    4095:	8b 48 04             	mov    0x4(%eax),%ecx
    4098:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    409b:	39 f2                	cmp    %esi,%edx
    409d:	75 d8                	jne    4077 <free+0x47>
    p->s.size += bp->s.size;
    409f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
    40a2:	a3 c0 62 00 00       	mov    %eax,0x62c0
    p->s.size += bp->s.size;
    40a7:	89 48 04             	mov    %ecx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    40aa:	8b 53 f8             	mov    -0x8(%ebx),%edx
    40ad:	89 10                	mov    %edx,(%eax)
}
    40af:	5b                   	pop    %ebx
    40b0:	5e                   	pop    %esi
    40b1:	5f                   	pop    %edi
    40b2:	5d                   	pop    %ebp
    40b3:	c3                   	ret    
    40b4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    40ba:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40cc:	8b 1d c0 62 00 00    	mov    0x62c0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40d2:	8d 48 07             	lea    0x7(%eax),%ecx
    40d5:	c1 e9 03             	shr    $0x3,%ecx
  if((prevp = freep) == 0){
    40d8:	85 db                	test   %ebx,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40da:	8d 71 01             	lea    0x1(%ecx),%esi
  if((prevp = freep) == 0){
    40dd:	0f 84 9b 00 00 00    	je     417e <malloc+0xbe>
    40e3:	8b 13                	mov    (%ebx),%edx
    40e5:	8b 7a 04             	mov    0x4(%edx),%edi
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    40e8:	39 fe                	cmp    %edi,%esi
    40ea:	76 64                	jbe    4150 <malloc+0x90>
    40ec:	8d 04 f5 00 00 00 00 	lea    0x0(,%esi,8),%eax
  if(nu < 4096)
    40f3:	bb 00 80 00 00       	mov    $0x8000,%ebx
    40f8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    40fb:	eb 0e                	jmp    410b <malloc+0x4b>
    40fd:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4100:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    4102:	8b 78 04             	mov    0x4(%eax),%edi
    4105:	39 fe                	cmp    %edi,%esi
    4107:	76 4f                	jbe    4158 <malloc+0x98>
    ...
    if(p == freep)
    410b:	3b 15 c0 62 00 00    	cmp    0x62c0,%edx
    4111:	75 ed                	jne    4100 <malloc+0x40>
  if(nu < 4096)
    4113:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4116:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    411c:	bf 00 10 00 00       	mov    $0x1000,%edi
    4121:	0f 43 fe             	cmovae %esi,%edi
    4124:	0f 42 c3             	cmovb  %ebx,%eax
  p = sbrk(nu * sizeof(Header));
    4127:	89 04 24             	mov    %eax,(%esp)
    412a:	e8 fb fb ff ff       	call   3d2a <sbrk>
  if(p == (char*)-1)
    412f:	83 f8 ff             	cmp    $0xffffffff,%eax
    4132:	74 18                	je     414c <malloc+0x8c>
  hp->s.size = nu;
    4134:	89 78 04             	mov    %edi,0x4(%eax)
  free((void*)(hp + 1));
    4137:	83 c0 08             	add    $0x8,%eax
    413a:	89 04 24             	mov    %eax,(%esp)
    413d:	e8 ee fe ff ff       	call   4030 <free>
  return freep;
    4142:	8b 15 c0 62 00 00    	mov    0x62c0,%edx
      if((p = morecore(nunits)) == 0)
    4148:	85 d2                	test   %edx,%edx
    414a:	75 b4                	jne    4100 <malloc+0x40>
        return 0;
    414c:	31 c0                	xor    %eax,%eax
    414e:	eb 20                	jmp    4170 <malloc+0xb0>
    if(p->s.size >= nunits){
    4150:	89 d0                	mov    %edx,%eax
    4152:	89 da                	mov    %ebx,%edx
    4154:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    4158:	39 fe                	cmp    %edi,%esi
    415a:	74 1c                	je     4178 <malloc+0xb8>
        p->s.size -= nunits;
    415c:	29 f7                	sub    %esi,%edi
    415e:	89 78 04             	mov    %edi,0x4(%eax)
        p += p->s.size;
    4161:	8d 04 f8             	lea    (%eax,%edi,8),%eax
        p->s.size = nunits;
    4164:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    4167:	89 15 c0 62 00 00    	mov    %edx,0x62c0
      return (void*)(p + 1);
    416d:	83 c0 08             	add    $0x8,%eax
  }
}
    ...
    4177:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    4178:	8b 08                	mov    (%eax),%ecx
    417a:	89 0a                	mov    %ecx,(%edx)
    417c:	eb e9                	jmp    4167 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
    417e:	c7 05 c0 62 00 00 c4 	movl   $0x62c4,0x62c0
    4185:	62 00 00 
    base.s.size = 0;
    4188:	ba c4 62 00 00       	mov    $0x62c4,%edx
    base.s.ptr = freep = prevp = &base;
    418d:	c7 05 c4 62 00 00 c4 	movl   $0x62c4,0x62c4
    4194:	62 00 00 
    base.s.size = 0;
    4197:	c7 05 c8 62 00 00 00 	movl   $0x0,0x62c8
    419e:	00 00 00 
    41a1:	e9 46 ff ff ff       	jmp    40ec <malloc+0x2c>
