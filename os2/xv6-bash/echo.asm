...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c a6 07 00 	movl   $0x7a6,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 a8 07 00 	movl   $0x7a8,0x4(%esp)
  33:	00 
  ...
  4b:	c7 44 24 0c ad 07 00 	movl   $0x7ad,0xc(%esp)
  52:	00 
  53:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  57:	c7 44 24 04 a8 07 00 	movl   $0x7a8,0x4(%esp)
  5e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a9:	0f b6 92 b6 07 00 00 	movzbl 0x7b6(%edx),%edx
  }while((x /= base) != 0);
 ...
 41e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 58f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 591:	b8 af 07 00 00       	mov    $0x7af,%eax
...
free(void *ap)
{
 ...
 631:	a1 30 0a 00 00       	mov    0xa30,%eax
{
 ...
 69f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6a2:	a3 30 0a 00 00       	mov    %eax,0xa30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 1d 30 0a 00 00    	mov    0xa30,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 70b:	3b 15 30 0a 00 00    	cmp    0xa30,%edx
 ...
 73d:	e8 ee fe ff ff       	call   630 <free>
  return freep;
 742:	8b 15 30 0a 00 00    	mov    0xa30,%edx
 ...
 764:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 767:	89 15 30 0a 00 00    	mov    %edx,0xa30
      return (void*)(p + 1);
 ...
 77c:	eb e9                	jmp    767 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 77e:	c7 05 30 0a 00 00 34 	movl   $0xa34,0xa30
 785:	0a 00 00 
    base.s.size = 0;
 788:	ba 34 0a 00 00       	mov    $0xa34,%edx
    base.s.ptr = freep = prevp = &base;
 78d:	c7 05 34 0a 00 00 34 	movl   $0xa34,0xa34
 794:	0a 00 00 
    base.s.size = 0;
 797:	c7 05 38 0a 00 00 00 	movl   $0x0,0xa38
 79e:	00 00 00 
