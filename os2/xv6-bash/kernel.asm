...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 47 77 10 80 	movl   $0x80107747,(%esp)
...
801006c9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        s = "(null)";
801006cc:	b8 d8 6d 10 80       	mov    $0x80106dd8,%eax
...
801007b4:	e9 b0 fe ff ff       	jmp    80100669 <cprintf+0x19>
    panic("null fmt");
801007b9:	c7 04 24 df 6d 10 80 	movl   $0x80106ddf,(%esp)
...
80100976:	c7 44 24 04 e8 6d 10 	movl   $0x80106de8,0x4(%esp)
8010097d:	80 
...
80100a4a:	75 d4                	jne    80100a20 <exec+0x60>
  if((pgdir = setupkvm()) == 0)
80100a4c:	e8 8f 60 00 00       	call   80106ae0 <setupkvm>
...
80100af2:	e8 59 5e 00 00       	call   80106950 <allocuvm>
...
80100b33:	e8 58 5d 00 00       	call   80106890 <loaduvm>
...
80100b49:	e8 12 5f 00 00       	call   80106a60 <freevm>
...
80100b8c:	e8 bf 5d 00 00       	call   80106950 <allocuvm>
...
80100ba4:	e8 b7 5e 00 00       	call   80106a60 <freevm>
  return -1;
...
80100bb3:	e8 f8 1f 00 00       	call   80102bb0 <end_op>
    cprintf("exec: fail\n");
80100bb8:	c7 04 24 01 6e 10 80 	movl   $0x80106e01,(%esp)
...
80100be8:	e8 a3 5f 00 00       	call   80106b90 <clearpteu>
...
80100c51:	e8 9a 60 00 00       	call   80106cf0 <copyout>
...
80100cbe:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cc4:	e8 27 60 00 00       	call   80106cf0 <copyout>
...
80100d3f:	e8 bc 59 00 00       	call   80106700 <switchuvm>
  freevm(oldpgdir);
80100d44:	89 34 24             	mov    %esi,(%esp)
80100d47:	e8 14 5d 00 00       	call   80106a60 <freevm>
  return 0;
...
80100d76:	c7 44 24 04 0d 6e 10 	movl   $0x80106e0d,0x4(%esp)
80100d7d:	80 
...
80100e36:	c3                   	ret    
    panic("filedup");
80100e37:	c7 04 24 14 6e 10 80 	movl   $0x80106e14,(%esp)
...
80100ef7:	e9 b4 1c 00 00       	jmp    80102bb0 <end_op>
    panic("fileclose");
80100efc:	c7 04 24 1c 6e 10 80 	movl   $0x80106e1c,(%esp)
...
80100fe5:	eb d8                	jmp    80100fbf <fileread+0x5f>
  panic("fileread");
80100fe7:	c7 04 24 26 6e 10 80 	movl   $0x80106e26,(%esp)
...
801010fc:	e9 1f 22 00 00       	jmp    80103320 <pipewrite>
        panic("short filewrite");
80101101:	c7 04 24 2f 6e 10 80 	movl   $0x80106e2f,(%esp)
80101108:	e8 53 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
8010110d:	c7 04 24 35 6e 10 80 	movl   $0x80106e35,(%esp)
...
801011c5:	c7 04 24 3f 6e 10 80 	movl   $0x80106e3f,(%esp)
...
801012ed:	c7 04 24 55 6e 10 80 	movl   $0x80106e55,(%esp)
...
801013a5:	eb 93                	jmp    8010133a <bmap+0x3a>
  panic("bmap: out of range");
801013a7:	c7 04 24 65 6e 10 80 	movl   $0x80106e65,(%esp)
...
80101489:	c7 04 24 78 6e 10 80 	movl   $0x80106e78,(%esp)
...
801014ac:	c7 44 24 04 8b 6e 10 	movl   $0x80106e8b,0x4(%esp)
801014b3:	80 
...
801014c9:	c7 44 24 04 92 6e 10 	movl   $0x80106e92,0x4(%esp)
801014d0:	80 
...
801014f6:	c7 04 24 f8 6e 10 80 	movl   $0x80106ef8,(%esp)
...
80101611:	c7 04 24 98 6e 10 80 	movl   $0x80106e98,(%esp)
...
80101794:	0f 85 76 ff ff ff    	jne    80101710 <ilock+0x30>
      panic("ilock: no type");
8010179a:	c7 04 24 b0 6e 10 80 	movl   $0x80106eb0,(%esp)
801017a1:	e8 ba eb ff ff       	call   80100360 <panic>
    panic("ilock");
801017a6:	c7 04 24 aa 6e 10 80 	movl   $0x80106eaa,(%esp)
...
801017ee:	e9 fd 28 00 00       	jmp    801040f0 <releasesleep>
    panic("iunlock");
801017f3:	c7 04 24 bf 6e 10 80 	movl   $0x80106ebf,(%esp)
...
80101c91:	c3                   	ret    
      panic("dirlookup read");
80101c92:	c7 04 24 d9 6e 10 80 	movl   $0x80106ed9,(%esp)
80101c99:	e8 c2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c9e:	c7 04 24 c7 6e 10 80 	movl   $0x80106ec7,(%esp)
...
80101f13:	eb e9                	jmp    80101efe <dirlink+0xae>
      panic("dirlink read");
80101f15:	c7 04 24 e8 6e 10 80 	movl   $0x80106ee8,(%esp)
80101f1c:	e8 3f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101f21:	c7 04 24 2e 75 10 80 	movl   $0x8010752e,(%esp)
...
8010200f:	c7 04 24 54 6f 10 80 	movl   $0x80106f54,(%esp)
80102016:	e8 45 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
8010201b:	c7 04 24 4b 6f 10 80 	movl   $0x80106f4b,(%esp)
...
80102036:	c7 44 24 04 66 6f 10 	movl   $0x80106f66,0x4(%esp)
8010203d:	80 
...
80102209:	eb bb                	jmp    801021c6 <iderw+0x76>
    panic("iderw: buf not locked");
8010220b:	c7 04 24 6a 6f 10 80 	movl   $0x80106f6a,(%esp)
80102212:	e8 49 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
80102217:	c7 04 24 95 6f 10 80 	movl   $0x80106f95,(%esp)
8010221e:	e8 3d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
80102223:	c7 04 24 80 6f 10 80 	movl   $0x80106f80,(%esp)
...
80102278:	c7 04 24 b4 6f 10 80 	movl   $0x80106fb4,(%esp)
...
801023ac:	eb bb                	jmp    80102369 <kfree+0x49>
    panic("kfree");
801023ae:	c7 04 24 e6 6f 10 80 	movl   $0x80106fe6,(%esp)
...
8010241b:	c7 44 24 04 ec 6f 10 	movl   $0x80106fec,0x4(%esp)
80102422:	80 
...
80102564:	0f b6 81 20 71 10 80 	movzbl -0x7fef8ee0(%ecx),%eax
...
80102598:	0f b6 91 20 71 10 80 	movzbl -0x7fef8ee0(%ecx),%edx
  shift ^= togglecode[data];
8010259f:	0f b6 81 20 70 10 80 	movzbl -0x7fef8fe0(%ecx),%eax
  shift |= shiftcode[data];
...
801025af:	8b 04 85 00 70 10 80 	mov    -0x7fef9000(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102aab:	c7 44 24 04 20 72 10 	movl   $0x80107220,0x4(%esp)
80102ab2:	80 
...
80102cd2:	c3                   	ret    
    panic("log.committing");
80102cd3:	c7 04 24 24 72 10 80 	movl   $0x80107224,(%esp)
...
80102d8d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d90:	c7 04 24 33 72 10 80 	movl   $0x80107233,(%esp)
80102d97:	e8 c4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d9c:	c7 04 24 49 72 10 80 	movl   $0x80107249,(%esp)
...
80102dc7:	c7 04 24 64 72 10 80 	movl   $0x80107264,(%esp)
80102dce:	89 44 24 04          	mov    %eax,0x4(%esp)
80102dd2:	e8 79 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102dd7:	e8 44 28 00 00       	call   80105620 <idtinit>
...
80102e03:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e06:	e8 d5 38 00 00       	call   801066e0 <switchkvm>
  seginit();
80102e0b:	e8 10 38 00 00       	call   80106620 <seginit>
  lapicinit();
...
80102e43:	e8 28 3d 00 00       	call   80106b70 <kvmalloc>
...
80102e55:	e8 c6 37 00 00       	call   80106620 <seginit>
  picinit();       // disable pic
...
80102e70:	e8 9b 07 00 00       	call   80103610 <pinit>
  tvinit();        // trap vectors
80102e75:	e8 06 27 00 00       	call   80105580 <tvinit>
  binit();         // buffer cache
...
80102f6f:	00 
80102f70:	c7 44 24 04 78 72 10 	movl   $0x80107278,0x4(%esp)
80102f77:	80 
...
8010302a:	00 
8010302b:	c7 44 24 04 7d 72 10 	movl   $0x8010727d,0x4(%esp)
80103032:	80 
...
801030bc:	ff 24 8d bc 72 10 80 	jmp    *-0x7fef8d44(,%ecx,4)
801030c3:	90                   	nop
...
80103147:	0f 85 c5 fe ff ff    	jne    80103012 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010314d:	c7 04 24 82 72 10 80 	movl   $0x80107282,(%esp)
...
80103168:	eb e3                	jmp    8010314d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010316a:	c7 04 24 9c 72 10 80 	movl   $0x8010729c,(%esp)
...
8010320f:	c7 44 24 04 d0 72 10 	movl   $0x801072d0,0x4(%esp)
80103216:	80 
...
8010355d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103560:	c7 40 14 67 55 10 80 	movl   $0x80105567,0x14(%eax)
...
80103616:	c7 44 24 04 d5 72 10 	movl   $0x801072d5,0x4(%esp)
8010361d:	80 
...
8010368a:	c7 04 24 dc 72 10 80 	movl   $0x801072dc,(%esp)
80103691:	e8 ca cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103696:	c7 04 24 f8 73 10 80 	movl   $0x801073f8,(%esp)
...
80103713:	e8 c8 33 00 00       	call   80106ae0 <setupkvm>
...
80103735:	80 
80103736:	e8 d5 30 00 00       	call   80106810 <inituvm>
  p->sz = PGSIZE;
...
801037b2:	00 
801037b3:	c7 44 24 04 05 73 10 	movl   $0x80107305,0x4(%esp)
801037ba:	80 
801037bb:	89 04 24             	mov    %eax,(%esp)
801037be:	e8 cd 0d 00 00       	call   80104590 <safestrcpy>
  p->cwd = namei("/");
801037c3:	c7 04 24 0e 73 10 80 	movl   $0x8010730e,(%esp)
...
801037f7:	c7 04 24 ec 72 10 80 	movl   $0x801072ec,(%esp)
...
80103839:	e8 12 31 00 00       	call   80106950 <allocuvm>
...
80103847:	e8 b4 2e 00 00       	call   80106700 <switchuvm>
  return 0;
...
8010386a:	e8 d1 31 00 00       	call   80106a40 <deallocuvm>
...
801038bb:	e8 00 33 00 00       	call   80106bc0 <copyuvm>
...
80103966:	66 90                	xchg   %ax,%ax
      cprintf("fork() called\n");
80103968:	c7 04 24 10 73 10 80 	movl   $0x80107310,(%esp)
...
80103a02:	83 c3 7c             	add    $0x7c,%ebx
      switchuvm(p);
80103a05:	e8 f6 2c 00 00       	call   80106700 <switchuvm>
...
80103a1b:	e8 cb 0b 00 00       	call   801045eb <swtch>
      switchkvm();
80103a20:	e8 bb 2c 00 00       	call   801066e0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103abe:	c7 04 24 1f 73 10 80 	movl   $0x8010731f,(%esp)
80103ac5:	e8 96 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103aca:	c7 04 24 4b 73 10 80 	movl   $0x8010734b,(%esp)
80103ad1:	e8 8a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103ad6:	c7 04 24 3d 73 10 80 	movl   $0x8010733d,(%esp)
80103add:	e8 7e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103ae2:	c7 04 24 31 73 10 80 	movl   $0x80107331,(%esp)
...
80103be6:	e8 65 fe ff ff       	call   80103a50 <sched>
  panic("zombie exit");
80103beb:	c7 04 24 6c 73 10 80 	movl   $0x8010736c,(%esp)
80103bf2:	e8 69 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bf7:	c7 04 24 5f 73 10 80 	movl   $0x8010735f,(%esp)
...
80103cde:	c7 04 24 7e 73 10 80 	movl   $0x8010737e,(%esp)
80103ce5:	e8 76 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103cea:	c7 04 24 78 73 10 80 	movl   $0x80107378,(%esp)
...
80103d88:	e8 d3 2c 00 00       	call   80106a60 <freevm>
        release(&ptable.lock);
...
80103ed3:	e8 18 04 00 00       	call   801042f0 <acquire>
    cprintf(
80103ed8:	c7 04 24 96 73 10 80 	movl   $0x80107396,(%esp)
80103edf:	e8 6c c7 ff ff       	call   80100650 <cprintf>
        "pid\tppid\tname\tstate\tsize"
        );
    cprintf("\n");
80103ee4:	c7 04 24 47 77 10 80 	movl   $0x80107747,(%esp)
...
80103f12:	c7 04 24 af 73 10 80 	movl   $0x801073af,(%esp)
80103f19:	e8 32 c7 ff ff       	call   80100650 <cprintf>
            ...
            cprintf("\n");
80103f1e:	c7 04 24 47 77 10 80 	movl   $0x80107747,(%esp)
...
80103f3c:	83 f8 05             	cmp    $0x5,%eax
                state = "uknown";
80103f3f:	ba 8f 73 10 80       	mov    $0x8010738f,%edx
            if (ptable.proc[i].state >= 0 && ptable.proc[i].state < NELEM(states)
80103f44:	77 11                	ja     80103f57 <sys_cps+0x97>
                && states[ptable.proc[i].state]) {
80103f46:	8b 14 85 20 74 10 80 	mov    -0x7fef8be0(,%eax,4),%edx
                state = "uknown";
80103f4d:	b8 8f 73 10 80       	mov    $0x8010738f,%eax
...
80103f94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f98:	c7 04 24 47 77 10 80 	movl   $0x80107747,(%esp)
...
80103fe0:	c7 04 24 c2 73 10 80 	movl   $0x801073c2,(%esp)
...
80104029:	c7 04 24 c1 6d 10 80 	movl   $0x80106dc1,(%esp)
...
80104788:	83 fa 18             	cmp    $0x18,%edx
...
80104940:	c7 44 24 04 24 75 10 	movl   $0x80107524,0x4(%esp)
80104947:	80 
...
8010495b:	c7 44 24 04 23 75 10 	movl   $0x80107523,0x4(%esp)
80104962:	80 
...
80104971:	79 89                	jns    801048fc <create+0xdc>
      panic("create dots");
80104973:	c7 04 24 17 75 10 80 	movl   $0x80107517,(%esp)
8010497a:	e8 e1 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010497f:	c7 04 24 26 75 10 80 	movl   $0x80107526,(%esp)
80104986:	e8 d5 b9 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010498b:	c7 04 24 08 75 10 80 	movl   $0x80107508,(%esp)
...
80104d31:	c7 44 24 04 24 75 10 	movl   $0x80107524,0x4(%esp)
80104d38:	80 
...
80104d49:	c7 44 24 04 23 75 10 	movl   $0x80107523,0x4(%esp)
80104d50:	80 
...
80104e9d:	c7 04 24 48 75 10 80 	movl   $0x80107548,(%esp)
80104ea4:	e8 b7 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104ea9:	c7 04 24 5a 75 10 80 	movl   $0x8010755a,(%esp)
80104eb0:	e8 ab b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104eb5:	c7 04 24 36 75 10 80 	movl   $0x80107536,(%esp)
...
801054f2:	78 0c                	js     80105500 <sys_kdebug+0x30>
        return -1;
    debugState = tof;
801054f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054f7:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
    return 0;
...
80105514:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105517:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
8010551e:	e8 cd ed ff ff       	call   801042f0 <acquire>
  xticks = ticks;
80105523:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  release(&tickslock);
80105529:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80105530:	e8 2b ee ff ff       	call   80104360 <release>
  return xticks;
}
...
80105540:	55                   	push   %ebp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105541:	ba f4 00 00 00       	mov    $0xf4,%edx
...
80105594:	66 89 0c c5 c2 4c 11 	mov    %cx,-0x7feeb33e(,%eax,8)
8010559b:	80 
8010559c:	c6 04 c5 c4 4c 11 80 	movb   $0x0,-0x7feeb33c(,%eax,8)
801055a3:	00 
801055a4:	c6 04 c5 c5 4c 11 80 	movb   $0x8e,-0x7feeb33b(,%eax,8)
801055ab:	8e 
801055ac:	66 89 14 c5 c0 4c 11 	mov    %dx,-0x7feeb340(,%eax,8)
801055b3:	80 
801055b4:	c1 ea 10             	shr    $0x10,%edx
801055b7:	66 89 14 c5 c6 4c 11 	mov    %dx,-0x7feeb33a(,%eax,8)
801055be:	80 
  for(i = 0; i < 256; i++)
...
801055d9:	c7 44 24 04 69 75 10 	movl   $0x80107569,0x4(%esp)
801055e0:	80 
801055e1:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801055e8:	66 89 15 c2 4e 11 80 	mov    %dx,0x80114ec2
801055ef:	66 a3 c0 4e 11 80    	mov    %ax,0x80114ec0
801055f5:	c1 e8 10             	shr    $0x10,%eax
801055f8:	c6 05 c4 4e 11 80 00 	movb   $0x0,0x80114ec4
801055ff:	c6 05 c5 4e 11 80 ef 	movb   $0xef,0x80114ec5
80105606:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6
  initlock(&tickslock, "time");
8010560c:	e8 6f eb ff ff       	call   80104180 <initlock>
}
80105611:	c9                   	leave  
80105612:	c3                   	ret    
...
8010562b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010562f:	b8 c0 4c 11 80       	mov    $0x80114cc0,%eax
...
80105670:	ff 24 85 10 76 10 80 	jmp    *-0x7fef89f0(,%eax,4)
80105677:	90                   	nop
    lapiceoi();
    break;
...
80105678:	e8 53 e0 ff ff       	call   801036d0 <myproc>
...
8010569c:	e8 0f e0 ff ff       	call   801036b0 <cpuid>
...
801056ac:	e8 1f e0 ff ff       	call   801036d0 <myproc>
801056b1:	89 45 e0             	mov    %eax,-0x20(%ebp)
801056b4:	e8 17 e0 ff ff       	call   801036d0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801056e3:	c7 04 24 cc 75 10 80 	movl   $0x801075cc,(%esp)
801056ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801056ee:	e8 5d af ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801056f3:	e8 d8 df ff ff       	call   801036d0 <myproc>
...
80105700:	e8 cb df ff ff       	call   801036d0 <myproc>
...
80105715:	e8 b6 df ff ff       	call   801036d0 <myproc>
8010571a:	85 c0                	test   %eax,%eax
8010571c:	74 0d                	je     8010572b <trap+0xdb>
8010571e:	66 90                	xchg   %ax,%ax
80105720:	e8 ab df ff ff       	call   801036d0 <myproc>
...
80105729:	74 4d                	je     80105778 <trap+0x128>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010572b:	e8 a0 df ff ff       	call   801036d0 <myproc>
80105730:	85 c0                	test   %eax,%eax
80105732:	74 1d                	je     80105751 <trap+0x101>
80105734:	e8 97 df ff ff       	call   801036d0 <myproc>
...
8010576b:	75 a8                	jne    80105715 <trap+0xc5>
    exit();
8010576d:	e8 7e e3 ff ff       	call   80103af0 <exit>
...
801057c0:	e8 1b 02 00 00       	call   801059e0 <uartintr>
    lapiceoi();
801057c5:	e8 e6 cf ff ff       	call   801027b0 <lapiceoi>
    break;
...
801057d7:	e8 d4 de ff ff       	call   801036b0 <cpuid>
801057dc:	c7 04 24 74 75 10 80 	movl   $0x80107574,(%esp)
...
8010583f:	5d                   	pop    %ebp
      exit();
80105840:	e9 ab e2 ff ff       	jmp    80103af0 <exit>
80105845:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105848:	e8 a3 e2 ff ff       	call   80103af0 <exit>
8010584d:	eb cd                	jmp    8010581c <trap+0x1cc>
8010584f:	90                   	nop
      acquire(&tickslock);
80105850:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80105857:	e8 94 ea ff ff       	call   801042f0 <acquire>
      wakeup(&ticks);
8010585c:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      ticks++;
80105863:	83 05 c0 54 11 80 01 	addl   $0x1,0x801154c0
      wakeup(&ticks);
8010586a:	e8 71 e5 ff ff       	call   80103de0 <wakeup>
      release(&tickslock);
8010586f:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
...
80105886:	e8 25 de ff ff       	call   801036b0 <cpuid>
...
8010589a:	c7 04 24 98 75 10 80 	movl   $0x80107598,(%esp)
801058a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801058a5:	e8 a6 ad ff ff       	call   80100650 <cprintf>
      panic("trap");
801058aa:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
...
801059a7:	00 
  for(p="xv6...\n"; *p; p++)
801059a8:	bb 90 76 10 80       	mov    $0x80107690,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801059ed:	e8 de ad ff ff       	call   801007d0 <consoleintr>
}
801059f2:	c9                   	leave  
801059f3:	c3                   	ret    
...
801064b4:	e8 17 c0 ff ff       	call   801024d0 <kalloc>
...
80106571:	c3                   	ret    
      panic("remap");
80106572:	c7 04 24 98 76 10 80 	movl   $0x80107698,(%esp)
...
801065c3:	e8 58 bd ff ff       	call   80102320 <kfree>
      *pte = 0;
...
80106623:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106626:	e8 85 d0 ff ff       	call   801036b0 <cpuid>
...
80106638:	05 a0 27 11 80       	add    $0x801127a0,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
...
801066e0:	a1 c4 54 11 80       	mov    0x801154c4,%eax
{
...
80106724:	0f 84 c3 00 00 00    	je     801067ed <switchuvm+0xed>
  pushcli();
8010672a:	e8 d1 da ff ff       	call   80104200 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010672f:	e8 fc ce ff ff       	call   80103630 <mycpu>
80106734:	89 c3                	mov    %eax,%ebx
80106736:	e8 f5 ce ff ff       	call   80103630 <mycpu>
8010673b:	89 c7                	mov    %eax,%edi
8010673d:	e8 ee ce ff ff       	call   80103630 <mycpu>
80106742:	83 c7 08             	add    $0x8,%edi
80106745:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106748:	e8 e3 ce ff ff       	call   80103630 <mycpu>
...
801067db:	5d                   	pop    %ebp
  popcli();
801067dc:	e9 5f da ff ff       	jmp    80104240 <popcli>
    panic("switchuvm: no process");
801067e1:	c7 04 24 9e 76 10 80 	movl   $0x8010769e,(%esp)
801067e8:	e8 73 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801067ed:	c7 04 24 c9 76 10 80 	movl   $0x801076c9,(%esp)
801067f4:	e8 67 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801067f9:	c7 04 24 b4 76 10 80 	movl   $0x801076b4,(%esp)
...
8010682b:	77 54                	ja     80106881 <inituvm+0x71>
  mem = kalloc();
8010682d:	e8 9e bc ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106881:	c7 04 24 dd 76 10 80 	movl   $0x801076dd,(%esp)
...
8010690d:	e8 7e b0 ff ff       	call   80101990 <readi>
...
80106932:	c7 04 24 f7 76 10 80 	movl   $0x801076f7,(%esp)
80106939:	e8 22 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010693e:	c7 04 24 98 77 10 80 	movl   $0x80107798,(%esp)
...
801069c4:	76 2a                	jbe    801069f0 <allocuvm+0xa0>
    mem = kalloc();
801069c6:	e8 05 bb ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
801069d1:	c7 04 24 15 77 10 80 	movl   $0x80107715,(%esp)
...
80106a00:	c7 04 24 2d 77 10 80 	movl   $0x8010772d,(%esp)
...
80106a21:	e8 fa b8 ff ff       	call   80102320 <kfree>
      return 0;
...
80106aad:	e8 6e b8 ff ff       	call   80102320 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106ac2:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ac3:	e9 58 b8 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106ac8:	c7 04 24 49 77 10 80 	movl   $0x80107749,(%esp)
...
80106ae8:	e8 e3 b9 ff ff       	call   801024d0 <kalloc>
...
80106b7b:	a3 c4 54 11 80       	mov    %eax,0x801154c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106bab:	c3                   	ret    
    panic("clearpteu");
80106bac:	c7 04 24 5a 77 10 80 	movl   $0x8010775a,(%esp)
...
80106c50:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106c56:	e8 75 b8 ff ff       	call   801024d0 <kalloc>
...
80106c8b:	e8 90 b6 ff ff       	call   80102320 <kfree>
      goto bad;
...
80106c94:	eb d8                	jmp    80106c6e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106c96:	c7 04 24 7e 77 10 80 	movl   $0x8010777e,(%esp)
80106c9d:	e8 be 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106ca2:	c7 04 24 64 77 10 80 	movl   $0x80107764,(%esp)
