   ...
   b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "stressfs starting\n");
  16:	c7 44 24 04 66 08 00 	movl   $0x866,0x4(%esp)
  1d:	00 
  memset(data, 'a', sizeof(data));
  ...
  printf(1, "write %d\n", i);
  7e:	c7 44 24 04 79 08 00 	movl   $0x879,0x4(%esp)
  85:	00 
...
//    printf(fd, "%d\n", i);
  ...
  printf(1, "read\n");
  d6:	c7 44 24 04 83 08 00 	movl   $0x883,0x4(%esp)
  dd:	00 
 ...
 4de:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 4f1:	e9 ca 00 00 00       	jmp    5c0 <printf+0xf0>
 4f6:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 4f8:	83 fa 25             	cmp    $0x25,%edx
 4fb:	0f 84 c7 00 00 00    	je     5c8 <printf+0xf8>
  write(fd, &c, 1);
 501:	8d 45 e0             	lea    -0x20(%ebp),%eax
 ...
 524:	0f 84 96 00 00 00    	je     5c0 <printf+0xf0>
    if(state == 0){
 ...
 534:	75 e5                	jne    51b <printf+0x4b>
      if(c == 'd' || c == 'u'){
 536:	83 fa 75             	cmp    $0x75,%edx
 539:	0f 84 99 00 00 00    	je     5d8 <printf+0x108>
 53f:	83 fa 64             	cmp    $0x64,%edx
 542:	0f 84 90 00 00 00    	je     5d8 <printf+0x108>
          // added unsigned - RJC
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 548:	25 f7 00 00 00       	and    $0xf7,%eax
 54d:	83 f8 70             	cmp    $0x70,%eax
 550:	0f 84 aa 00 00 00    	je     600 <printf+0x130>
 ...
 556:	83 fa 73             	cmp    $0x73,%edx
 559:	0f 84 e9 00 00 00    	je     648 <printf+0x178>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 55f:	83 fa 63             	cmp    $0x63,%edx
 562:	0f 84 2b 01 00 00    	je     693 <printf+0x1c3>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 568:	83 fa 25             	cmp    $0x25,%edx
 56b:	0f 84 4f 01 00 00    	je     6c0 <printf+0x1f0>
  write(fd, &c, 1);
 571:	8d 45 e6             	lea    -0x1a(%ebp),%eax
 574:	83 c3 01             	add    $0x1,%ebx
 577:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 57e:	00 
      } else {
 ...
 585:	89 34 24             	mov    %esi,(%esp)
 588:	89 55 d0             	mov    %edx,-0x30(%ebp)
 58b:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
 58f:	e8 ee fd ff ff       	call   382 <write>
        putc(fd, c);
 594:	8b 55 d0             	mov    -0x30(%ebp),%edx
  write(fd, &c, 1);
 ...
 5a9:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 5ac:	e8 d1 fd ff ff       	call   382 <write>
  for(i = 0; fmt[i]; i++){
 5b1:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
 5b5:	84 d2                	test   %dl,%dl
 5b7:	0f 85 6d ff ff ff    	jne    52a <printf+0x5a>
 ...
 5cd:	e9 49 ff ff ff       	jmp    51b <printf+0x4b>
 5d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
 5d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 5df:	b9 0a 00 00 00       	mov    $0xa,%ecx
        printint(fd, *ap, 16, 0);
 ...
 5ed:	e8 3e fe ff ff       	call   430 <printint>
        ap++;
 5f2:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 5f6:	e9 20 ff ff ff       	jmp    51b <printf+0x4b>
 5fb:	90                   	nop
 5fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
 600:	8d 45 e1             	lea    -0x1f(%ebp),%eax
 603:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 60a:	00 
 60b:	89 44 24 04          	mov    %eax,0x4(%esp)
 60f:	89 34 24             	mov    %esi,(%esp)
 612:	c6 45 e1 30          	movb   $0x30,-0x1f(%ebp)
 616:	e8 67 fd ff ff       	call   382 <write>
 61b:	8d 45 e2             	lea    -0x1e(%ebp),%eax
 61e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 625:	00 
 626:	89 44 24 04          	mov    %eax,0x4(%esp)
 62a:	89 34 24             	mov    %esi,(%esp)
 62d:	c6 45 e2 78          	movb   $0x78,-0x1e(%ebp)
 631:	e8 4c fd ff ff       	call   382 <write>
        printint(fd, *ap, 16, 0);
 636:	b9 10 00 00 00       	mov    $0x10,%ecx
 63b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 642:	eb a0                	jmp    5e4 <printf+0x114>
 ...
 680:	e8 fd fc ff ff       	call   382 <write>
        while(*s != 0){
 685:	0f b6 07             	movzbl (%edi),%eax
 688:	84 c0                	test   %al,%al
 68a:	75 dc                	jne    668 <printf+0x198>
      state = 0;
 68c:	31 ff                	xor    %edi,%edi
 68e:	e9 88 fe ff ff       	jmp    51b <printf+0x4b>
        putc(fd, *ap);
 ...
 6a2:	89 34 24             	mov    %esi,(%esp)
        putc(fd, *ap);
 6a5:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
 6a8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 6ab:	89 44 24 04          	mov    %eax,0x4(%esp)
 6af:	e8 ce fc ff ff       	call   382 <write>
        ap++;
 6b4:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 6b8:	e9 5e fe ff ff       	jmp    51b <printf+0x4b>
 ...
 6c3:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 6c5:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 6cc:	00 
 6cd:	89 44 24 04          	mov    %eax,0x4(%esp)
 6d1:	89 34 24             	mov    %esi,(%esp)
 6d4:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
 6d8:	e8 a5 fc ff ff       	call   382 <write>
 6dd:	e9 39 fe ff ff       	jmp    51b <printf+0x4b>
...
free(void *ap)
{
 ...
 6f1:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 737:	89 10                	mov    %edx,(%eax)
  freep = p;
 739:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 73e:	5b                   	pop    %ebx
 73f:	5e                   	pop    %esi
 740:	5f                   	pop    %edi
 ...
 75f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 762:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 1d 0c 0b 00 00    	mov    0xb0c,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 7cb:	3b 15 0c 0b 00 00    	cmp    0xb0c,%edx
 ...
 7ea:	e8 fb fb ff ff       	call   3ea <sbrk>
  if(p == (char*)-1)
 ...
 7fd:	e8 ee fe ff ff       	call   6f0 <free>
  return freep;
 802:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 824:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 827:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
      return (void*)(p + 1);
 ...
 83c:	eb e9                	jmp    827 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 83e:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 845:	0b 00 00 
    base.s.size = 0;
 848:	ba 10 0b 00 00       	mov    $0xb10,%edx
    base.s.ptr = freep = prevp = &base;
 84d:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 854:	0b 00 00 
    base.s.size = 0;
 857:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 85e:	00 00 00 
