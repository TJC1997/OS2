...
printint(int fd, int xx, int base, int sgn)
{
 ...
 339:	0f b6 92 3d 07 00 00 	movzbl 0x73d(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 3c1:	e9 ca 00 00 00       	jmp    490 <printf+0xf0>
 3c6:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 3c8:	83 fa 25             	cmp    $0x25,%edx
 3cb:	0f 84 c7 00 00 00    	je     498 <printf+0xf8>
  write(fd, &c, 1);
 3d1:	8d 45 e0             	lea    -0x20(%ebp),%eax
 ...
 3f4:	0f 84 96 00 00 00    	je     490 <printf+0xf0>
    if(state == 0){
 ...
 404:	75 e5                	jne    3eb <printf+0x4b>
      if(c == 'd' || c == 'u'){
 406:	83 fa 75             	cmp    $0x75,%edx
 409:	0f 84 99 00 00 00    	je     4a8 <printf+0x108>
 40f:	83 fa 64             	cmp    $0x64,%edx
 412:	0f 84 90 00 00 00    	je     4a8 <printf+0x108>
          // added unsigned - RJC
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 418:	25 f7 00 00 00       	and    $0xf7,%eax
 41d:	83 f8 70             	cmp    $0x70,%eax
 420:	0f 84 aa 00 00 00    	je     4d0 <printf+0x130>
 ...
 426:	83 fa 73             	cmp    $0x73,%edx
 429:	0f 84 e9 00 00 00    	je     518 <printf+0x178>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 42f:	83 fa 63             	cmp    $0x63,%edx
 432:	0f 84 2b 01 00 00    	je     563 <printf+0x1c3>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 438:	83 fa 25             	cmp    $0x25,%edx
 43b:	0f 84 4f 01 00 00    	je     590 <printf+0x1f0>
  write(fd, &c, 1);
 441:	8d 45 e6             	lea    -0x1a(%ebp),%eax
 ...
 458:	89 55 d0             	mov    %edx,-0x30(%ebp)
 45b:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
 45f:	e8 ee fd ff ff       	call   252 <write>
        putc(fd, c);
 464:	8b 55 d0             	mov    -0x30(%ebp),%edx
  write(fd, &c, 1);
 467:	8d 45 e7             	lea    -0x19(%ebp),%eax
 46a:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 471:	00 
 472:	89 44 24 04          	mov    %eax,0x4(%esp)
 476:	89 34 24             	mov    %esi,(%esp)
        putc(fd, c);
 479:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 47c:	e8 d1 fd ff ff       	call   252 <write>
  for(i = 0; fmt[i]; i++){
 481:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
 485:	84 d2                	test   %dl,%dl
 487:	0f 85 6d ff ff ff    	jne    3fa <printf+0x5a>
 ...
 49d:	e9 49 ff ff ff       	jmp    3eb <printf+0x4b>
 ...
 4bd:	e8 3e fe ff ff       	call   300 <printint>
        ap++;
 4c2:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 4c6:	e9 20 ff ff ff       	jmp    3eb <printf+0x4b>
 4cb:	90                   	nop
 4cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
 4d0:	8d 45 e1             	lea    -0x1f(%ebp),%eax
 4d3:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 4da:	00 
 4db:	89 44 24 04          	mov    %eax,0x4(%esp)
 4df:	89 34 24             	mov    %esi,(%esp)
 4e2:	c6 45 e1 30          	movb   $0x30,-0x1f(%ebp)
 4e6:	e8 67 fd ff ff       	call   252 <write>
 4eb:	8d 45 e2             	lea    -0x1e(%ebp),%eax
 4ee:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 4f5:	00 
 4f6:	89 44 24 04          	mov    %eax,0x4(%esp)
 4fa:	89 34 24             	mov    %esi,(%esp)
 4fd:	c6 45 e2 78          	movb   $0x78,-0x1e(%ebp)
 501:	e8 4c fd ff ff       	call   252 <write>
        printint(fd, *ap, 16, 0);
 506:	b9 10 00 00 00       	mov    $0x10,%ecx
 50b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 512:	eb a0                	jmp    4b4 <printf+0x114>
 ...
 550:	e8 fd fc ff ff       	call   252 <write>
        while(*s != 0){
 555:	0f b6 07             	movzbl (%edi),%eax
 558:	84 c0                	test   %al,%al
 55a:	75 dc                	jne    538 <printf+0x198>
      state = 0;
 55c:	31 ff                	xor    %edi,%edi
 55e:	e9 88 fe ff ff       	jmp    3eb <printf+0x4b>
        putc(fd, *ap);
 ...
 57f:	e8 ce fc ff ff       	call   252 <write>
        ap++;
 584:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
 588:	e9 5e fe ff ff       	jmp    3eb <printf+0x4b>
 58d:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
 590:	8d 45 e5             	lea    -0x1b(%ebp),%eax
      state = 0;
 593:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 595:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
 59c:	00 
 59d:	89 44 24 04          	mov    %eax,0x4(%esp)
 5a1:	89 34 24             	mov    %esi,(%esp)
 5a4:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
 5a8:	e8 a5 fc ff ff       	call   252 <write>
 5ad:	e9 39 fe ff ff       	jmp    3eb <printf+0x4b>
...
free(void *ap)
{
 ...
 5c1:	a1 b4 09 00 00       	mov    0x9b4,%eax
{
 ...
 607:	89 10                	mov    %edx,(%eax)
  freep = p;
 609:	a3 b4 09 00 00       	mov    %eax,0x9b4
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 632:	a3 b4 09 00 00       	mov    %eax,0x9b4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 1d b4 09 00 00    	mov    0x9b4,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 699:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 69b:	3b 15 b4 09 00 00    	cmp    0x9b4,%edx
 ...
 6ba:	e8 fb fb ff ff       	call   2ba <sbrk>
  if(p == (char*)-1)
 ...
 6f4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 b4 09 00 00    	mov    %edx,0x9b4
      return (void*)(p + 1);
 ...
 70c:	eb e9                	jmp    6f7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 70e:	c7 05 b4 09 00 00 b8 	movl   $0x9b8,0x9b4
 715:	09 00 00 
    base.s.size = 0;
 718:	ba b8 09 00 00       	mov    $0x9b8,%edx
    base.s.ptr = freep = prevp = &base;
 71d:	c7 05 b8 09 00 00 b8 	movl   $0x9b8,0x9b8
 724:	09 00 00 
    base.s.size = 0;
 727:	c7 05 bc 09 00 00 00 	movl   $0x0,0x9bc
 72e:	00 00 00 
