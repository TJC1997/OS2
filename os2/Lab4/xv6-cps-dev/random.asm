...
printint(int fd, int xx, int base, int sgn)
{
 ...
 359:	0f b6 92 72 07 00 00 	movzbl 0x772(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ce:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 53f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 541:	b8 6b 07 00 00       	mov    $0x76b,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 e8 09 00 00       	mov    0x9e8,%eax
{
 ...
 627:	89 10                	mov    %edx,(%eax)
  freep = p;
 629:	a3 e8 09 00 00       	mov    %eax,0x9e8
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 652:	a3 e8 09 00 00       	mov    %eax,0x9e8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 1d e8 09 00 00    	mov    0x9e8,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6bb:	3b 15 e8 09 00 00    	cmp    0x9e8,%edx
 ...
 6ed:	e8 ee fe ff ff       	call   5e0 <free>
  return freep;
 6f2:	8b 15 e8 09 00 00    	mov    0x9e8,%edx
 ...
 714:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 717:	89 15 e8 09 00 00    	mov    %edx,0x9e8
      return (void*)(p + 1);
 ...
 72c:	eb e9                	jmp    717 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 72e:	c7 05 e8 09 00 00 ec 	movl   $0x9ec,0x9e8
 735:	09 00 00 
    base.s.size = 0;
 738:	ba ec 09 00 00       	mov    $0x9ec,%edx
    base.s.ptr = freep = prevp = &base;
 73d:	c7 05 ec 09 00 00 ec 	movl   $0x9ec,0x9ec
 744:	09 00 00 
    base.s.size = 0;
 747:	c7 05 f0 09 00 00 00 	movl   $0x0,0x9f0
 74e:	00 00 00 
