...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      20:	00 
      21:	c7 04 24 89 13 00 00 	movl   $0x1389,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      5d:	00 
      5e:	c7 04 24 80 19 00 00 	movl   $0x1980,(%esp)
      65:	e8 96 00 00 00       	call   100 <getcmd>
      6a:	85 c0                	test   %eax,%eax
      6c:	78 2f                	js     9d <main+0x9d>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6e:	80 3d 80 19 00 00 63 	cmpb   $0x63,0x1980
      75:	75 d1                	jne    48 <main+0x48>
      77:	80 3d 81 19 00 00 64 	cmpb   $0x64,0x1981
    ...
    if(fork1() == 0)
      ...
      runcmd(parsecmd(buf));
      89:	c7 04 24 80 19 00 00 	movl   $0x1980,(%esp)
  ...
  exit();
      ...
      buf[strlen(buf)-1] = 0;  // chop \n
      a2:	c7 04 24 80 19 00 00 	movl   $0x1980,(%esp)
      a9:	e8 92 0b 00 00       	call   c40 <strlen>
      if(chdir(buf+3) < 0)
      ae:	c7 04 24 83 19 00 00 	movl   $0x1983,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      b5:	c6 80 7f 19 00 00 00 	movb   $0x0,0x197f(%eax)
      if(chdir(buf+3) < 0)
      bc:	e8 91 0d 00 00       	call   e52 <chdir>
      c1:	85 c0                	test   %eax,%eax
      c3:	79 91                	jns    56 <main+0x56>
        printf(2, "cannot cd %s\n", buf+3);
      c5:	c7 44 24 08 83 19 00 	movl   $0x1983,0x8(%esp)
      cc:	00 
      cd:	c7 44 24 04 91 13 00 	movl   $0x1391,0x4(%esp)
      d4:	00 
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     10e:	c7 44 24 04 e8 12 00 	movl   $0x12e8,0x4(%esp)
     115:	00 
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	c7 44 24 04 85 13 00 	movl   $0x1385,0x4(%esp)
     170:	00 
...
fork1(void)
{
  ...
  return pid;
     ...
     1a1:	c3                   	ret    
    panic("fork");
     1a2:	c7 04 24 eb 12 00 00 	movl   $0x12eb,(%esp)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 a0 13 00 00 	jmp    *0x13a0(,%eax,4)
    if(pipe(p) < 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     24b:	c7 44 24 04 f7 12 00 	movl   $0x12f7,0x4(%esp)
     252:	00 
    ...
    panic("runcmd");
     2ae:	c7 04 24 f0 12 00 00 	movl   $0x12f0,(%esp)
     2b5:	e8 a6 fe ff ff       	call   160 <panic>
      panic("pipe");
     2ba:	c7 04 24 17 13 00 00 	movl   $0x1317,(%esp)
     2c1:	e8 9a fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2c6:	8b 43 08             	mov    0x8(%ebx),%eax
     2c9:	c7 44 24 04 07 13 00 	movl   $0x1307,0x4(%esp)
     2d0:	00 
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     36e:	e8 8d 0e 00 00       	call   1200 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ae:	e8 4d 0e 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     40e:	e8 ed 0d 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     45e:	e8 9d 0d 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4ae:	e8 4d 0d 00 00       	call   1200 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4f9:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     51a:	c7 04 24 70 19 00 00 	movl   $0x1970,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     56a:	c7 04 24 70 19 00 00 	movl   $0x1970,(%esp)
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5bb:	c7 04 24 68 19 00 00 	movl   $0x1968,(%esp)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5dd:	c7 04 24 70 19 00 00 	movl   $0x1970,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     652:	c7 04 24 70 19 00 00 	movl   $0x1970,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     6a0:	c7 44 24 08 39 13 00 	movl   $0x1339,0x8(%esp)
     6a7:	00 
  ...
  return cmd;
     ...
     762:	c3                   	ret    
      panic("missing file for redirection");
     763:	c7 04 24 1c 13 00 00 	movl   $0x131c,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     77f:	c7 44 24 08 3c 13 00 	movl   $0x133c,0x8(%esp)
     786:	00 
  ...
  while(!peek(ps, es, "|)&;")){
     7de:	c7 44 24 08 53 13 00 	movl   $0x1353,0x8(%esp)
     7e5:	00 
    ...
    if(argc >= MAXARGS)
     ...
     82f:	75 97                	jne    7c8 <parseexec+0x58>
      panic("too many args");
     831:	c7 04 24 45 13 00 00 	movl   $0x1345,(%esp)
  ...
  return ret;
     ...
     879:	c3                   	ret    
      panic("syntax");
     87a:	c7 04 24 3e 13 00 00 	movl   $0x133e,(%esp)
...
00000890 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     8ab:	c7 44 24 08 58 13 00 	movl   $0x1358,0x8(%esp)
     8b2:	00 
...
00000910 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     956:	c7 44 24 08 5a 13 00 	movl   $0x135a,0x8(%esp)
     95d:	00 
  ...
  if(peek(ps, es, ";")){
     96e:	c7 44 24 08 56 13 00 	movl   $0x1356,0x8(%esp)
     975:	00 
...
000009d0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     9df:	c7 44 24 08 3c 13 00 	movl   $0x133c,0x8(%esp)
     9e6:	00 
  ...
  if(!peek(ps, es, ")"))
     a1f:	c7 44 24 08 78 13 00 	movl   $0x1378,0x8(%esp)
     a26:	00 
  ...
  cmd = parseredirs(cmd, ps, es);
     ...
     a6c:	c3                   	ret    
    panic("parseblock");
     a6d:	c7 04 24 5c 13 00 00 	movl   $0x135c,(%esp)
     a74:	e8 e7 f6 ff ff       	call   160 <panic>
    panic("syntax - missing )");
     a79:	c7 04 24 67 13 00 00 	movl   $0x1367,(%esp)
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     aa9:	ff 24 85 b8 13 00 00 	jmp    *0x13b8(,%eax,4)
...
00000b40 <parsecmd>:
{
  ...
  peek(&s, es, "");
     b64:	c7 44 24 08 06 13 00 	movl   $0x1306,0x8(%esp)
     b6b:	00 
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     b99:	c7 44 24 04 7a 13 00 	movl   $0x137a,0x4(%esp)
     ba0:	00 
     ba1:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     ba8:	e8 a3 03 00 00       	call   f50 <printf>
    panic("syntax");
     bad:	c7 04 24 3e 13 00 00 	movl   $0x133e,(%esp)
...
#endif // CPS
SYSCALL(rrand)
     e92:	b8 19 00 00 00       	mov    $0x19,%eax
     e97:	cd 40                	int    $0x40
     e99:	c3                   	ret    

00000e9a <kdebug>:
SYSCALL(kdebug)
     e9a:	b8 18 00 00 00       	mov    $0x18,%eax
     e9f:	cd 40                	int    $0x40
     ea1:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee9:	0f b6 92 d7 13 00 00 	movzbl 0x13d7(%edx),%edx
  }while((x /= base) != 0);
     ...
     f5e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f71:	e9 ca 00 00 00       	jmp    1040 <printf+0xf0>
     f76:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
     f78:	83 fa 25             	cmp    $0x25,%edx
     f7b:	0f 84 c7 00 00 00    	je     1048 <printf+0xf8>
  write(fd, &c, 1);
     f81:	8d 45 e0             	lea    -0x20(%ebp),%eax
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fa4:	0f 84 96 00 00 00    	je     1040 <printf+0xf0>
    if(state == 0){
    ...
    if(state == 0){
     ...
     fb4:	75 e5                	jne    f9b <printf+0x4b>
      if(c == 'd' || c == 'u'){
     fb6:	83 fa 75             	cmp    $0x75,%edx
     fb9:	0f 84 99 00 00 00    	je     1058 <printf+0x108>
     fbf:	83 fa 64             	cmp    $0x64,%edx
     fc2:	0f 84 90 00 00 00    	je     1058 <printf+0x108>
          // added unsigned - RJC
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     fc8:	25 f7 00 00 00       	and    $0xf7,%eax
     fcd:	83 f8 70             	cmp    $0x70,%eax
     fd0:	0f 84 aa 00 00 00    	je     1080 <printf+0x130>
     ...
     fd6:	83 fa 73             	cmp    $0x73,%edx
     fd9:	0f 84 e9 00 00 00    	je     10c8 <printf+0x178>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     fdf:	83 fa 63             	cmp    $0x63,%edx
     fe2:	0f 84 2b 01 00 00    	je     1113 <printf+0x1c3>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     fe8:	83 fa 25             	cmp    $0x25,%edx
     feb:	0f 84 4f 01 00 00    	je     1140 <printf+0x1f0>
  write(fd, &c, 1);
     ff1:	8d 45 e6             	lea    -0x1a(%ebp),%eax
     ff4:	83 c3 01             	add    $0x1,%ebx
     ff7:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     ffe:	00 
      } else {
      ...
      state = 0;
     fff:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    1001:	89 44 24 04          	mov    %eax,0x4(%esp)
    1005:	89 34 24             	mov    %esi,(%esp)
    1008:	89 55 d0             	mov    %edx,-0x30(%ebp)
    100b:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
    100f:	e8 ee fd ff ff       	call   e02 <write>
        putc(fd, c);
    1014:	8b 55 d0             	mov    -0x30(%ebp),%edx
  write(fd, &c, 1);
    1017:	8d 45 e7             	lea    -0x19(%ebp),%eax
    101a:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    1021:	00 
    1022:	89 44 24 04          	mov    %eax,0x4(%esp)
    1026:	89 34 24             	mov    %esi,(%esp)
        putc(fd, c);
    1029:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    102c:	e8 d1 fd ff ff       	call   e02 <write>
  for(i = 0; fmt[i]; i++){
    1031:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    1035:	84 d2                	test   %dl,%dl
    1037:	0f 85 6d ff ff ff    	jne    faa <printf+0x5a>
    103d:	8d 76 00             	lea    0x0(%esi),%esi
    }
  }
}
    1040:	83 c4 3c             	add    $0x3c,%esp
    1043:	5b                   	pop    %ebx
    1044:	5e                   	pop    %esi
    1045:	5f                   	pop    %edi
    1046:	5d                   	pop    %ebp
    1047:	c3                   	ret    
        state = '%';
    1048:	bf 25 00 00 00       	mov    $0x25,%edi
    104d:	e9 49 ff ff ff       	jmp    f9b <printf+0x4b>
    1052:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    1058:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    105f:	b9 0a 00 00 00       	mov    $0xa,%ecx
        printint(fd, *ap, 16, 0);
    1064:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      state = 0;
    1067:	31 ff                	xor    %edi,%edi
        printint(fd, *ap, 16, 0);
    1069:	8b 10                	mov    (%eax),%edx
    106b:	89 f0                	mov    %esi,%eax
    106d:	e8 3e fe ff ff       	call   eb0 <printint>
        ap++;
    1072:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    1076:	e9 20 ff ff ff       	jmp    f9b <printf+0x4b>
    107b:	90                   	nop
    107c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    1080:	8d 45 e1             	lea    -0x1f(%ebp),%eax
    1083:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    108a:	00 
    108b:	89 44 24 04          	mov    %eax,0x4(%esp)
    108f:	89 34 24             	mov    %esi,(%esp)
    1092:	c6 45 e1 30          	movb   $0x30,-0x1f(%ebp)
    1096:	e8 67 fd ff ff       	call   e02 <write>
    109b:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    109e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    10a5:	00 
    10a6:	89 44 24 04          	mov    %eax,0x4(%esp)
    10aa:	89 34 24             	mov    %esi,(%esp)
    10ad:	c6 45 e2 78          	movb   $0x78,-0x1e(%ebp)
    10b1:	e8 4c fd ff ff       	call   e02 <write>
        printint(fd, *ap, 16, 0);
    10b6:	b9 10 00 00 00       	mov    $0x10,%ecx
    10bb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    10c2:	eb a0                	jmp    1064 <printf+0x114>
    10c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    10c8:	8b 45 d4             	mov    -0x2c(%ebp),%eax
        ap++;
    10cb:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
        s = (char*)*ap;
    10cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    10d1:	b8 d0 13 00 00       	mov    $0x13d0,%eax
    10d6:	85 ff                	test   %edi,%edi
    10d8:	0f 44 f8             	cmove  %eax,%edi
        while(*s != 0){
    10db:	0f b6 07             	movzbl (%edi),%eax
    10de:	84 c0                	test   %al,%al
    10e0:	74 2a                	je     110c <printf+0x1bc>
    10e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    10e8:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    10eb:	8d 45 e3             	lea    -0x1d(%ebp),%eax
          s++;
    10ee:	83 c7 01             	add    $0x1,%edi
  write(fd, &c, 1);
    10f1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    10f8:	00 
    10f9:	89 44 24 04          	mov    %eax,0x4(%esp)
    10fd:	89 34 24             	mov    %esi,(%esp)
    1100:	e8 fd fc ff ff       	call   e02 <write>
        while(*s != 0){
    1105:	0f b6 07             	movzbl (%edi),%eax
    1108:	84 c0                	test   %al,%al
    110a:	75 dc                	jne    10e8 <printf+0x198>
      state = 0;
    110c:	31 ff                	xor    %edi,%edi
    110e:	e9 88 fe ff ff       	jmp    f9b <printf+0x4b>
        putc(fd, *ap);
    1113:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      state = 0;
    1116:	31 ff                	xor    %edi,%edi
        putc(fd, *ap);
    1118:	8b 00                	mov    (%eax),%eax
  write(fd, &c, 1);
    111a:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    1121:	00 
    1122:	89 34 24             	mov    %esi,(%esp)
        putc(fd, *ap);
    1125:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    1128:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    112b:	89 44 24 04          	mov    %eax,0x4(%esp)
    112f:	e8 ce fc ff ff       	call   e02 <write>
        ap++;
    1134:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    1138:	e9 5e fe ff ff       	jmp    f9b <printf+0x4b>
    113d:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    1140:	8d 45 e5             	lea    -0x1b(%ebp),%eax
      state = 0;
    1143:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    1145:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    114c:	00 
    114d:	89 44 24 04          	mov    %eax,0x4(%esp)
    1151:	89 34 24             	mov    %esi,(%esp)
    1154:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
    1158:	e8 a5 fc ff ff       	call   e02 <write>
    115d:	e9 39 fe ff ff       	jmp    f9b <printf+0x4b>
    1162:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1171:	a1 e4 19 00 00       	mov    0x19e4,%eax
{
  ...
  bp = (Header*)ap - 1;
    1180:	8d 53 f8             	lea    -0x8(%ebx),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1183:	39 d0                	cmp    %edx,%eax
    1185:	72 11                	jb     1198 <free+0x28>
    1187:	90                   	nop
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1188:	39 c8                	cmp    %ecx,%eax
    118a:	72 04                	jb     1190 <free+0x20>
    118c:	39 ca                	cmp    %ecx,%edx
    118e:	72 10                	jb     11a0 <free+0x30>
    1190:	89 c8                	mov    %ecx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1192:	39 d0                	cmp    %edx,%eax
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1194:	8b 08                	mov    (%eax),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1196:	73 f0                	jae    1188 <free+0x18>
    1198:	39 ca                	cmp    %ecx,%edx
    119a:	72 04                	jb     11a0 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11a3:	8d 3c f2             	lea    (%edx,%esi,8),%edi
    11a6:	39 cf                	cmp    %ecx,%edi
    11a8:	74 1e                	je     11c8 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    11aa:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    11ad:	8b 48 04             	mov    0x4(%eax),%ecx
    11b0:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    11b3:	39 f2                	cmp    %esi,%edx
    11b5:	74 28                	je     11df <free+0x6f>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    11b7:	89 10                	mov    %edx,(%eax)
  freep = p;
    11b9:	a3 e4 19 00 00       	mov    %eax,0x19e4
}
    11be:	5b                   	pop    %ebx
    11bf:	5e                   	pop    %esi
    11c0:	5f                   	pop    %edi
    ...
    bp->s.size += p->s.ptr->s.size;
    11c8:	03 71 04             	add    0x4(%ecx),%esi
    11cb:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    11ce:	8b 08                	mov    (%eax),%ecx
    11d0:	8b 09                	mov    (%ecx),%ecx
    11d2:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    11d5:	8b 48 04             	mov    0x4(%eax),%ecx
    11d8:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    11db:	39 f2                	cmp    %esi,%edx
    11dd:	75 d8                	jne    11b7 <free+0x47>
    p->s.size += bp->s.size;
    11df:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
    11e2:	a3 e4 19 00 00       	mov    %eax,0x19e4
    p->s.size += bp->s.size;
    11e7:	89 48 04             	mov    %ecx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    11ea:	8b 53 f8             	mov    -0x8(%ebx),%edx
    11ed:	89 10                	mov    %edx,(%eax)
}
    11ef:	5b                   	pop    %ebx
    11f0:	5e                   	pop    %esi
    11f1:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    120c:	8b 1d e4 19 00 00    	mov    0x19e4,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1212:	8d 48 07             	lea    0x7(%eax),%ecx
    1215:	c1 e9 03             	shr    $0x3,%ecx
  if((prevp = freep) == 0){
    1218:	85 db                	test   %ebx,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    121a:	8d 71 01             	lea    0x1(%ecx),%esi
  if((prevp = freep) == 0){
    121d:	0f 84 9b 00 00 00    	je     12be <malloc+0xbe>
    1223:	8b 13                	mov    (%ebx),%edx
    1225:	8b 7a 04             	mov    0x4(%edx),%edi
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    1228:	39 fe                	cmp    %edi,%esi
    122a:	76 64                	jbe    1290 <malloc+0x90>
    122c:	8d 04 f5 00 00 00 00 	lea    0x0(,%esi,8),%eax
  if(nu < 4096)
    1233:	bb 00 80 00 00       	mov    $0x8000,%ebx
    1238:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    123b:	eb 0e                	jmp    124b <malloc+0x4b>
    123d:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1240:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1242:	8b 78 04             	mov    0x4(%eax),%edi
    1245:	39 fe                	cmp    %edi,%esi
    1247:	76 4f                	jbe    1298 <malloc+0x98>
    ...
    if(p == freep)
    124b:	3b 15 e4 19 00 00    	cmp    0x19e4,%edx
    1251:	75 ed                	jne    1240 <malloc+0x40>
  if(nu < 4096)
    1253:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1256:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    125c:	bf 00 10 00 00       	mov    $0x1000,%edi
    1261:	0f 43 fe             	cmovae %esi,%edi
    1264:	0f 42 c3             	cmovb  %ebx,%eax
  p = sbrk(nu * sizeof(Header));
    1267:	89 04 24             	mov    %eax,(%esp)
    126a:	e8 fb fb ff ff       	call   e6a <sbrk>
  if(p == (char*)-1)
    126f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1272:	74 18                	je     128c <malloc+0x8c>
  hp->s.size = nu;
    1274:	89 78 04             	mov    %edi,0x4(%eax)
  free((void*)(hp + 1));
    1277:	83 c0 08             	add    $0x8,%eax
    127a:	89 04 24             	mov    %eax,(%esp)
    127d:	e8 ee fe ff ff       	call   1170 <free>
  return freep;
    1282:	8b 15 e4 19 00 00    	mov    0x19e4,%edx
      if((p = morecore(nunits)) == 0)
    1288:	85 d2                	test   %edx,%edx
    128a:	75 b4                	jne    1240 <malloc+0x40>
        return 0;
    128c:	31 c0                	xor    %eax,%eax
    128e:	eb 20                	jmp    12b0 <malloc+0xb0>
    if(p->s.size >= nunits){
    ...
    129a:	74 1c                	je     12b8 <malloc+0xb8>
        p->s.size -= nunits;
    129c:	29 f7                	sub    %esi,%edi
    129e:	89 78 04             	mov    %edi,0x4(%eax)
        p += p->s.size;
    12a1:	8d 04 f8             	lea    (%eax,%edi,8),%eax
        p->s.size = nunits;
    12a4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    12a7:	89 15 e4 19 00 00    	mov    %edx,0x19e4
      return (void*)(p + 1);
    12ad:	83 c0 08             	add    $0x8,%eax
  }
}
    12b0:	83 c4 1c             	add    $0x1c,%esp
    12b3:	5b                   	pop    %ebx
    12b4:	5e                   	pop    %esi
    12b5:	5f                   	pop    %edi
    12b6:	5d                   	pop    %ebp
    12b7:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    12b8:	8b 08                	mov    (%eax),%ecx
    12ba:	89 0a                	mov    %ecx,(%edx)
    12bc:	eb e9                	jmp    12a7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
    12be:	c7 05 e4 19 00 00 e8 	movl   $0x19e8,0x19e4
    12c5:	19 00 00 
    base.s.size = 0;
    12c8:	ba e8 19 00 00       	mov    $0x19e8,%edx
    base.s.ptr = freep = prevp = &base;
    12cd:	c7 05 e8 19 00 00 e8 	movl   $0x19e8,0x19e8
    12d4:	19 00 00 
    base.s.size = 0;
    12d7:	c7 05 ec 19 00 00 00 	movl   $0x0,0x19ec
    12de:	00 00 00 
    12e1:	e9 46 ff ff ff       	jmp    122c <malloc+0x2c>
