...
main(int argc, char **argv)
{
  ...
  10:	e8 bb 06 00 00       	call   6d0 <malloc>
    int rez = -17;

    ptr = malloc(20);
  15:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  1c:	e8 af 06 00 00       	call   6d0 <malloc>
  ...
  34:	e8 29 03 00 00       	call   362 <kthread_create>
    printf(1, "%s %d: %d\n", __FILE__, __LINE__, rez);
  39:	c7 44 24 0c 20 00 00 	movl   $0x20,0xc(%esp)
  40:	00 
  41:	c7 44 24 08 d5 08 00 	movl   $0x8d5,0x8(%esp)
  48:	00 
  49:	c7 44 24 04 de 08 00 	movl   $0x8de,0x4(%esp)
  50:	00 
...
00000070 <func1>:
{
  ...
  73:	5d                   	pop    %ebp
    kthread_exit(i);
  74:	e9 f9 02 00 00       	jmp    372 <kthread_exit>
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 f0 08 00 00 	movzbl 0x8f0(%edx),%edx
  }while((x /= base) != 0);
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 59f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5a1:	b8 e9 08 00 00       	mov    $0x8e9,%eax
...
benny_thread_create(benny_thread_t *vbt, void (*func)(void*), void *arg_ptr)
{
 ...
 818:	00 
 819:	c7 44 24 08 01 09 00 	movl   $0x901,0x8(%esp)
 820:	00 
 821:	c7 44 24 04 10 09 00 	movl   $0x910,0x4(%esp)
 828:	00 
 829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 830:	e8 eb fb ff ff       	call   420 <printf>
    printf(1,"tid:: %u\n",bt->tid);
 835:	8b 03                	mov    (%ebx),%eax
 837:	c7 44 24 04 27 09 00 	movl   $0x927,0x4(%esp)
 83e:	00 
