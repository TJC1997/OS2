...
main(int argc, char *argv[])
{
   ...
   7:	83 ec 10             	sub    $0x10,%esp
    ...
    int pid = -1;
    int ppid = getpid();
   a:	e8 13 03 00 00       	call   322 <getpid>
   f:	89 c3                	mov    %eax,%ebx
  ...
  18:	75 4e                	jne    68 <main+0x68>
        int cppid = getppid();
  1a:	e8 23 03 00 00       	call   342 <getppid>
        assert(ppid == cppid);
  1f:	39 c3                	cmp    %eax,%ebx
  21:	74 29                	je     4c <main+0x4c>
  23:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  2a:	00 
  2b:	c7 44 24 08 d8 08 00 	movl   $0x8d8,0x8(%esp)
  32:	00 
  33:	c7 44 24 04 fc 08 00 	movl   $0x8fc,0x4(%esp)
  3a:	00 
  ...
  4c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  50:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  54:	c7 44 24 04 e6 08 00 	movl   $0x8e6,0x4(%esp)
  5b:	00 
  5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  63:	e8 b8 03 00 00       	call   420 <printf>
    }
    wait();
  68:	e8 3d 02 00 00       	call   2aa <wait>
#endif
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 27 09 00 00 	movzbl 0x927(%edx),%edx
  }while((x /= base) != 0);
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 59f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5a1:	b8 20 09 00 00       	mov    $0x920,%eax
...
free(void *ap)
{
 ...
 641:	a1 58 0c 00 00       	mov    0xc58,%eax
{
 ...
 687:	89 10                	mov    %edx,(%eax)
  freep = p;
 689:	a3 58 0c 00 00       	mov    %eax,0xc58
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6af:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6b2:	a3 58 0c 00 00       	mov    %eax,0xc58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 1d 58 0c 00 00    	mov    0xc58,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 71b:	3b 15 58 0c 00 00    	cmp    0xc58,%edx
 ...
 74d:	e8 ee fe ff ff       	call   640 <free>
  return freep;
 752:	8b 15 58 0c 00 00    	mov    0xc58,%edx
 ...
 774:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 777:	89 15 58 0c 00 00    	mov    %edx,0xc58
      return (void*)(p + 1);
 ...
 78c:	eb e9                	jmp    777 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 78e:	c7 05 58 0c 00 00 5c 	movl   $0xc5c,0xc58
 795:	0c 00 00 
    base.s.size = 0;
 798:	ba 5c 0c 00 00       	mov    $0xc5c,%edx
    base.s.ptr = freep = prevp = &base;
 79d:	c7 05 5c 0c 00 00 5c 	movl   $0xc5c,0xc5c
 7a4:	0c 00 00 
    base.s.size = 0;
 7a7:	c7 05 60 0c 00 00 00 	movl   $0x0,0xc60
 7ae:	00 00 00 
...
benny_thread_create(benny_thread_t *vbt, void (*func)(void*), void *arg_ptr)
{
 ...
 818:	00 
 819:	c7 44 24 08 38 09 00 	movl   $0x938,0x8(%esp)
 820:	00 
 821:	c7 44 24 04 47 09 00 	movl   $0x947,0x4(%esp)
 828:	00 
 829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 830:	e8 eb fb ff ff       	call   420 <printf>
    printf(1,"tid:: %u\n",bt->tid);
 835:	8b 03                	mov    (%ebx),%eax
 837:	c7 44 24 04 5e 09 00 	movl   $0x95e,0x4(%esp)
 83e:	00 
