   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  3f:	c7 44 24 04 ec 08 00 	movl   $0x8ec,0x4(%esp)
  46:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 0f 09 00 00 	movzbl 0x90f(%edx),%edx
  }while((x /= base) != 0);
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 59f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5a1:	b8 08 09 00 00       	mov    $0x908,%eax
...
free(void *ap)
{
 ...
 641:	a1 48 0c 00 00       	mov    0xc48,%eax
{
 ...
 687:	89 10                	mov    %edx,(%eax)
  freep = p;
 689:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6af:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6b2:	a3 48 0c 00 00       	mov    %eax,0xc48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 1d 48 0c 00 00    	mov    0xc48,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 71b:	3b 15 48 0c 00 00    	cmp    0xc48,%edx
 ...
 74d:	e8 ee fe ff ff       	call   640 <free>
  return freep;
 752:	8b 15 48 0c 00 00    	mov    0xc48,%edx
 ...
 774:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 777:	89 15 48 0c 00 00    	mov    %edx,0xc48
      return (void*)(p + 1);
 ...
 795:	0c 00 00 
    base.s.size = 0;
 798:	ba 4c 0c 00 00       	mov    $0xc4c,%edx
    base.s.ptr = freep = prevp = &base;
 79d:	c7 05 4c 0c 00 00 4c 	movl   $0xc4c,0xc4c
 7a4:	0c 00 00 
    base.s.size = 0;
 7a7:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 7ae:	00 00 00 
...
benny_thread_create(benny_thread_t *vbt, void (*func)(void*), void *arg_ptr)
{
 ...
 818:	00 
 819:	c7 44 24 08 20 09 00 	movl   $0x920,0x8(%esp)
 820:	00 
 821:	c7 44 24 04 2f 09 00 	movl   $0x92f,0x4(%esp)
 828:	00 
 829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 830:	e8 eb fb ff ff       	call   420 <printf>
    printf(1,"tid:: %u\n",bt->tid);
 835:	8b 03                	mov    (%ebx),%eax
 837:	c7 44 24 04 46 09 00 	movl   $0x946,0x4(%esp)
 83e:	00 
