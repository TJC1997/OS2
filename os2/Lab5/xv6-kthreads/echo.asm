...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c d5 08 00 	movl   $0x8d5,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 d7 08 00 	movl   $0x8d7,0x4(%esp)
  33:	00 
  ...
  4b:	c7 44 24 0c 18 09 00 	movl   $0x918,0xc(%esp)
  52:	00 
  53:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  57:	c7 44 24 04 d7 08 00 	movl   $0x8d7,0x4(%esp)
  5e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 e3 08 00 00 	movzbl 0x8e3(%edx),%edx
  }while((x /= base) != 0);
 ...
 42e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 59f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5a1:	b8 dc 08 00 00       	mov    $0x8dc,%eax
...
free(void *ap)
{
 ...
 641:	a1 18 0c 00 00       	mov    0xc18,%eax
{
 ...
 687:	89 10                	mov    %edx,(%eax)
  freep = p;
 689:	a3 18 0c 00 00       	mov    %eax,0xc18
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6af:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6b2:	a3 18 0c 00 00       	mov    %eax,0xc18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 1d 18 0c 00 00    	mov    0xc18,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 71b:	3b 15 18 0c 00 00    	cmp    0xc18,%edx
 ...
 74d:	e8 ee fe ff ff       	call   640 <free>
  return freep;
 752:	8b 15 18 0c 00 00    	mov    0xc18,%edx
 ...
 774:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 777:	89 15 18 0c 00 00    	mov    %edx,0xc18
      return (void*)(p + 1);
 ...
 78c:	eb e9                	jmp    777 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 78e:	c7 05 18 0c 00 00 1c 	movl   $0xc1c,0xc18
 795:	0c 00 00 
    base.s.size = 0;
 798:	ba 1c 0c 00 00       	mov    $0xc1c,%edx
    base.s.ptr = freep = prevp = &base;
 79d:	c7 05 1c 0c 00 00 1c 	movl   $0xc1c,0xc1c
 7a4:	0c 00 00 
    base.s.size = 0;
 7a7:	c7 05 20 0c 00 00 00 	movl   $0x0,0xc20
 7ae:	00 00 00 
...
benny_thread_create(benny_thread_t *vbt, void (*func)(void*), void *arg_ptr)
{
 ...
 818:	00 
 819:	c7 44 24 08 f4 08 00 	movl   $0x8f4,0x8(%esp)
 820:	00 
 821:	c7 44 24 04 03 09 00 	movl   $0x903,0x4(%esp)
 828:	00 
 829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 830:	e8 eb fb ff ff       	call   420 <printf>
    printf(1,"tid:: %u\n",bt->tid);
 835:	8b 03                	mov    (%ebx),%eax
 837:	c7 44 24 04 1a 09 00 	movl   $0x91a,0x4(%esp)
 83e:	00 
