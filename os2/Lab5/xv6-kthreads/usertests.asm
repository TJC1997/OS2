...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
       9:	c7 44 24 04 c6 52 00 	movl   $0x52c6,0x4(%esp)
      10:	00 
      11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      18:	e8 03 3e 00 00       	call   3e20 <printf>

  if(open("usertests.ran", 0) >= 0){
      1d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      24:	00 
      25:	c7 04 24 da 52 00 00 	movl   $0x52da,(%esp)
      2c:	e8 b1 3c 00 00       	call   3ce2 <open>
      31:	85 c0                	test   %eax,%eax
      33:	78 19                	js     4e <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
      35:	c7 44 24 04 44 5a 00 	movl   $0x5a44,0x4(%esp)
      3c:	00 
      3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
      44:	e8 d7 3d 00 00       	call   3e20 <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
      ...
      55:	00 
      56:	c7 04 24 da 52 00 00 	movl   $0x52da,(%esp)
...
00000130 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     136:	a1 10 64 00 00       	mov    0x6410,%eax
     13b:	c7 44 24 04 6c 43 00 	movl   $0x436c,0x4(%esp)
     142:	00 
     143:	89 04 24             	mov    %eax,(%esp)
     146:	e8 d5 3c 00 00       	call   3e20 <printf>
  if(mkdir("iputdir") < 0){
     14b:	c7 04 24 ff 42 00 00 	movl   $0x42ff,(%esp)
     152:	e8 b3 3b 00 00       	call   3d0a <mkdir>
     157:	85 c0                	test   %eax,%eax
     159:	78 4b                	js     1a6 <iputtest+0x76>
  if(chdir("iputdir") < 0){
     15b:	c7 04 24 ff 42 00 00 	movl   $0x42ff,(%esp)
     162:	e8 ab 3b 00 00       	call   3d12 <chdir>
     167:	85 c0                	test   %eax,%eax
     169:	0f 88 85 00 00 00    	js     1f4 <iputtest+0xc4>
  if(unlink("../iputdir") < 0){
     16f:	c7 04 24 fc 42 00 00 	movl   $0x42fc,(%esp)
     176:	e8 77 3b 00 00       	call   3cf2 <unlink>
     17b:	85 c0                	test   %eax,%eax
     17d:	78 5b                	js     1da <iputtest+0xaa>
  if(chdir("/") < 0){
     17f:	c7 04 24 21 43 00 00 	movl   $0x4321,(%esp)
     186:	e8 87 3b 00 00       	call   3d12 <chdir>
     18b:	85 c0                	test   %eax,%eax
     18d:	78 31                	js     1c0 <iputtest+0x90>
  printf(stdout, "iput test ok\n");
     18f:	a1 10 64 00 00       	mov    0x6410,%eax
     194:	c7 44 24 04 a4 43 00 	movl   $0x43a4,0x4(%esp)
     19b:	00 
     19c:	89 04 24             	mov    %eax,(%esp)
     19f:	e8 7c 3c 00 00       	call   3e20 <printf>
}
     1a4:	c9                   	leave  
     1a5:	c3                   	ret    
    printf(stdout, "mkdir failed\n");
     1a6:	a1 10 64 00 00       	mov    0x6410,%eax
     1ab:	c7 44 24 04 d8 42 00 	movl   $0x42d8,0x4(%esp)
     1b2:	00 
     1b3:	89 04 24             	mov    %eax,(%esp)
     1b6:	e8 65 3c 00 00       	call   3e20 <printf>
    exit();
     1bb:	e8 e2 3a 00 00       	call   3ca2 <exit>
    printf(stdout, "chdir / failed\n");
     1c0:	a1 10 64 00 00       	mov    0x6410,%eax
     1c5:	c7 44 24 04 23 43 00 	movl   $0x4323,0x4(%esp)
     1cc:	00 
     1cd:	89 04 24             	mov    %eax,(%esp)
     1d0:	e8 4b 3c 00 00       	call   3e20 <printf>
    exit();
     1d5:	e8 c8 3a 00 00       	call   3ca2 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1da:	a1 10 64 00 00       	mov    0x6410,%eax
     1df:	c7 44 24 04 07 43 00 	movl   $0x4307,0x4(%esp)
     1e6:	00 
     1e7:	89 04 24             	mov    %eax,(%esp)
     1ea:	e8 31 3c 00 00       	call   3e20 <printf>
    exit();
     1ef:	e8 ae 3a 00 00       	call   3ca2 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1f4:	a1 10 64 00 00       	mov    0x6410,%eax
     1f9:	c7 44 24 04 e6 42 00 	movl   $0x42e6,0x4(%esp)
     200:	00 
     201:	89 04 24             	mov    %eax,(%esp)
     204:	e8 17 3c 00 00       	call   3e20 <printf>
    exit();
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     216:	a1 10 64 00 00       	mov    0x6410,%eax
     21b:	c7 44 24 04 33 43 00 	movl   $0x4333,0x4(%esp)
     222:	00 
     223:	89 04 24             	mov    %eax,(%esp)
     226:	e8 f5 3b 00 00       	call   3e20 <printf>
  pid = fork();
  ...
  printf(stdout, "exitiput test ok\n");
     275:	a1 10 64 00 00       	mov    0x6410,%eax
     27a:	c7 44 24 04 56 43 00 	movl   $0x4356,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 96 3b 00 00       	call   3e20 <printf>
}
     28a:	c9                   	leave  
     28b:	c3                   	ret    
     28c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(stdout, "unlink ../iputdir failed\n");
     290:	a1 10 64 00 00       	mov    0x6410,%eax
     295:	c7 44 24 04 07 43 00 	movl   $0x4307,0x4(%esp)
     29c:	00 
     29d:	89 04 24             	mov    %eax,(%esp)
     2a0:	e8 7b 3b 00 00       	call   3e20 <printf>
      exit();
     2a5:	e8 f8 39 00 00       	call   3ca2 <exit>
    printf(stdout, "fork failed\n");
     2aa:	a1 10 64 00 00       	mov    0x6410,%eax
     2af:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
     2b6:	00 
     2b7:	89 04 24             	mov    %eax,(%esp)
     2ba:	e8 61 3b 00 00       	call   3e20 <printf>
    exit();
     2bf:	e8 de 39 00 00       	call   3ca2 <exit>
      printf(stdout, "child chdir failed\n");
     2c4:	a1 10 64 00 00       	mov    0x6410,%eax
     2c9:	c7 44 24 04 42 43 00 	movl   $0x4342,0x4(%esp)
     2d0:	00 
     2d1:	89 04 24             	mov    %eax,(%esp)
     2d4:	e8 47 3b 00 00       	call   3e20 <printf>
      exit();
     2d9:	e8 c4 39 00 00       	call   3ca2 <exit>
      printf(stdout, "mkdir failed\n");
     2de:	a1 10 64 00 00       	mov    0x6410,%eax
     2e3:	c7 44 24 04 d8 42 00 	movl   $0x42d8,0x4(%esp)
     2ea:	00 
     2eb:	89 04 24             	mov    %eax,(%esp)
     2ee:	e8 2d 3b 00 00       	call   3e20 <printf>
      exit();
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     306:	a1 10 64 00 00       	mov    0x6410,%eax
     30b:	c7 44 24 04 68 43 00 	movl   $0x4368,0x4(%esp)
     312:	00 
     313:	89 04 24             	mov    %eax,(%esp)
     316:	e8 05 3b 00 00       	call   3e20 <printf>
  if(mkdir("oidir") < 0){
     31b:	c7 04 24 77 43 00 00 	movl   $0x4377,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     349:	00 
     34a:	c7 04 24 77 43 00 00 	movl   $0x4377,(%esp)
     351:	e8 8c 39 00 00       	call   3ce2 <open>
    if(fd >= 0){
     356:	85 c0                	test   %eax,%eax
     358:	78 6e                	js     3c8 <openiputtest+0xc8>
      printf(stdout, "open directory for write succeeded\n");
     35a:	a1 10 64 00 00       	mov    0x6410,%eax
     35f:	c7 44 24 04 fc 52 00 	movl   $0x52fc,0x4(%esp)
     366:	00 
     367:	89 04 24             	mov    %eax,(%esp)
     36a:	e8 b1 3a 00 00       	call   3e20 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     384:	c7 04 24 77 43 00 00 	movl   $0x4377,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     399:	a1 10 64 00 00       	mov    0x6410,%eax
     39e:	c7 44 24 04 a0 43 00 	movl   $0x43a0,0x4(%esp)
     3a5:	00 
     3a6:	89 04 24             	mov    %eax,(%esp)
     3a9:	e8 72 3a 00 00       	call   3e20 <printf>
}
     3ae:	c9                   	leave  
     3af:	c3                   	ret    
    printf(stdout, "unlink failed\n");
     3b0:	a1 10 64 00 00       	mov    0x6410,%eax
     3b5:	c7 44 24 04 91 43 00 	movl   $0x4391,0x4(%esp)
     3bc:	00 
     3bd:	89 04 24             	mov    %eax,(%esp)
     3c0:	e8 5b 3a 00 00       	call   3e20 <printf>
     3c5:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
     3c8:	e8 d5 38 00 00       	call   3ca2 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cd:	a1 10 64 00 00       	mov    0x6410,%eax
     3d2:	c7 44 24 04 7d 43 00 	movl   $0x437d,0x4(%esp)
     3d9:	00 
     3da:	89 04 24             	mov    %eax,(%esp)
     3dd:	e8 3e 3a 00 00       	call   3e20 <printf>
    exit();
     3e2:	e8 bb 38 00 00       	call   3ca2 <exit>
    printf(stdout, "fork failed\n");
     3e7:	a1 10 64 00 00       	mov    0x6410,%eax
     3ec:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
     3f3:	00 
     3f4:	89 04 24             	mov    %eax,(%esp)
     3f7:	e8 24 3a 00 00       	call   3e20 <printf>
    exit();
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     416:	a1 10 64 00 00       	mov    0x6410,%eax
     41b:	c7 44 24 04 b2 43 00 	movl   $0x43b2,0x4(%esp)
     422:	00 
     423:	89 04 24             	mov    %eax,(%esp)
     426:	e8 f5 39 00 00       	call   3e20 <printf>
  fd = open("echo", 0);
     42b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     432:	00 
     433:	c7 04 24 bd 43 00 00 	movl   $0x43bd,(%esp)
  ...
  fd = open("doesnotexist", 0);
     ...
     452:	00 
     453:	c7 04 24 d5 43 00 00 	movl   $0x43d5,(%esp)
     45a:	e8 83 38 00 00       	call   3ce2 <open>
  if(fd >= 0){
     45f:	85 c0                	test   %eax,%eax
     461:	79 31                	jns    494 <opentest+0x84>
  printf(stdout, "open test ok\n");
     463:	a1 10 64 00 00       	mov    0x6410,%eax
     468:	c7 44 24 04 00 44 00 	movl   $0x4400,0x4(%esp)
     46f:	00 
     470:	89 04 24             	mov    %eax,(%esp)
     473:	e8 a8 39 00 00       	call   3e20 <printf>
}
     478:	c9                   	leave  
     479:	c3                   	ret    
    printf(stdout, "open echo failed!\n");
     47a:	a1 10 64 00 00       	mov    0x6410,%eax
     47f:	c7 44 24 04 c2 43 00 	movl   $0x43c2,0x4(%esp)
     486:	00 
     487:	89 04 24             	mov    %eax,(%esp)
     48a:	e8 91 39 00 00       	call   3e20 <printf>
    exit();
     48f:	e8 0e 38 00 00       	call   3ca2 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     494:	a1 10 64 00 00       	mov    0x6410,%eax
     499:	c7 44 24 04 e2 43 00 	movl   $0x43e2,0x4(%esp)
     4a0:	00 
     4a1:	89 04 24             	mov    %eax,(%esp)
     4a4:	e8 77 39 00 00       	call   3e20 <printf>
    exit();
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     4b8:	a1 10 64 00 00       	mov    0x6410,%eax
     4bd:	c7 44 24 04 0e 44 00 	movl   $0x440e,0x4(%esp)
     4c4:	00 
     4c5:	89 04 24             	mov    %eax,(%esp)
     4c8:	e8 53 39 00 00       	call   3e20 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4cd:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     4d4:	00 
     4d5:	c7 04 24 1f 44 00 00 	movl   $0x441f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4eb:	a1 10 64 00 00       	mov    0x6410,%eax
  for(i = 0; i < 100; i++){
     4f0:	31 db                	xor    %ebx,%ebx
    printf(stdout, "creat small succeeded; ok\n");
     4f2:	c7 44 24 04 25 44 00 	movl   $0x4425,0x4(%esp)
     4f9:	00 
     4fa:	89 04 24             	mov    %eax,(%esp)
     4fd:	e8 1e 39 00 00       	call   3e20 <printf>
     502:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     508:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     50f:	00 
     510:	c7 44 24 04 5c 44 00 	movl   $0x445c,0x4(%esp)
     517:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     530:	00 
     531:	c7 44 24 04 67 44 00 	movl   $0x4467,0x4(%esp)
     538:	00 
  ...
  printf(stdout, "writes ok\n");
     552:	a1 10 64 00 00       	mov    0x6410,%eax
     557:	c7 44 24 04 72 44 00 	movl   $0x4472,0x4(%esp)
     55e:	00 
     55f:	89 04 24             	mov    %eax,(%esp)
     562:	e8 b9 38 00 00       	call   3e20 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     576:	00 
     577:	c7 04 24 1f 44 00 00 	movl   $0x441f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     58d:	a1 10 64 00 00       	mov    0x6410,%eax
     592:	c7 44 24 04 7d 44 00 	movl   $0x447d,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 7e 38 00 00       	call   3e20 <printf>
  i = read(fd, buf, 2000);
     5a2:	c7 44 24 08 d0 07 00 	movl   $0x7d0,0x8(%esp)
     5a9:	00 
     5aa:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
     5b1:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     5c5:	a1 10 64 00 00       	mov    0x6410,%eax
     5ca:	c7 44 24 04 b1 44 00 	movl   $0x44b1,0x4(%esp)
     5d1:	00 
     5d2:	89 04 24             	mov    %eax,(%esp)
     5d5:	e8 46 38 00 00       	call   3e20 <printf>
  close(fd);
     5da:	89 1c 24             	mov    %ebx,(%esp)
     5dd:	e8 e8 36 00 00       	call   3cca <close>
  if(unlink("small") < 0){
     5e2:	c7 04 24 1f 44 00 00 	movl   $0x441f,(%esp)
     5e9:	e8 04 37 00 00       	call   3cf2 <unlink>
     5ee:	85 c0                	test   %eax,%eax
     5f0:	0f 88 8c 00 00 00    	js     682 <writetest+0x1d2>
  printf(stdout, "small file test ok\n");
     5f6:	a1 10 64 00 00       	mov    0x6410,%eax
     5fb:	c7 44 24 04 d9 44 00 	movl   $0x44d9,0x4(%esp)
     602:	00 
     603:	89 04 24             	mov    %eax,(%esp)
     606:	e8 15 38 00 00       	call   3e20 <printf>
}
     ...
     612:	a1 10 64 00 00       	mov    0x6410,%eax
     617:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     61b:	c7 44 24 04 20 53 00 	movl   $0x5320,0x4(%esp)
     622:	00 
     623:	89 04 24             	mov    %eax,(%esp)
     626:	e8 f5 37 00 00       	call   3e20 <printf>
      exit();
     62b:	e8 72 36 00 00       	call   3ca2 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     630:	a1 10 64 00 00       	mov    0x6410,%eax
     635:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     639:	c7 44 24 04 44 53 00 	movl   $0x5344,0x4(%esp)
     640:	00 
     641:	89 04 24             	mov    %eax,(%esp)
     644:	e8 d7 37 00 00       	call   3e20 <printf>
      exit();
     649:	e8 54 36 00 00       	call   3ca2 <exit>
    printf(stdout, "error: open small failed!\n");
     64e:	a1 10 64 00 00       	mov    0x6410,%eax
     653:	c7 44 24 04 96 44 00 	movl   $0x4496,0x4(%esp)
     65a:	00 
     65b:	89 04 24             	mov    %eax,(%esp)
     65e:	e8 bd 37 00 00       	call   3e20 <printf>
    exit();
     663:	e8 3a 36 00 00       	call   3ca2 <exit>
    printf(stdout, "read failed\n");
     668:	a1 10 64 00 00       	mov    0x6410,%eax
     66d:	c7 44 24 04 dd 47 00 	movl   $0x47dd,0x4(%esp)
     674:	00 
     675:	89 04 24             	mov    %eax,(%esp)
     678:	e8 a3 37 00 00       	call   3e20 <printf>
    exit();
     67d:	e8 20 36 00 00       	call   3ca2 <exit>
    printf(stdout, "unlink small failed\n");
     682:	a1 10 64 00 00       	mov    0x6410,%eax
     687:	c7 44 24 04 c4 44 00 	movl   $0x44c4,0x4(%esp)
     68e:	00 
     68f:	89 04 24             	mov    %eax,(%esp)
     692:	e8 89 37 00 00       	call   3e20 <printf>
    exit();
     697:	e8 06 36 00 00       	call   3ca2 <exit>
    printf(stdout, "error: creat small failed!\n");
     69c:	a1 10 64 00 00       	mov    0x6410,%eax
     6a1:	c7 44 24 04 40 44 00 	movl   $0x4440,0x4(%esp)
     6a8:	00 
     6a9:	89 04 24             	mov    %eax,(%esp)
     6ac:	e8 6f 37 00 00       	call   3e20 <printf>
    exit();
...
000006c0 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     6c8:	a1 10 64 00 00       	mov    0x6410,%eax
     6cd:	c7 44 24 04 ed 44 00 	movl   $0x44ed,0x4(%esp)
     6d4:	00 
     6d5:	89 04 24             	mov    %eax,(%esp)
     6d8:	e8 43 37 00 00       	call   3e20 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     6dd:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     6e4:	00 
     6e5:	c7 04 24 67 45 00 00 	movl   $0x4567,(%esp)
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     707:	00 
     708:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
     70f:	00 
     710:	89 34 24             	mov    %esi,(%esp)
    ((int*)buf)[0] = i;
     713:	89 1d 00 8c 00 00    	mov    %ebx,0x8c00
    if(write(fd, buf, 512) != 512){
  ...
  fd = open("big", O_RDONLY);
     ...
     743:	00 
     744:	c7 04 24 67 45 00 00 	movl   $0x4567,(%esp)
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n){
     76b:	a1 00 8c 00 00       	mov    0x8c00,%eax
    ...
    i = read(fd, buf, 512);
     ...
     782:	00 
     783:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
     78a:	00 
  ...
  if(unlink("big") < 0){
     7ab:	c7 04 24 67 45 00 00 	movl   $0x4567,(%esp)
     7b2:	e8 3b 35 00 00       	call   3cf2 <unlink>
     7b7:	85 c0                	test   %eax,%eax
     7b9:	0f 88 d0 00 00 00    	js     88f <writetest1+0x1cf>
  printf(stdout, "big files ok\n");
     7bf:	a1 10 64 00 00       	mov    0x6410,%eax
     7c4:	c7 44 24 04 8e 45 00 	movl   $0x458e,0x4(%esp)
     7cb:	00 
     7cc:	89 04 24             	mov    %eax,(%esp)
     7cf:	e8 4c 36 00 00       	call   3e20 <printf>
}
     ...
     7db:	a1 10 64 00 00       	mov    0x6410,%eax
     7e0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     7e4:	c7 44 24 04 17 45 00 	movl   $0x4517,0x4(%esp)
     7eb:	00 
     7ec:	89 04 24             	mov    %eax,(%esp)
     7ef:	e8 2c 36 00 00       	call   3e20 <printf>
      exit();
     7f4:	e8 a9 34 00 00       	call   3ca2 <exit>
      printf(stdout, "read content of block %d is %d\n",
     7f9:	89 44 24 0c          	mov    %eax,0xc(%esp)
     7fd:	a1 10 64 00 00       	mov    0x6410,%eax
     802:	89 5c 24 08          	mov    %ebx,0x8(%esp)
     806:	c7 44 24 04 68 53 00 	movl   $0x5368,0x4(%esp)
     80d:	00 
     80e:	89 04 24             	mov    %eax,(%esp)
     811:	e8 0a 36 00 00       	call   3e20 <printf>
      exit();
     816:	e8 87 34 00 00       	call   3ca2 <exit>
      printf(stdout, "read failed %d\n", i);
     81b:	89 44 24 08          	mov    %eax,0x8(%esp)
     81f:	a1 10 64 00 00       	mov    0x6410,%eax
     824:	c7 44 24 04 6b 45 00 	movl   $0x456b,0x4(%esp)
     82b:	00 
     82c:	89 04 24             	mov    %eax,(%esp)
     82f:	e8 ec 35 00 00       	call   3e20 <printf>
      exit();
     834:	e8 69 34 00 00       	call   3ca2 <exit>
        printf(stdout, "read only %d blocks from big", n);
     839:	a1 10 64 00 00       	mov    0x6410,%eax
     83e:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
     845:	00 
     846:	c7 44 24 04 4e 45 00 	movl   $0x454e,0x4(%esp)
     84d:	00 
     84e:	89 04 24             	mov    %eax,(%esp)
     851:	e8 ca 35 00 00       	call   3e20 <printf>
        exit();
     856:	e8 47 34 00 00       	call   3ca2 <exit>
    printf(stdout, "error: open big failed!\n");
     85b:	a1 10 64 00 00       	mov    0x6410,%eax
     860:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
     867:	00 
     868:	89 04 24             	mov    %eax,(%esp)
     86b:	e8 b0 35 00 00       	call   3e20 <printf>
    exit();
     870:	e8 2d 34 00 00       	call   3ca2 <exit>
    printf(stdout, "error: creat big failed!\n");
     875:	a1 10 64 00 00       	mov    0x6410,%eax
     87a:	c7 44 24 04 fd 44 00 	movl   $0x44fd,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 96 35 00 00       	call   3e20 <printf>
    exit();
     88a:	e8 13 34 00 00       	call   3ca2 <exit>
    printf(stdout, "unlink big failed\n");
     88f:	a1 10 64 00 00       	mov    0x6410,%eax
     894:	c7 44 24 04 7b 45 00 	movl   $0x457b,0x4(%esp)
     89b:	00 
     89c:	89 04 24             	mov    %eax,(%esp)
     89f:	e8 7c 35 00 00       	call   3e20 <printf>
    exit();
     ...
     8b4:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     8bc:	a1 10 64 00 00       	mov    0x6410,%eax
     8c1:	c7 44 24 04 88 53 00 	movl   $0x5388,0x4(%esp)
     8c8:	00 
     8c9:	89 04 24             	mov    %eax,(%esp)
     8cc:	e8 4f 35 00 00       	call   3e20 <printf>
  name[0] = 'a';
     8d1:	c6 05 00 ac 00 00 61 	movb   $0x61,0xac00
  name[2] = '\0';
     8d8:	c6 05 02 ac 00 00 00 	movb   $0x0,0xac02
     8df:	90                   	nop
    fd = open(name, O_CREATE|O_RDWR);
     8e0:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     8e7:	00 
     8e8:	c7 04 24 00 ac 00 00 	movl   $0xac00,(%esp)
    name[1] = '0' + i;
     8ef:	88 1d 01 ac 00 00    	mov    %bl,0xac01
  ...
  name[0] = 'a';
     90a:	c6 05 00 ac 00 00 61 	movb   $0x61,0xac00
  name[2] = '\0';
     911:	bb 30 00 00 00       	mov    $0x30,%ebx
     916:	c6 05 02 ac 00 00 00 	movb   $0x0,0xac02
     91d:	8d 76 00             	lea    0x0(%esi),%esi
    name[1] = '0' + i;
     920:	88 1d 01 ac 00 00    	mov    %bl,0xac01
     926:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     929:	c7 04 24 00 ac 00 00 	movl   $0xac00,(%esp)
     930:	e8 bd 33 00 00       	call   3cf2 <unlink>
  for(i = 0; i < 52; i++){
     935:	80 fb 64             	cmp    $0x64,%bl
     938:	75 e6                	jne    920 <createtest+0x70>
  printf(stdout, "many creates, followed by unlink; ok\n");
     93a:	a1 10 64 00 00       	mov    0x6410,%eax
     93f:	c7 44 24 04 b0 53 00 	movl   $0x53b0,0x4(%esp)
     946:	00 
     947:	89 04 24             	mov    %eax,(%esp)
     94a:	e8 d1 34 00 00       	call   3e20 <printf>
}
...
00000960 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     966:	a1 10 64 00 00       	mov    0x6410,%eax
     96b:	c7 44 24 04 9c 45 00 	movl   $0x459c,0x4(%esp)
     972:	00 
     973:	89 04 24             	mov    %eax,(%esp)
     976:	e8 a5 34 00 00       	call   3e20 <printf>
  if(mkdir("dir0") < 0){
     97b:	c7 04 24 a8 45 00 00 	movl   $0x45a8,(%esp)
     982:	e8 83 33 00 00       	call   3d0a <mkdir>
     987:	85 c0                	test   %eax,%eax
     989:	78 4b                	js     9d6 <dirtest+0x76>
  if(chdir("dir0") < 0){
     98b:	c7 04 24 a8 45 00 00 	movl   $0x45a8,(%esp)
     992:	e8 7b 33 00 00       	call   3d12 <chdir>
     997:	85 c0                	test   %eax,%eax
     999:	0f 88 85 00 00 00    	js     a24 <dirtest+0xc4>
  if(chdir("..") < 0){
     99f:	c7 04 24 4d 4b 00 00 	movl   $0x4b4d,(%esp)
     9a6:	e8 67 33 00 00       	call   3d12 <chdir>
     9ab:	85 c0                	test   %eax,%eax
     9ad:	78 5b                	js     a0a <dirtest+0xaa>
  if(unlink("dir0") < 0){
     9af:	c7 04 24 a8 45 00 00 	movl   $0x45a8,(%esp)
     9b6:	e8 37 33 00 00       	call   3cf2 <unlink>
     9bb:	85 c0                	test   %eax,%eax
     9bd:	78 31                	js     9f0 <dirtest+0x90>
  printf(stdout, "mkdir test ok\n");
     9bf:	a1 10 64 00 00       	mov    0x6410,%eax
     9c4:	c7 44 24 04 e5 45 00 	movl   $0x45e5,0x4(%esp)
     9cb:	00 
     9cc:	89 04 24             	mov    %eax,(%esp)
     9cf:	e8 4c 34 00 00       	call   3e20 <printf>
}
     9d4:	c9                   	leave  
     9d5:	c3                   	ret    
    printf(stdout, "mkdir failed\n");
     9d6:	a1 10 64 00 00       	mov    0x6410,%eax
     9db:	c7 44 24 04 d8 42 00 	movl   $0x42d8,0x4(%esp)
     9e2:	00 
     9e3:	89 04 24             	mov    %eax,(%esp)
     9e6:	e8 35 34 00 00       	call   3e20 <printf>
    exit();
     9eb:	e8 b2 32 00 00       	call   3ca2 <exit>
    printf(stdout, "unlink dir0 failed\n");
     9f0:	a1 10 64 00 00       	mov    0x6410,%eax
     9f5:	c7 44 24 04 d1 45 00 	movl   $0x45d1,0x4(%esp)
     9fc:	00 
     9fd:	89 04 24             	mov    %eax,(%esp)
     a00:	e8 1b 34 00 00       	call   3e20 <printf>
    exit();
     a05:	e8 98 32 00 00       	call   3ca2 <exit>
    printf(stdout, "chdir .. failed\n");
     a0a:	a1 10 64 00 00       	mov    0x6410,%eax
     a0f:	c7 44 24 04 c0 45 00 	movl   $0x45c0,0x4(%esp)
     a16:	00 
     a17:	89 04 24             	mov    %eax,(%esp)
     a1a:	e8 01 34 00 00       	call   3e20 <printf>
    exit();
     a1f:	e8 7e 32 00 00       	call   3ca2 <exit>
    printf(stdout, "chdir dir0 failed\n");
     a24:	a1 10 64 00 00       	mov    0x6410,%eax
     a29:	c7 44 24 04 ad 45 00 	movl   $0x45ad,0x4(%esp)
     a30:	00 
     a31:	89 04 24             	mov    %eax,(%esp)
     a34:	e8 e7 33 00 00       	call   3e20 <printf>
    exit();
...
00000a40 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     a46:	a1 10 64 00 00       	mov    0x6410,%eax
     a4b:	c7 44 24 04 f4 45 00 	movl   $0x45f4,0x4(%esp)
     a52:	00 
     a53:	89 04 24             	mov    %eax,(%esp)
     a56:	e8 c5 33 00 00       	call   3e20 <printf>
  if(exec("echo", echoargv) < 0){
     a5b:	c7 44 24 04 14 64 00 	movl   $0x6414,0x4(%esp)
     a62:	00 
     a63:	c7 04 24 bd 43 00 00 	movl   $0x43bd,(%esp)
    ...
    printf(stdout, "exec echo failed\n");
     a75:	a1 10 64 00 00       	mov    0x6410,%eax
     a7a:	c7 44 24 04 ff 45 00 	movl   $0x45ff,0x4(%esp)
     a81:	00 
     a82:	89 04 24             	mov    %eax,(%esp)
     a85:	e8 96 33 00 00       	call   3e20 <printf>
    exit();
...
00000a90 <pipe1>:
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ae0:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
     ae7:	00 
     ...
     b0a:	38 9c 0b 00 8c 00 00 	cmp    %bl,0x8c00(%ebx,%ecx,1)
     ...
     b31:	c7 44 24 04 2e 46 00 	movl   $0x462e,0x4(%esp)
     b38:	00 
     b39:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b40:	e8 db 32 00 00       	call   3e20 <printf>
}
     ...
     b5a:	89 f0                	mov    %esi,%eax
{
     ...
     b66:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     b68:	88 9c 18 00 8c 00 00 	mov    %bl,0x8c00(%eax,%ebx,1)
     ...
     b82:	00 
     b83:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
     b8a:	00 
  ...
  printf(1, "pipe1 ok\n");
     bc4:	c7 44 24 04 53 46 00 	movl   $0x4653,0x4(%esp)
     bcb:	00 
     bcc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bd3:	e8 48 32 00 00       	call   3e20 <printf>
     bd8:	e9 68 ff ff ff       	jmp    b45 <pipe1+0xb5>
      printf(1, "pipe1 oops 3 total %d\n", total);
     bdd:	8b 45 d4             	mov    -0x2c(%ebp),%eax
     be0:	c7 44 24 04 3c 46 00 	movl   $0x463c,0x4(%esp)
     be7:	00 
     be8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bef:	89 44 24 08          	mov    %eax,0x8(%esp)
     bf3:	e8 28 32 00 00       	call   3e20 <printf>
     bf8:	eb ac                	jmp    ba6 <pipe1+0x116>
    printf(1, "pipe() failed\n");
     bfa:	c7 44 24 04 11 46 00 	movl   $0x4611,0x4(%esp)
     c01:	00 
     c02:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c09:	e8 12 32 00 00       	call   3e20 <printf>
    exit();
     c0e:	e8 8f 30 00 00       	call   3ca2 <exit>
    printf(1, "fork() failed\n");
     c13:	c7 44 24 04 5d 46 00 	movl   $0x465d,0x4(%esp)
     c1a:	00 
     c1b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c22:	e8 f9 31 00 00       	call   3e20 <printf>
    exit();
     c27:	e8 76 30 00 00       	call   3ca2 <exit>
        printf(1, "pipe1 oops 1\n");
     c2c:	c7 44 24 04 20 46 00 	movl   $0x4620,0x4(%esp)
     c33:	00 
     c34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c3b:	e8 e0 31 00 00       	call   3e20 <printf>
        exit();
...
00000c50 <preempt>:
{
  ...
  printf(1, "preempt: ");
     c59:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
     c60:	00 
     c61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c68:	e8 b3 31 00 00       	call   3e20 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     cb8:	00 
     cb9:	c7 44 24 04 31 4c 00 	movl   $0x4c31,0x4(%esp)
     cc0:	00 
     ...
     cce:	c7 44 24 04 76 46 00 	movl   $0x4676,0x4(%esp)
     cd5:	00 
     cd6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cdd:	e8 3e 31 00 00       	call   3e20 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     d04:	00 
     d05:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
     d0c:	00 
    ...
    printf(1, "preempt read error");
     d1a:	c7 44 24 04 8a 46 00 	movl   $0x468a,0x4(%esp)
     d21:	00 
     d22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d29:	e8 f2 30 00 00       	call   3e20 <printf>
}
  ...
  printf(1, "kill... ");
     d41:	c7 44 24 04 9d 46 00 	movl   $0x469d,0x4(%esp)
     d48:	00 
     d49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d50:	e8 cb 30 00 00       	call   3e20 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     d6d:	c7 44 24 04 a6 46 00 	movl   $0x46a6,0x4(%esp)
     d74:	00 
     d75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d7c:	e8 9f 30 00 00       	call   3e20 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     d95:	c7 44 24 04 af 46 00 	movl   $0x46af,0x4(%esp)
     d9c:	00 
     d9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     da4:	e8 77 30 00 00       	call   3e20 <printf>
...
00000db0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ddb:	79 e3                	jns    dc0 <exitwait+0x10>
      printf(1, "fork failed\n");
     ddd:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
     de4:	00 
     de5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dec:	e8 2f 30 00 00       	call   3e20 <printf>
}
     ...
     df8:	c7 44 24 04 bb 46 00 	movl   $0x46bb,0x4(%esp)
     dff:	00 
     e00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e07:	e8 14 30 00 00       	call   3e20 <printf>
}
  ...
  printf(1, "exitwait ok\n");
     e18:	c7 44 24 04 cb 46 00 	movl   $0x46cb,0x4(%esp)
     e1f:	00 
     e20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e27:	e8 f4 2f 00 00       	call   3e20 <printf>
}
...
00000e40 <mem>:
{
  ...
  printf(1, "mem test\n");
     e49:	c7 44 24 04 d8 46 00 	movl   $0x46d8,0x4(%esp)
     e50:	00 
     e51:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e58:	e8 c3 2f 00 00       	call   3e20 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     e83:	e8 48 32 00 00       	call   40d0 <malloc>
    ...
    wait();
     ...
     ef0:	c7 44 24 04 e2 46 00 	movl   $0x46e2,0x4(%esp)
     ef7:	00 
     ef8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     eff:	e8 1c 2f 00 00       	call   3e20 <printf>
      kill(ppid);
...
00000f20 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fb6:	c7 44 24 04 04 54 00 	movl   $0x5404,0x4(%esp)
     fbd:	00 
     fbe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fc5:	e8 56 2e 00 00       	call   3e20 <printf>
  if(pid == 0)
  ...
  fd = open("sharedfd", 0);
     ...
     fe9:	00 
     fea:	c7 04 24 13 47 00 00 	movl   $0x4713,(%esp)
  ...
  unlink("sharedfd");
    106c:	c7 04 24 13 47 00 00 	movl   $0x4713,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    108b:	c7 44 24 04 1c 47 00 	movl   $0x471c,0x4(%esp)
    1092:	00 
    1093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    109a:	e8 81 2d 00 00       	call   3e20 <printf>
}
    ...
    10a7:	c7 44 24 04 d8 53 00 	movl   $0x53d8,0x4(%esp)
    10ae:	00 
    10af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10b6:	e8 65 2d 00 00       	call   3e20 <printf>
}
    ...
    10c3:	c7 44 24 04 24 54 00 	movl   $0x5424,0x4(%esp)
    10ca:	00 
    10cb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10d2:	e8 49 2d 00 00       	call   3e20 <printf>
}
    ...
    10e7:	c7 44 24 04 29 47 00 	movl   $0x4729,0x4(%esp)
    10ee:	00 
    10ef:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10f6:	e8 25 2d 00 00       	call   3e20 <printf>
    exit();
...
00001100 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1105:	be 3e 47 00 00       	mov    $0x473e,%esi
{
    110a:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    110b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    1110:	c7 44 24 04 44 47 00 	movl   $0x4744,0x4(%esp)
    1117:	00 
    1118:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  char *names[] = { "f0", "f1", "f2", "f3" };
    111f:	c7 45 d8 3e 47 00 00 	movl   $0x473e,-0x28(%ebp)
    1126:	c7 45 dc 87 48 00 00 	movl   $0x4887,-0x24(%ebp)
    112d:	c7 45 e0 8b 48 00 00 	movl   $0x488b,-0x20(%ebp)
    1134:	c7 45 e4 41 47 00 00 	movl   $0x4741,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    113b:	e8 e0 2c 00 00       	call   3e20 <printf>
    unlink(fname);
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1182:	c7 45 d4 3e 47 00 00 	movl   $0x473e,-0x2c(%ebp)
    fd = open(fname, 0);
    ...
    11a7:	00 
    11a8:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    11af:	00 
    ...
    11be:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    11c0:	0f be 8a 00 8c 00 00 	movsbl 0x8c00(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    11fa:	c7 44 24 04 82 47 00 	movl   $0x4782,0x4(%esp)
    1201:	00 
    1202:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1209:	e8 12 2c 00 00       	call   3e20 <printf>
}
    ...
    1221:	e9 63 ff ff ff       	jmp    1189 <fourfiles+0x89>
          printf(1, "wrong char\n");
    1226:	c7 44 24 04 65 47 00 	movl   $0x4765,0x4(%esp)
    122d:	00 
    122e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1235:	e8 e6 2b 00 00       	call   3e20 <printf>
          exit();
    ...
    126c:	00 
    126d:	c7 04 24 00 8c 00 00 	movl   $0x8c00,(%esp)
    ...
    128c:	00 
    128d:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    1294:	00 
    ...
    12a8:	c7 44 24 04 54 47 00 	movl   $0x4754,0x4(%esp)
    12af:	00 
    12b0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b7:	e8 64 2b 00 00       	call   3e20 <printf>
          exit();
    12bc:	e8 e1 29 00 00       	call   3ca2 <exit>
      printf(1, "wrong length %d\n", total);
    12c1:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    12c5:	c7 44 24 04 71 47 00 	movl   $0x4771,0x4(%esp)
    12cc:	00 
    12cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12d4:	e8 47 2b 00 00       	call   3e20 <printf>
      exit();
    12d9:	e8 c4 29 00 00       	call   3ca2 <exit>
      printf(1, "fork failed\n");
    12de:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
    12e5:	00 
    12e6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ed:	e8 2e 2b 00 00       	call   3e20 <printf>
      exit();
    12f2:	e8 ab 29 00 00       	call   3ca2 <exit>
        printf(1, "create failed\n");
    12f7:	c7 44 24 04 df 49 00 	movl   $0x49df,0x4(%esp)
    12fe:	00 
    12ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1306:	e8 15 2b 00 00       	call   3e20 <printf>
        exit();
    ...
    1316:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    131b:	c7 44 24 04 90 47 00 	movl   $0x4790,0x4(%esp)
    1322:	00 
    1323:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    132a:	e8 f1 2a 00 00       	call   3e20 <printf>
    pid = fork();
  ...
  printf(1, "createdelete ok\n");
    1415:	c7 44 24 04 a3 47 00 	movl   $0x47a3,0x4(%esp)
    141c:	00 
    141d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1424:	e8 f7 29 00 00       	call   3e20 <printf>
}
...
00001550 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    1558:	c7 44 24 04 b4 47 00 	movl   $0x47b4,0x4(%esp)
    155f:	00 
    1560:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1567:	e8 b4 28 00 00       	call   3e20 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    156c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1573:	00 
    1574:	c7 04 24 c5 47 00 00 	movl   $0x47c5,(%esp)
  ...
  write(fd, "hello", 5);
    ...
    1591:	00 
    1592:	c7 44 24 04 ea 47 00 	movl   $0x47ea,0x4(%esp)
    1599:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    15b1:	00 
    15b2:	c7 04 24 c5 47 00 00 	movl   $0x47c5,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    15c8:	c7 04 24 c5 47 00 00 	movl   $0x47c5,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15e3:	00 
    15e4:	c7 04 24 c5 47 00 00 	movl   $0x47c5,(%esp)
    15eb:	e8 f2 26 00 00       	call   3ce2 <open>
  write(fd1, "yyy", 3);
    15f0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    15f7:	00 
    15f8:	c7 44 24 04 22 48 00 	movl   $0x4822,0x4(%esp)
    15ff:	00 
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1619:	00 
    161a:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    1621:	00 
  ...
  if(buf[0] != 'h'){
    1633:	80 3d 00 8c 00 00 68 	cmpb   $0x68,0x8c00
    163a:	75 7e                	jne    16ba <unlinkread+0x16a>
  if(write(fd, buf, 10) != 10){
    163c:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1643:	00 
    1644:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    164b:	00 
  ...
  unlink("unlinkread");
    1661:	c7 04 24 c5 47 00 00 	movl   $0x47c5,(%esp)
    1668:	e8 85 26 00 00       	call   3cf2 <unlink>
  printf(1, "unlinkread ok\n");
    166d:	c7 44 24 04 6d 48 00 	movl   $0x486d,0x4(%esp)
    1674:	00 
    1675:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167c:	e8 9f 27 00 00       	call   3e20 <printf>
}
    ...
    1688:	c7 44 24 04 d0 47 00 	movl   $0x47d0,0x4(%esp)
    168f:	00 
    1690:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1697:	e8 84 27 00 00       	call   3e20 <printf>
    exit();
    169c:	e8 01 26 00 00       	call   3ca2 <exit>
    printf(1, "unlinkread write failed\n");
    16a1:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
    16a8:	00 
    16a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16b0:	e8 6b 27 00 00       	call   3e20 <printf>
    exit();
    16b5:	e8 e8 25 00 00       	call   3ca2 <exit>
    printf(1, "unlinkread wrong data\n");
    16ba:	c7 44 24 04 3d 48 00 	movl   $0x483d,0x4(%esp)
    16c1:	00 
    16c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c9:	e8 52 27 00 00       	call   3e20 <printf>
    exit();
    16ce:	e8 cf 25 00 00       	call   3ca2 <exit>
    printf(1, "unlinkread read failed");
    16d3:	c7 44 24 04 26 48 00 	movl   $0x4826,0x4(%esp)
    16da:	00 
    16db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e2:	e8 39 27 00 00       	call   3e20 <printf>
    exit();
    16e7:	e8 b6 25 00 00       	call   3ca2 <exit>
    printf(1, "unlink unlinkread failed\n");
    16ec:	c7 44 24 04 08 48 00 	movl   $0x4808,0x4(%esp)
    16f3:	00 
    16f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16fb:	e8 20 27 00 00       	call   3e20 <printf>
    exit();
    1700:	e8 9d 25 00 00       	call   3ca2 <exit>
    printf(1, "open unlinkread failed\n");
    1705:	c7 44 24 04 f0 47 00 	movl   $0x47f0,0x4(%esp)
    170c:	00 
    170d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1714:	e8 07 27 00 00       	call   3e20 <printf>
    exit();
...
00001720 <linktest>:
{
  ...
  printf(1, "linktest\n");
    1727:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
    172e:	00 
    172f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1736:	e8 e5 26 00 00       	call   3e20 <printf>
  unlink("lf1");
    173b:	c7 04 24 86 48 00 00 	movl   $0x4886,(%esp)
    1742:	e8 ab 25 00 00       	call   3cf2 <unlink>
  unlink("lf2");
    1747:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
    174e:	e8 9f 25 00 00       	call   3cf2 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    1753:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    175a:	00 
    175b:	c7 04 24 86 48 00 00 	movl   $0x4886,(%esp)
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1778:	00 
    1779:	c7 44 24 04 ea 47 00 	movl   $0x47ea,0x4(%esp)
    1780:	00 
  ...
  fd = open("lf2", 0);
    ...
    17e5:	00 
    17e6:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1803:	00 
    1804:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    180b:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    1825:	c7 44 24 04 8a 48 00 	movl   $0x488a,0x4(%esp)
    182c:	00 
    182d:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
    1834:	e8 c9 24 00 00       	call   3d02 <link>
    1839:	85 c0                	test   %eax,%eax
    183b:	0f 89 a1 00 00 00    	jns    18e2 <linktest+0x1c2>
  unlink("lf2");
    1841:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
    1848:	e8 a5 24 00 00       	call   3cf2 <unlink>
  if(link("lf2", "lf1") >= 0){
    184d:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    1854:	00 
    1855:	c7 04 24 8a 48 00 00 	movl   $0x488a,(%esp)
    185c:	e8 a1 24 00 00       	call   3d02 <link>
    1861:	85 c0                	test   %eax,%eax
    1863:	79 64                	jns    18c9 <linktest+0x1a9>
  if(link(".", "lf1") >= 0){
    1865:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    186c:	00 
    186d:	c7 04 24 4e 4b 00 00 	movl   $0x4b4e,(%esp)
    1874:	e8 89 24 00 00       	call   3d02 <link>
    1879:	85 c0                	test   %eax,%eax
    187b:	79 33                	jns    18b0 <linktest+0x190>
  printf(1, "linktest ok\n");
    187d:	c7 44 24 04 24 49 00 	movl   $0x4924,0x4(%esp)
    1884:	00 
    1885:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188c:	e8 8f 25 00 00       	call   3e20 <printf>
}
    ...
    1897:	c7 44 24 04 8e 48 00 	movl   $0x488e,0x4(%esp)
    189e:	00 
    189f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18a6:	e8 75 25 00 00       	call   3e20 <printf>
    exit();
    18ab:	e8 f2 23 00 00       	call   3ca2 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    18b0:	c7 44 24 04 08 49 00 	movl   $0x4908,0x4(%esp)
    18b7:	00 
    18b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18bf:	e8 5c 25 00 00       	call   3e20 <printf>
    exit();
    18c4:	e8 d9 23 00 00       	call   3ca2 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    18c9:	c7 44 24 04 bc 54 00 	movl   $0x54bc,0x4(%esp)
    18d0:	00 
    18d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d8:	e8 43 25 00 00       	call   3e20 <printf>
    exit();
    18dd:	e8 c0 23 00 00       	call   3ca2 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    18e2:	c7 44 24 04 ea 48 00 	movl   $0x48ea,0x4(%esp)
    18e9:	00 
    18ea:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f1:	e8 2a 25 00 00       	call   3e20 <printf>
    exit();
    18f6:	e8 a7 23 00 00       	call   3ca2 <exit>
    printf(1, "read lf2 failed\n");
    18fb:	c7 44 24 04 d9 48 00 	movl   $0x48d9,0x4(%esp)
    1902:	00 
    1903:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190a:	e8 11 25 00 00       	call   3e20 <printf>
    exit();
    190f:	e8 8e 23 00 00       	call   3ca2 <exit>
    printf(1, "open lf2 failed\n");
    1914:	c7 44 24 04 c8 48 00 	movl   $0x48c8,0x4(%esp)
    191b:	00 
    191c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1923:	e8 f8 24 00 00       	call   3e20 <printf>
    exit();
    1928:	e8 75 23 00 00       	call   3ca2 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    192d:	c7 44 24 04 94 54 00 	movl   $0x5494,0x4(%esp)
    1934:	00 
    1935:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    193c:	e8 df 24 00 00       	call   3e20 <printf>
    exit();
    1941:	e8 5c 23 00 00       	call   3ca2 <exit>
    printf(1, "link lf1 lf2 failed\n");
    1946:	c7 44 24 04 b3 48 00 	movl   $0x48b3,0x4(%esp)
    194d:	00 
    194e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1955:	e8 c6 24 00 00       	call   3e20 <printf>
    exit();
    195a:	e8 43 23 00 00       	call   3ca2 <exit>
    printf(1, "write lf1 failed\n");
    195f:	c7 44 24 04 a1 48 00 	movl   $0x48a1,0x4(%esp)
    1966:	00 
    1967:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    196e:	e8 ad 24 00 00       	call   3e20 <printf>
    exit();
    ...
    1985:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    198b:	c7 44 24 04 31 49 00 	movl   $0x4931,0x4(%esp)
    1992:	00 
    1993:	8d 5d ad             	lea    -0x53(%ebp),%ebx
    1996:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    199d:	e8 7e 24 00 00       	call   3e20 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1a34:	c7 04 24 41 49 00 00 	movl   $0x4941,(%esp)
  ...
  for(i = 0; i < 40; i++){
    1a4c:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1a4f:	c7 04 24 41 49 00 00 	movl   $0x4941,(%esp)
  ...
  fd = open(".", 0);
    ...
    1a8d:	00 
    1a8e:	c7 04 24 4e 4b 00 00 	movl   $0x4b4e,(%esp)
  ...
  printf(1, "concreate ok\n");
    1bf0:	c7 44 24 04 96 49 00 	movl   $0x4996,0x4(%esp)
    1bf7:	00 
    1bf8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bff:	e8 1c 22 00 00       	call   3e20 <printf>
}
...
00001ca0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ca9:	c7 44 24 04 a4 49 00 	movl   $0x49a4,0x4(%esp)
    1cb0:	00 
    1cb1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cb8:	e8 63 21 00 00       	call   3e20 <printf>
  unlink("x");
    1cbd:	c7 04 24 31 4c 00 00 	movl   $0x4c31,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1cfb:	74 7b                	je     1d78 <linkunlink+0xd8>
      unlink("x");
    1cfd:	c7 04 24 31 4c 00 00 	movl   $0x4c31,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1d30:	00 
    1d31:	c7 04 24 31 4c 00 00 	movl   $0x4c31,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1d56:	c7 44 24 04 b9 49 00 	movl   $0x49b9,0x4(%esp)
    1d5d:	00 
    1d5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d65:	e8 b6 20 00 00       	call   3e20 <printf>
}
    ...
    1d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("cat", "x");
    1d78:	c7 44 24 04 31 4c 00 	movl   $0x4c31,0x4(%esp)
    1d7f:	00 
    1d80:	c7 04 24 b5 49 00 00 	movl   $0x49b5,(%esp)
    1d87:	e8 76 1f 00 00       	call   3d02 <link>
    1d8c:	e9 78 ff ff ff       	jmp    1d09 <linkunlink+0x69>
    printf(1, "fork failed\n");
    1d91:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
    1d98:	00 
    1d99:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1da0:	e8 7b 20 00 00       	call   3e20 <printf>
    exit();
...
00001db0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1db8:	c7 44 24 04 c8 49 00 	movl   $0x49c8,0x4(%esp)
    1dbf:	00 
    1dc0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dc7:	e8 54 20 00 00       	call   3e20 <printf>
  unlink("bd");
    1dcc:	c7 04 24 d5 49 00 00 	movl   $0x49d5,(%esp)
    1dd3:	e8 1a 1f 00 00       	call   3cf2 <unlink>
  fd = open("bd", O_CREATE);
    1dd8:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1ddf:	00 
    1de0:	c7 04 24 d5 49 00 00 	movl   $0x49d5,(%esp)
  ...
  close(fd);
    ...
    1e1f:	c7 04 24 d5 49 00 00 	movl   $0x49d5,(%esp)
    name[0] = 'x';
  ...
  unlink("bd");
    1e45:	c7 04 24 d5 49 00 00 	movl   $0x49d5,(%esp)
  for(i = 0; i < 500; i++){
  ...
  printf(1, "bigdir ok\n");
    1e8d:	c7 44 24 04 17 4a 00 	movl   $0x4a17,0x4(%esp)
    1e94:	00 
    1e95:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e9c:	e8 7f 1f 00 00       	call   3e20 <printf>
}
    ...
    1ea8:	c7 44 24 04 ee 49 00 	movl   $0x49ee,0x4(%esp)
    1eaf:	00 
    1eb0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eb7:	e8 64 1f 00 00       	call   3e20 <printf>
      exit();
    1ebc:	e8 e1 1d 00 00       	call   3ca2 <exit>
      printf(1, "bigdir unlink failed");
    1ec1:	c7 44 24 04 02 4a 00 	movl   $0x4a02,0x4(%esp)
    1ec8:	00 
    1ec9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ed0:	e8 4b 1f 00 00       	call   3e20 <printf>
      exit();
    1ed5:	e8 c8 1d 00 00       	call   3ca2 <exit>
    printf(1, "bigdir create failed\n");
    1eda:	c7 44 24 04 d8 49 00 	movl   $0x49d8,0x4(%esp)
    1ee1:	00 
    1ee2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ee9:	e8 32 1f 00 00       	call   3e20 <printf>
    exit();
...
00001f00 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1f07:	c7 44 24 04 22 4a 00 	movl   $0x4a22,0x4(%esp)
    1f0e:	00 
    1f0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f16:	e8 05 1f 00 00       	call   3e20 <printf>
  unlink("ff");
    1f1b:	c7 04 24 ab 4a 00 00 	movl   $0x4aab,(%esp)
    1f22:	e8 cb 1d 00 00       	call   3cf2 <unlink>
  if(mkdir("dd") != 0){
    1f27:	c7 04 24 48 4b 00 00 	movl   $0x4b48,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f42:	00 
    1f43:	c7 04 24 81 4a 00 00 	movl   $0x4a81,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    1f60:	00 
    1f61:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
    1f68:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1fa8:	00 
    1fa9:	c7 04 24 7e 4a 00 00 	movl   $0x4a7e,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    1fc6:	00 
    1fc7:	c7 44 24 04 9f 4a 00 	movl   $0x4a9f,0x4(%esp)
    1fce:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1fe6:	00 
    1fe7:	c7 04 24 a2 4a 00 00 	movl   $0x4aa2,(%esp)
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2004:	00 
    2005:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    200c:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20d6:	00 
    20d7:	c7 04 24 e2 4a 00 00 	movl   $0x4ae2,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    20f4:	00 
    20f5:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    20fc:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    211d:	00 
    211e:	c7 04 24 7e 4a 00 00 	movl   $0x4a7e,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2139:	00 
    213a:	c7 04 24 96 4b 00 00 	movl   $0x4b96,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2155:	00 
    2156:	c7 04 24 bb 4b 00 00 	movl   $0x4bbb,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2171:	00 
    2172:	c7 04 24 48 4b 00 00 	movl   $0x4b48,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    218d:	00 
    218e:	c7 04 24 48 4b 00 00 	movl   $0x4b48,(%esp)
  ...
  printf(1, "subdir ok\n");
    ...
    231c:	c7 44 24 04 c7 4a 00 	movl   $0x4ac7,0x4(%esp)
    2323:	00 
    2324:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    232b:	e8 f0 1a 00 00       	call   3e20 <printf>
    exit();
    2330:	e8 6d 19 00 00       	call   3ca2 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2335:	c7 44 24 04 22 4b 00 	movl   $0x4b22,0x4(%esp)
    233c:	00 
    233d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2344:	e8 d7 1a 00 00       	call   3e20 <printf>
    exit();
    2349:	e8 54 19 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    234e:	c7 44 24 04 ed 4a 00 	movl   $0x4aed,0x4(%esp)
    2355:	00 
    2356:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    235d:	e8 be 1a 00 00       	call   3e20 <printf>
    exit();
    2362:	e8 3b 19 00 00       	call   3ca2 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2367:	c7 44 24 04 9f 4b 00 	movl   $0x4b9f,0x4(%esp)
    236e:	00 
    236f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2376:	e8 a5 1a 00 00       	call   3e20 <printf>
    exit();
    237b:	e8 22 19 00 00       	call   3ca2 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2380:	c7 44 24 04 84 55 00 	movl   $0x5584,0x4(%esp)
    2387:	00 
    2388:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    238f:	e8 8c 1a 00 00       	call   3e20 <printf>
    exit();
    2394:	e8 09 19 00 00       	call   3ca2 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    2399:	c7 44 24 04 33 4c 00 	movl   $0x4c33,0x4(%esp)
    23a0:	00 
    23a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23a8:	e8 73 1a 00 00       	call   3e20 <printf>
    exit();
    23ad:	e8 f0 18 00 00       	call   3ca2 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    23b2:	c7 44 24 04 f4 55 00 	movl   $0x55f4,0x4(%esp)
    23b9:	00 
    23ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23c1:	e8 5a 1a 00 00       	call   3e20 <printf>
    exit();
    23c6:	e8 d7 18 00 00       	call   3ca2 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    23cb:	c7 44 24 04 ae 4a 00 	movl   $0x4aae,0x4(%esp)
    23d2:	00 
    23d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23da:	e8 41 1a 00 00       	call   3e20 <printf>
    exit();
    23df:	e8 be 18 00 00       	call   3ca2 <exit>
    printf(1, "create dd/dd/ff failed\n");
    23e4:	c7 44 24 04 87 4a 00 	movl   $0x4a87,0x4(%esp)
    23eb:	00 
    23ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23f3:	e8 28 1a 00 00       	call   3e20 <printf>
    exit();
    23f8:	e8 a5 18 00 00       	call   3ca2 <exit>
    printf(1, "chdir ./.. failed\n");
    23fd:	c7 44 24 04 50 4b 00 	movl   $0x4b50,0x4(%esp)
    2404:	00 
    2405:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    240c:	e8 0f 1a 00 00       	call   3e20 <printf>
    exit();
    2411:	e8 8c 18 00 00       	call   3ca2 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2416:	c7 44 24 04 3c 55 00 	movl   $0x553c,0x4(%esp)
    241d:	00 
    241e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2425:	e8 f6 19 00 00       	call   3e20 <printf>
    exit();
    242a:	e8 73 18 00 00       	call   3ca2 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    242f:	c7 44 24 04 d0 55 00 	movl   $0x55d0,0x4(%esp)
    2436:	00 
    2437:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    243e:	e8 dd 19 00 00       	call   3e20 <printf>
    exit();
    2443:	e8 5a 18 00 00       	call   3ca2 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2448:	c7 44 24 04 ac 55 00 	movl   $0x55ac,0x4(%esp)
    244f:	00 
    2450:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2457:	e8 c4 19 00 00       	call   3e20 <printf>
    exit();
    245c:	e8 41 18 00 00       	call   3ca2 <exit>
    printf(1, "open dd wronly succeeded!\n");
    2461:	c7 44 24 04 0f 4c 00 	movl   $0x4c0f,0x4(%esp)
    2468:	00 
    2469:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2470:	e8 ab 19 00 00       	call   3e20 <printf>
    exit();
    2475:	e8 28 18 00 00       	call   3ca2 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    247a:	c7 44 24 04 f6 4b 00 	movl   $0x4bf6,0x4(%esp)
    2481:	00 
    2482:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2489:	e8 92 19 00 00       	call   3e20 <printf>
    exit();
    248e:	e8 0f 18 00 00       	call   3ca2 <exit>
    printf(1, "create dd succeeded!\n");
    2493:	c7 44 24 04 e0 4b 00 	movl   $0x4be0,0x4(%esp)
    249a:	00 
    249b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24a2:	e8 79 19 00 00       	call   3e20 <printf>
    exit();
    24a7:	e8 f6 17 00 00       	call   3ca2 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    24ac:	c7 44 24 04 c4 4b 00 	movl   $0x4bc4,0x4(%esp)
    24b3:	00 
    24b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24bb:	e8 60 19 00 00       	call   3e20 <printf>
    exit();
    24c0:	e8 dd 17 00 00       	call   3ca2 <exit>
    printf(1, "chdir dd failed\n");
    24c5:	c7 44 24 04 05 4b 00 	movl   $0x4b05,0x4(%esp)
    24cc:	00 
    24cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d4:	e8 47 19 00 00       	call   3e20 <printf>
    exit();
    24d9:	e8 c4 17 00 00       	call   3ca2 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    24de:	c7 44 24 04 60 55 00 	movl   $0x5560,0x4(%esp)
    24e5:	00 
    24e6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24ed:	e8 2e 19 00 00       	call   3e20 <printf>
    exit();
    24f2:	e8 ab 17 00 00       	call   3ca2 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    24f7:	c7 44 24 04 63 4a 00 	movl   $0x4a63,0x4(%esp)
    24fe:	00 
    24ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2506:	e8 15 19 00 00       	call   3e20 <printf>
    exit();
    250b:	e8 92 17 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2510:	c7 44 24 04 14 55 00 	movl   $0x5514,0x4(%esp)
    2517:	00 
    2518:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251f:	e8 fc 18 00 00       	call   3e20 <printf>
    exit();
    2524:	e8 79 17 00 00       	call   3ca2 <exit>
    printf(1, "create dd/ff failed\n");
    2529:	c7 44 24 04 47 4a 00 	movl   $0x4a47,0x4(%esp)
    2530:	00 
    2531:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2538:	e8 e3 18 00 00       	call   3e20 <printf>
    exit();
    253d:	e8 60 17 00 00       	call   3ca2 <exit>
    printf(1, "subdir mkdir dd failed\n");
    2542:	c7 44 24 04 2f 4a 00 	movl   $0x4a2f,0x4(%esp)
    2549:	00 
    254a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2551:	e8 ca 18 00 00       	call   3e20 <printf>
    exit();
    2556:	e8 47 17 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd failed\n");
    255b:	c7 44 24 04 18 4d 00 	movl   $0x4d18,0x4(%esp)
    2562:	00 
    2563:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    256a:	e8 b1 18 00 00       	call   3e20 <printf>
    exit();
    256f:	e8 2e 17 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd/dd failed\n");
    2574:	c7 44 24 04 03 4d 00 	movl   $0x4d03,0x4(%esp)
    257b:	00 
    257c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2583:	e8 98 18 00 00       	call   3e20 <printf>
    exit();
    2588:	e8 15 17 00 00       	call   3ca2 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    258d:	c7 44 24 04 18 56 00 	movl   $0x5618,0x4(%esp)
    2594:	00 
    2595:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    259c:	e8 7f 18 00 00       	call   3e20 <printf>
    exit();
    25a1:	e8 fc 16 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd/ff failed\n");
    25a6:	c7 44 24 04 ee 4c 00 	movl   $0x4cee,0x4(%esp)
    25ad:	00 
    25ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25b5:	e8 66 18 00 00       	call   3e20 <printf>
    exit();
    25ba:	e8 e3 16 00 00       	call   3ca2 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    25bf:	c7 44 24 04 d6 4c 00 	movl   $0x4cd6,0x4(%esp)
    25c6:	00 
    25c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25ce:	e8 4d 18 00 00       	call   3e20 <printf>
    exit();
    25d3:	e8 ca 16 00 00       	call   3ca2 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    25d8:	c7 44 24 04 be 4c 00 	movl   $0x4cbe,0x4(%esp)
    25df:	00 
    25e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25e7:	e8 34 18 00 00       	call   3e20 <printf>
    exit();
    25ec:	e8 b1 16 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    25f1:	c7 44 24 04 a2 4c 00 	movl   $0x4ca2,0x4(%esp)
    25f8:	00 
    25f9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2600:	e8 1b 18 00 00       	call   3e20 <printf>
    exit();
    2605:	e8 98 16 00 00       	call   3ca2 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    260a:	c7 44 24 04 86 4c 00 	movl   $0x4c86,0x4(%esp)
    2611:	00 
    2612:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2619:	e8 02 18 00 00       	call   3e20 <printf>
    exit();
    261e:	e8 7f 16 00 00       	call   3ca2 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2623:	c7 44 24 04 69 4c 00 	movl   $0x4c69,0x4(%esp)
    262a:	00 
    262b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2632:	e8 e9 17 00 00       	call   3e20 <printf>
    exit();
    2637:	e8 66 16 00 00       	call   3ca2 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    263c:	c7 44 24 04 4e 4c 00 	movl   $0x4c4e,0x4(%esp)
    2643:	00 
    2644:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    264b:	e8 d0 17 00 00       	call   3e20 <printf>
    exit();
    2650:	e8 4d 16 00 00       	call   3ca2 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    2655:	c7 44 24 04 7b 4b 00 	movl   $0x4b7b,0x4(%esp)
    265c:	00 
    265d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2664:	e8 b7 17 00 00       	call   3e20 <printf>
    exit();
    2669:	e8 34 16 00 00       	call   3ca2 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    266e:	c7 44 24 04 63 4b 00 	movl   $0x4b63,0x4(%esp)
    2675:	00 
    2676:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    267d:	e8 9e 17 00 00       	call   3e20 <printf>
    exit();
    ...
    2695:	bb f3 01 00 00       	mov    $0x1f3,%ebx
{
  ...
  printf(1, "bigwrite test\n");
    269d:	c7 44 24 04 35 4d 00 	movl   $0x4d35,0x4(%esp)
    26a4:	00 
    26a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26ac:	e8 6f 17 00 00       	call   3e20 <printf>
  unlink("bigwrite");
    26b1:	c7 04 24 44 4d 00 00 	movl   $0x4d44,(%esp)
    26b8:	e8 35 16 00 00       	call   3cf2 <unlink>
    26bd:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open("bigwrite", O_CREATE | O_RDWR);
    26c0:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    26c7:	00 
    26c8:	c7 04 24 44 4d 00 00 	movl   $0x4d44,(%esp)
    ...
    26e2:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    26e9:	00 
    ...
    26fa:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    2701:	00 
  ...
  printf(1, "bigwrite ok\n");
    ...
    2753:	c7 44 24 04 65 4d 00 	movl   $0x4d65,0x4(%esp)
    275a:	00 
    275b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2762:	e8 b9 16 00 00       	call   3e20 <printf>
        exit();
    2767:	e8 36 15 00 00       	call   3ca2 <exit>
      printf(1, "cannot create bigwrite\n");
    276c:	c7 44 24 04 4d 4d 00 	movl   $0x4d4d,0x4(%esp)
    2773:	00 
    2774:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    277b:	e8 a0 16 00 00       	call   3e20 <printf>
      exit();
...
00002790 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    2799:	c7 44 24 04 84 4d 00 	movl   $0x4d84,0x4(%esp)
    27a0:	00 
    27a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27a8:	e8 73 16 00 00       	call   3e20 <printf>
  unlink("bigfile");
    27ad:	c7 04 24 a0 4d 00 00 	movl   $0x4da0,(%esp)
    27b4:	e8 39 15 00 00       	call   3cf2 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27b9:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27c0:	00 
    27c1:	c7 04 24 a0 4d 00 00 	movl   $0x4da0,(%esp)
  ...
  if(fd < 0){
    ...
    27ec:	c7 04 24 00 8c 00 00 	movl   $0x8c00,(%esp)
    27f3:	e8 38 13 00 00       	call   3b30 <memset>
    if(write(fd, buf, 600) != 600){
    27f8:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    27ff:	00 
    2800:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    2807:	00 
  ...
  fd = open("bigfile", 0);
    ...
    2832:	00 
    2833:	c7 04 24 a0 4d 00 00 	movl   $0x4da0,(%esp)
  ...
  if(fd < 0){
    ...
    285b:	0f be 05 00 8c 00 00 	movsbl 0x8c00,%eax
    2862:	89 fa                	mov    %edi,%edx
    2864:	d1 fa                	sar    %edx
    2866:	39 d0                	cmp    %edx,%eax
    2868:	75 6f                	jne    28d9 <bigfile+0x149>
    286a:	0f be 15 2b 8d 00 00 	movsbl 0x8d2b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2885:	00 
    2886:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    288d:	00 
  ...
  unlink("bigfile");
    28b1:	c7 04 24 a0 4d 00 00 	movl   $0x4da0,(%esp)
    28b8:	e8 35 14 00 00       	call   3cf2 <unlink>
  printf(1, "bigfile test ok\n");
    28bd:	c7 44 24 04 2f 4e 00 	movl   $0x4e2f,0x4(%esp)
    28c4:	00 
    28c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28cc:	e8 4f 15 00 00       	call   3e20 <printf>
}
    ...
    28d9:	c7 44 24 04 fc 4d 00 	movl   $0x4dfc,0x4(%esp)
    28e0:	00 
    28e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28e8:	e8 33 15 00 00       	call   3e20 <printf>
      exit();
    28ed:	e8 b0 13 00 00       	call   3ca2 <exit>
      printf(1, "short read bigfile\n");
    28f2:	c7 44 24 04 e8 4d 00 	movl   $0x4de8,0x4(%esp)
    28f9:	00 
    28fa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2901:	e8 1a 15 00 00       	call   3e20 <printf>
      exit();
    2906:	e8 97 13 00 00       	call   3ca2 <exit>
      printf(1, "read bigfile failed\n");
    290b:	c7 44 24 04 d3 4d 00 	movl   $0x4dd3,0x4(%esp)
    2912:	00 
    2913:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    291a:	e8 01 15 00 00       	call   3e20 <printf>
      exit();
    291f:	e8 7e 13 00 00       	call   3ca2 <exit>
      printf(1, "write bigfile failed\n");
    2924:	c7 44 24 04 a8 4d 00 	movl   $0x4da8,0x4(%esp)
    292b:	00 
    292c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2933:	e8 e8 14 00 00       	call   3e20 <printf>
      exit();
    2938:	e8 65 13 00 00       	call   3ca2 <exit>
    printf(1, "cannot open bigfile\n");
    293d:	c7 44 24 04 be 4d 00 	movl   $0x4dbe,0x4(%esp)
    2944:	00 
    2945:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    294c:	e8 cf 14 00 00       	call   3e20 <printf>
    exit();
    2951:	e8 4c 13 00 00       	call   3ca2 <exit>
    printf(1, "cannot create bigfile");
    2956:	c7 44 24 04 92 4d 00 	movl   $0x4d92,0x4(%esp)
    295d:	00 
    295e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2965:	e8 b6 14 00 00       	call   3e20 <printf>
    exit();
    296a:	e8 33 13 00 00       	call   3ca2 <exit>
    printf(1, "read bigfile wrong total\n");
    296f:	c7 44 24 04 15 4e 00 	movl   $0x4e15,0x4(%esp)
    2976:	00 
    2977:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    297e:	e8 9d 14 00 00       	call   3e20 <printf>
    exit();
...
00002990 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    2996:	c7 44 24 04 40 4e 00 	movl   $0x4e40,0x4(%esp)
    299d:	00 
    299e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29a5:	e8 76 14 00 00       	call   3e20 <printf>
  if(mkdir("12345678901234") != 0){
    29aa:	c7 04 24 7b 4e 00 00 	movl   $0x4e7b,(%esp)
    29b1:	e8 54 13 00 00       	call   3d0a <mkdir>
    29b6:	85 c0                	test   %eax,%eax
    29b8:	0f 85 92 00 00 00    	jne    2a50 <fourteen+0xc0>
  if(mkdir("12345678901234/123456789012345") != 0){
    29be:	c7 04 24 38 56 00 00 	movl   $0x5638,(%esp)
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29d9:	00 
    29da:	c7 04 24 88 56 00 00 	movl   $0x5688,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29fd:	00 
    29fe:	c7 04 24 f8 56 00 00 	movl   $0x56f8,(%esp)
  ...
  printf(1, "fourteen ok\n");
    ...
    2ac3:	e8 58 13 00 00       	call   3e20 <printf>
    exit();
    2ac8:	e8 d5 11 00 00       	call   3ca2 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2acd:	c7 44 24 04 58 56 00 	movl   $0x5658,0x4(%esp)
    2ad4:	00 
    2ad5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2adc:	e8 3f 13 00 00       	call   3e20 <printf>
    exit();
...
00002c80 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2c87:	c7 44 24 04 48 4f 00 	movl   $0x4f48,0x4(%esp)
    2c8e:	00 
    2c8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c96:	e8 85 11 00 00       	call   3e20 <printf>
  fd = open("dirfile", O_CREATE);
    2c9b:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2ca2:	00 
    2ca3:	c7 04 24 55 4f 00 00 	movl   $0x4f55,(%esp)
  ...
  if(chdir("dirfile") == 0){
    2cbf:	c7 04 24 55 4f 00 00 	movl   $0x4f55,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2cda:	00 
    2cdb:	c7 04 24 8e 4f 00 00 	movl   $0x4f8e,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2d6a:	00 
    2d6b:	c7 04 24 4e 4b 00 00 	movl   $0x4b4e,(%esp)
  ...
  fd = open(".", 0);
    ...
    2d86:	00 
    2d87:	c7 04 24 4e 4b 00 00 	movl   $0x4b4e,(%esp)
    2d8e:	e8 4f 0f 00 00       	call   3ce2 <open>
  if(write(fd, "x", 1) > 0){
    2d93:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2d9a:	00 
    2d9b:	c7 44 24 04 31 4c 00 	movl   $0x4c31,0x4(%esp)
    2da2:	00 
  ...
  printf(1, "dir vs file OK\n");
    2db9:	c7 44 24 04 25 50 00 	movl   $0x5025,0x4(%esp)
    2dc0:	00 
    2dc1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dc8:	e8 53 10 00 00       	call   3e20 <printf>
}
    ...
    2dd3:	c7 44 24 04 99 4f 00 	movl   $0x4f99,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 39 10 00 00       	call   3e20 <printf>
    exit();
    2de7:	e8 b6 0e 00 00       	call   3ca2 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2dec:	c7 44 24 04 74 4f 00 	movl   $0x4f74,0x4(%esp)
    2df3:	00 
    2df4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dfb:	e8 20 10 00 00       	call   3e20 <printf>
    exit();
    2e00:	e8 9d 0e 00 00       	call   3ca2 <exit>
    printf(1, "create dirfile failed\n");
    2e05:	c7 44 24 04 5d 4f 00 	movl   $0x4f5d,0x4(%esp)
    2e0c:	00 
    2e0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e14:	e8 07 10 00 00       	call   3e20 <printf>
    exit();
    2e19:	e8 84 0e 00 00       	call   3ca2 <exit>
    printf(1, "write . succeeded!\n");
    2e1e:	c7 44 24 04 11 50 00 	movl   $0x5011,0x4(%esp)
    2e25:	00 
    2e26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e2d:	e8 ee 0f 00 00       	call   3e20 <printf>
    exit();
    2e32:	e8 6b 0e 00 00       	call   3ca2 <exit>
    printf(1, "open . for writing succeeded!\n");
    2e37:	c7 44 24 04 08 58 00 	movl   $0x5808,0x4(%esp)
    2e3e:	00 
    2e3f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e46:	e8 d5 0f 00 00       	call   3e20 <printf>
    exit();
    2e4b:	e8 52 0e 00 00       	call   3ca2 <exit>
    printf(1, "unlink dirfile failed!\n");
    2e50:	c7 44 24 04 f9 4f 00 	movl   $0x4ff9,0x4(%esp)
    2e57:	00 
    2e58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e5f:	e8 bc 0f 00 00       	call   3e20 <printf>
    exit();
    2e64:	e8 39 0e 00 00       	call   3ca2 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2e69:	c7 44 24 04 e8 57 00 	movl   $0x57e8,0x4(%esp)
    2e70:	00 
    2e71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e78:	e8 a3 0f 00 00       	call   3e20 <printf>
    exit();
    2e7d:	e8 20 0e 00 00       	call   3ca2 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2e82:	c7 44 24 04 d4 4f 00 	movl   $0x4fd4,0x4(%esp)
    2e89:	00 
    2e8a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e91:	e8 8a 0f 00 00       	call   3e20 <printf>
    exit();
    2e96:	e8 07 0e 00 00       	call   3ca2 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2e9b:	c7 44 24 04 b7 4f 00 	movl   $0x4fb7,0x4(%esp)
    2ea2:	00 
    2ea3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2eaa:	e8 71 0f 00 00       	call   3e20 <printf>
    exit();
    ...
    2ec4:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2f4f:	00 
    2f50:	c7 04 24 30 4c 00 00 	movl   $0x4c30,(%esp)
  ...
  printf(1, "empty file name OK\n");
    ...
    2fa3:	c7 44 24 04 4c 50 00 	movl   $0x504c,0x4(%esp)
    2faa:	00 
    2fab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fb2:	e8 69 0e 00 00       	call   3e20 <printf>
      exit();
    2fb7:	e8 e6 0c 00 00       	call   3ca2 <exit>
      printf(1, "chdir irefd failed\n");
    2fbc:	c7 44 24 04 60 50 00 	movl   $0x5060,0x4(%esp)
    2fc3:	00 
    2fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2fcb:	e8 50 0e 00 00       	call   3e20 <printf>
      exit();
    ...
    2fe4:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2fe9:	c7 44 24 04 88 50 00 	movl   $0x5088,0x4(%esp)
    2ff0:	00 
    2ff1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ff8:	e8 23 0e 00 00       	call   3e20 <printf>
  ...
  printf(1, "fork test OK\n");
    3042:	c7 44 24 04 ba 50 00 	movl   $0x50ba,0x4(%esp)
    3049:	00 
    304a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3051:	e8 ca 0d 00 00       	call   3e20 <printf>
}
    ...
    3060:	c7 44 24 04 28 58 00 	movl   $0x5828,0x4(%esp)
    3067:	00 
    3068:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    306f:	e8 ac 0d 00 00       	call   3e20 <printf>
    exit();
    3074:	e8 29 0c 00 00       	call   3ca2 <exit>
      printf(1, "wait stopped early\n");
    3079:	c7 44 24 04 93 50 00 	movl   $0x5093,0x4(%esp)
    3080:	00 
    3081:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3088:	e8 93 0d 00 00       	call   3e20 <printf>
      exit();
    308d:	e8 10 0c 00 00       	call   3ca2 <exit>
    printf(1, "wait got too many\n");
    3092:	c7 44 24 04 a7 50 00 	movl   $0x50a7,0x4(%esp)
    3099:	00 
    309a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30a1:	e8 7a 0d 00 00       	call   3e20 <printf>
    exit();
    ...
    30b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    30bb:	a1 10 64 00 00       	mov    0x6410,%eax
    30c0:	c7 44 24 04 c8 50 00 	movl   $0x50c8,0x4(%esp)
    30c7:	00 
    30c8:	89 04 24             	mov    %eax,(%esp)
    30cb:	e8 50 0d 00 00       	call   3e20 <printf>
  oldbrk = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    331a:	a1 10 64 00 00       	mov    0x6410,%eax
    331f:	c7 44 24 04 70 51 00 	movl   $0x5170,0x4(%esp)
    3326:	00 
    3327:	89 04 24             	mov    %eax,(%esp)
    332a:	e8 f1 0a 00 00       	call   3e20 <printf>
}
    ...
    335c:	00 
    335d:	c7 44 24 04 31 4c 00 	movl   $0x4c31,0x4(%esp)
    3364:	00 
    ...
    3382:	a1 10 64 00 00       	mov    0x6410,%eax
    3387:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    338b:	89 74 24 08          	mov    %esi,0x8(%esp)
    338f:	c7 44 24 04 d3 50 00 	movl   $0x50d3,0x4(%esp)
    3396:	00 
    3397:	89 04 24             	mov    %eax,(%esp)
    339a:	e8 81 0a 00 00       	call   3e20 <printf>
      exit();
    339f:	e8 fe 08 00 00       	call   3ca2 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    33a4:	a1 10 64 00 00       	mov    0x6410,%eax
    33a9:	c7 44 24 04 55 51 00 	movl   $0x5155,0x4(%esp)
    33b0:	00 
    33b1:	89 04 24             	mov    %eax,(%esp)
    33b4:	e8 67 0a 00 00       	call   3e20 <printf>
    exit();
    33b9:	e8 e4 08 00 00       	call   3ca2 <exit>
    printf(1, "pipe() failed\n");
    33be:	c7 44 24 04 11 46 00 	movl   $0x4611,0x4(%esp)
    33c5:	00 
    33c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    33cd:	e8 4e 0a 00 00       	call   3e20 <printf>
    exit();
    33d2:	e8 cb 08 00 00       	call   3ca2 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    33d7:	0f be 03             	movsbl (%ebx),%eax
    33da:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    33de:	c7 44 24 04 3c 51 00 	movl   $0x513c,0x4(%esp)
    33e5:	00 
    33e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
    33ea:	a1 10 64 00 00       	mov    0x6410,%eax
    33ef:	89 04 24             	mov    %eax,(%esp)
    33f2:	e8 29 0a 00 00       	call   3e20 <printf>
      kill(ppid);
    ...
    33ff:	e8 9e 08 00 00       	call   3ca2 <exit>
      printf(stdout, "fork failed\n");
    3404:	a1 10 64 00 00       	mov    0x6410,%eax
    3409:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
    3410:	00 
    3411:	89 04 24             	mov    %eax,(%esp)
    3414:	e8 07 0a 00 00       	call   3e20 <printf>
      exit();
    3419:	e8 84 08 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    341e:	89 44 24 0c          	mov    %eax,0xc(%esp)
    3422:	a1 10 64 00 00       	mov    0x6410,%eax
    3427:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    342b:	c7 44 24 04 1c 59 00 	movl   $0x591c,0x4(%esp)
    3432:	00 
    3433:	89 04 24             	mov    %eax,(%esp)
    3436:	e8 e5 09 00 00       	call   3e20 <printf>
    exit();
    343b:	e8 62 08 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    3440:	a1 10 64 00 00       	mov    0x6410,%eax
    3445:	c7 44 24 04 ec 58 00 	movl   $0x58ec,0x4(%esp)
    344c:	00 
    344d:	89 04 24             	mov    %eax,(%esp)
    3450:	e8 cb 09 00 00       	call   3e20 <printf>
    exit();
    3455:	e8 48 08 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    345a:	a1 10 64 00 00       	mov    0x6410,%eax
    345f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    3463:	89 74 24 08          	mov    %esi,0x8(%esp)
    3467:	c7 44 24 04 c4 58 00 	movl   $0x58c4,0x4(%esp)
    346e:	00 
    346f:	89 04 24             	mov    %eax,(%esp)
    3472:	e8 a9 09 00 00       	call   3e20 <printf>
    exit();
    3477:	e8 26 08 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    347c:	89 44 24 0c          	mov    %eax,0xc(%esp)
    3480:	a1 10 64 00 00       	mov    0x6410,%eax
    3485:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    3489:	c7 44 24 04 8c 58 00 	movl   $0x588c,0x4(%esp)
    3490:	00 
    3491:	89 04 24             	mov    %eax,(%esp)
    3494:	e8 87 09 00 00       	call   3e20 <printf>
    exit();
    3499:	e8 04 08 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    349e:	a1 10 64 00 00       	mov    0x6410,%eax
    34a3:	c7 44 24 04 21 51 00 	movl   $0x5121,0x4(%esp)
    34aa:	00 
    34ab:	89 04 24             	mov    %eax,(%esp)
    34ae:	e8 6d 09 00 00       	call   3e20 <printf>
    exit();
    34b3:	e8 ea 07 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    34b8:	a1 10 64 00 00       	mov    0x6410,%eax
    34bd:	c7 44 24 04 4c 58 00 	movl   $0x584c,0x4(%esp)
    34c4:	00 
    34c5:	89 04 24             	mov    %eax,(%esp)
    34c8:	e8 53 09 00 00       	call   3e20 <printf>
    exit();
    34cd:	e8 d0 07 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    34d2:	a1 10 64 00 00       	mov    0x6410,%eax
    34d7:	c7 44 24 04 05 51 00 	movl   $0x5105,0x4(%esp)
    34de:	00 
    34df:	89 04 24             	mov    %eax,(%esp)
    34e2:	e8 39 09 00 00       	call   3e20 <printf>
    exit();
    34e7:	e8 b6 07 00 00       	call   3ca2 <exit>
    printf(stdout, "sbrk test fork failed\n");
    34ec:	a1 10 64 00 00       	mov    0x6410,%eax
    34f1:	c7 44 24 04 ee 50 00 	movl   $0x50ee,0x4(%esp)
    34f8:	00 
    34f9:	89 04 24             	mov    %eax,(%esp)
    34fc:	e8 1f 09 00 00       	call   3e20 <printf>
    exit();
    ...
    3525:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(stdout, "validate test\n");
    352a:	a1 10 64 00 00       	mov    0x6410,%eax
    352f:	c7 44 24 04 7e 51 00 	movl   $0x517e,0x4(%esp)
    3536:	00 
    3537:	89 04 24             	mov    %eax,(%esp)
    353a:	e8 e1 08 00 00       	call   3e20 <printf>
    353f:	90                   	nop
    if((pid = fork()) == 0){
    ...
    3574:	c7 04 24 8d 51 00 00 	movl   $0x518d,(%esp)
  ...
  printf(stdout, "validate ok\n");
    3593:	a1 10 64 00 00       	mov    0x6410,%eax
    3598:	c7 44 24 04 b1 51 00 	movl   $0x51b1,0x4(%esp)
    359f:	00 
    35a0:	89 04 24             	mov    %eax,(%esp)
    35a3:	e8 78 08 00 00       	call   3e20 <printf>
}
    ...
    35af:	a1 10 64 00 00       	mov    0x6410,%eax
    35b4:	c7 44 24 04 98 51 00 	movl   $0x5198,0x4(%esp)
    35bb:	00 
    35bc:	89 04 24             	mov    %eax,(%esp)
    35bf:	e8 5c 08 00 00       	call   3e20 <printf>
      exit();
...
000035d0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    35d6:	a1 10 64 00 00       	mov    0x6410,%eax
    35db:	c7 44 24 04 be 51 00 	movl   $0x51be,0x4(%esp)
    35e2:	00 
    35e3:	89 04 24             	mov    %eax,(%esp)
    35e6:	e8 35 08 00 00       	call   3e20 <printf>
    if(uninit[i] != '\0'){
    35eb:	80 3d e0 64 00 00 00 	cmpb   $0x0,0x64e0
    35f2:	75 36                	jne    362a <bsstest+0x5a>
  for(i = 0; i < sizeof(uninit); i++){
    35f4:	b8 01 00 00 00       	mov    $0x1,%eax
    35f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(uninit[i] != '\0'){
    3600:	80 b8 e0 64 00 00 00 	cmpb   $0x0,0x64e0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    3613:	a1 10 64 00 00       	mov    0x6410,%eax
    3618:	c7 44 24 04 d9 51 00 	movl   $0x51d9,0x4(%esp)
    361f:	00 
    3620:	89 04 24             	mov    %eax,(%esp)
    3623:	e8 f8 07 00 00       	call   3e20 <printf>
}
    3628:	c9                   	leave  
    3629:	c3                   	ret    
      printf(stdout, "bss test failed\n");
    362a:	a1 10 64 00 00       	mov    0x6410,%eax
    362f:	c7 44 24 04 c8 51 00 	movl   $0x51c8,0x4(%esp)
    3636:	00 
    3637:	89 04 24             	mov    %eax,(%esp)
    363a:	e8 e1 07 00 00       	call   3e20 <printf>
      exit();
...
00003650 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3656:	c7 04 24 e6 51 00 00 	movl   $0x51e6,(%esp)
  ...
  fd = open("bigarg-ok", 0);
    ...
    3682:	00 
    3683:	c7 04 24 e6 51 00 00 	movl   $0x51e6,(%esp)
  ...
  unlink("bigarg-ok");
    369f:	c7 04 24 e6 51 00 00 	movl   $0x51e6,(%esp)
    ...
    36b0:	c7 04 85 40 64 00 00 	movl   $0x5940,0x6440(,%eax,4)
    36b7:	40 59 00 00 
    ...
    36c3:	a1 10 64 00 00       	mov    0x6410,%eax
    36c8:	c7 44 24 04 f0 51 00 	movl   $0x51f0,0x4(%esp)
    36cf:	00 
    args[MAXARG-1] = 0;
    36d0:	c7 05 bc 64 00 00 00 	movl   $0x0,0x64bc
    36d7:	00 00 00 
    printf(stdout, "bigarg test\n");
    36da:	89 04 24             	mov    %eax,(%esp)
    36dd:	e8 3e 07 00 00       	call   3e20 <printf>
    exec("echo", args);
    36e2:	c7 44 24 04 40 64 00 	movl   $0x6440,0x4(%esp)
    36e9:	00 
    36ea:	c7 04 24 bd 43 00 00 	movl   $0x43bd,(%esp)
    36f1:	e8 e4 05 00 00       	call   3cda <exec>
    printf(stdout, "bigarg test ok\n");
    36f6:	a1 10 64 00 00       	mov    0x6410,%eax
    36fb:	c7 44 24 04 fd 51 00 	movl   $0x51fd,0x4(%esp)
    3702:	00 
    3703:	89 04 24             	mov    %eax,(%esp)
    3706:	e8 15 07 00 00       	call   3e20 <printf>
    fd = open("bigarg-ok", O_CREATE);
    370b:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3712:	00 
    3713:	c7 04 24 e6 51 00 00 	movl   $0x51e6,(%esp)
    ...
    372c:	a1 10 64 00 00       	mov    0x6410,%eax
    3731:	c7 44 24 04 26 52 00 	movl   $0x5226,0x4(%esp)
    3738:	00 
    3739:	89 04 24             	mov    %eax,(%esp)
    373c:	e8 df 06 00 00       	call   3e20 <printf>
    exit();
    3741:	e8 5c 05 00 00       	call   3ca2 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3746:	a1 10 64 00 00       	mov    0x6410,%eax
    374b:	c7 44 24 04 0d 52 00 	movl   $0x520d,0x4(%esp)
    3752:	00 
    3753:	89 04 24             	mov    %eax,(%esp)
    3756:	e8 c5 06 00 00       	call   3e20 <printf>
    exit();
    ...
    3766:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    376b:	c7 44 24 04 3b 52 00 	movl   $0x523b,0x4(%esp)
    3772:	00 
    3773:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    377a:	e8 a1 06 00 00       	call   3e20 <printf>
    377f:	90                   	nop
    ...
    printf(1, "writing %s\n", name);
    3790:	c7 44 24 04 48 52 00 	movl   $0x5248,0x4(%esp)
    3797:	00 
    ...
    3818:	e8 03 06 00 00       	call   3e20 <printf>
    ...
    3849:	00 
    384a:	c7 44 24 04 00 8c 00 	movl   $0x8c00,0x4(%esp)
    3851:	00 
    ...
    3865:	c7 44 24 04 64 52 00 	movl   $0x5264,0x4(%esp)
    386c:	00 
    386d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3874:	e8 a7 05 00 00       	call   3e20 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3894:	c7 44 24 04 54 52 00 	movl   $0x5254,0x4(%esp)
    389b:	00 
    389c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    38a3:	e8 78 05 00 00       	call   3e20 <printf>
    name[1] = '0' + nfiles / 1000;
  ...
  printf(1, "fsfull test finished\n");
    3941:	c7 44 24 04 74 52 00 	movl   $0x5274,0x4(%esp)
    3948:	00 
    3949:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3950:	e8 cb 04 00 00       	call   3e20 <printf>
}
...
00003960 <uio>:
{
  ...
  printf(1, "uio test\n");
    3966:	c7 44 24 04 8a 52 00 	movl   $0x528a,0x4(%esp)
    396d:	00 
    396e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3975:	e8 a6 04 00 00       	call   3e20 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    398a:	c7 44 24 04 94 52 00 	movl   $0x5294,0x4(%esp)
    3991:	00 
    3992:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3999:	e8 82 04 00 00       	call   3e20 <printf>
}
    399e:	c9                   	leave  
    399f:	c3                   	ret    
    ...
    39ae:	c7 44 24 04 20 5a 00 	movl   $0x5a20,0x4(%esp)
    39b5:	00 
    39b6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39bd:	e8 5e 04 00 00       	call   3e20 <printf>
    exit();
    39c2:	e8 db 02 00 00       	call   3ca2 <exit>
    printf (1, "fork failed\n");
    39c7:	c7 44 24 04 19 52 00 	movl   $0x5219,0x4(%esp)
    39ce:	00 
    39cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39d6:	e8 45 04 00 00       	call   3e20 <printf>
    exit();
...
000039e0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    39ee:	00 
    39ef:	c7 04 24 a3 52 00 00 	movl   $0x52a3,(%esp)
  ...
  printf(1, "arg test passed\n");
    3a2c:	c7 44 24 04 b5 52 00 	movl   $0x52b5,0x4(%esp)
    3a33:	00 
    3a34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3a3b:	e8 e0 03 00 00       	call   3e20 <printf>
}
    ...
    3a46:	c7 44 24 04 a8 52 00 	movl   $0x52a8,0x4(%esp)
    3a4d:	00 
    3a4e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3a55:	e8 c6 03 00 00       	call   3e20 <printf>
    exit();
...
00003a60 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3a60:	69 05 0c 64 00 00 0d 	imul   $0x19660d,0x640c,%eax
    3a67:	66 19 00 
{
    3a6a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3a73:	a3 0c 64 00 00       	mov    %eax,0x640c
}
    3a78:	c3                   	ret    
...
00003d6a <kthread_join>:
SYSCALL(kthread_join)
    3d6a:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3d6f:	cd 40                	int    $0x40
    3d71:	c3                   	ret    

00003d72 <kthread_exit>:
SYSCALL(kthread_exit)
    3d72:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3d77:	cd 40                	int    $0x40
    3d79:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3d83:	57                   	push   %edi
    3d84:	56                   	push   %esi
    3d85:	89 c6                	mov    %eax,%esi
    3d87:	53                   	push   %ebx
    3d88:	83 ec 4c             	sub    $0x4c,%esp
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3d8b:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3d8e:	85 db                	test   %ebx,%ebx
    3d90:	74 09                	je     3d9b <printint+0x1b>
    3d92:	89 d0                	mov    %edx,%eax
    3d94:	c1 e8 1f             	shr    $0x1f,%eax
    3d97:	84 c0                	test   %al,%al
    3d99:	75 75                	jne    3e10 <printint+0x90>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    3d9b:	89 d0                	mov    %edx,%eax
  neg = 0;
    3d9d:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    3da4:	89 75 c0             	mov    %esi,-0x40(%ebp)
  }

  i = 0;
    3da7:	31 ff                	xor    %edi,%edi
    3da9:	89 ce                	mov    %ecx,%esi
    3dab:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    3dae:	eb 02                	jmp    3db2 <printint+0x32>
  do{
    buf[i++] = digits[x % base];
    3db0:	89 cf                	mov    %ecx,%edi
    3db2:	31 d2                	xor    %edx,%edx
    3db4:	f7 f6                	div    %esi
    3db6:	8d 4f 01             	lea    0x1(%edi),%ecx
    3db9:	0f b6 92 77 5a 00 00 	movzbl 0x5a77(%edx),%edx
  }while((x /= base) != 0);
    3dc0:	85 c0                	test   %eax,%eax
    buf[i++] = digits[x % base];
    3dc2:	88 14 0b             	mov    %dl,(%ebx,%ecx,1)
  }while((x /= base) != 0);
    3dc5:	75 e9                	jne    3db0 <printint+0x30>
  if(neg)
    3dc7:	8b 55 c4             	mov    -0x3c(%ebp),%edx
    buf[i++] = digits[x % base];
    3dca:	89 c8                	mov    %ecx,%eax
    3dcc:	8b 75 c0             	mov    -0x40(%ebp),%esi
  if(neg)
    3dcf:	85 d2                	test   %edx,%edx
    3dd1:	74 08                	je     3ddb <printint+0x5b>
    buf[i++] = '-';
    3dd3:	8d 4f 02             	lea    0x2(%edi),%ecx
    3dd6:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)

  while(--i >= 0)
    3ddb:	8d 79 ff             	lea    -0x1(%ecx),%edi
    3dde:	66 90                	xchg   %ax,%ax
    3de0:	0f b6 44 3d d8       	movzbl -0x28(%ebp,%edi,1),%eax
    3de5:	83 ef 01             	sub    $0x1,%edi
  write(fd, &c, 1);
    3de8:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3def:	00 
    3df0:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    3df4:	89 34 24             	mov    %esi,(%esp)
    3df7:	88 45 d7             	mov    %al,-0x29(%ebp)
    3dfa:	e8 c3 fe ff ff       	call   3cc2 <write>
  while(--i >= 0)
    3dff:	83 ff ff             	cmp    $0xffffffff,%edi
    3e02:	75 dc                	jne    3de0 <printint+0x60>
    putc(fd, buf[i]);
}
    3e04:	83 c4 4c             	add    $0x4c,%esp
    3e07:	5b                   	pop    %ebx
    3e08:	5e                   	pop    %esi
    3e09:	5f                   	pop    %edi
    3e0a:	5d                   	pop    %ebp
    ...
    x = -xx;
    3e10:	89 d0                	mov    %edx,%eax
    3e12:	f7 d8                	neg    %eax
    neg = 1;
    3e14:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
    3e1b:	eb 87                	jmp    3da4 <printint+0x24>
    ...
    3e24:	31 ff                	xor    %edi,%edi
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3e2b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  ap = (uint*)(void*)&fmt + 1;
    3e2e:	8d 45 10             	lea    0x10(%ebp),%eax
{
    3e31:	8b 75 08             	mov    0x8(%ebp),%esi
  ap = (uint*)(void*)&fmt + 1;
    3e34:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
    3e37:	0f b6 13             	movzbl (%ebx),%edx
    3e3a:	83 c3 01             	add    $0x1,%ebx
    3e3d:	84 d2                	test   %dl,%dl
    3e3f:	75 39                	jne    3e7a <printf+0x5a>
    3e41:	e9 ca 00 00 00       	jmp    3f10 <printf+0xf0>
    3e46:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    3e48:	83 fa 25             	cmp    $0x25,%edx
    3e4b:	0f 84 c7 00 00 00    	je     3f18 <printf+0xf8>
  write(fd, &c, 1);
    3e51:	8d 45 e0             	lea    -0x20(%ebp),%eax
    3e54:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3e5b:	00 
    3e5c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e60:	89 34 24             	mov    %esi,(%esp)
        state = '%';
      } else {
        putc(fd, c);
    3e63:	88 55 e0             	mov    %dl,-0x20(%ebp)
  write(fd, &c, 1);
    3e66:	e8 57 fe ff ff       	call   3cc2 <write>
    3e6b:	83 c3 01             	add    $0x1,%ebx
  for(i = 0; fmt[i]; i++){
    3e6e:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3e72:	84 d2                	test   %dl,%dl
    3e74:	0f 84 96 00 00 00    	je     3f10 <printf+0xf0>
    if(state == 0){
    3e7a:	85 ff                	test   %edi,%edi
    c = fmt[i] & 0xff;
    3e7c:	0f be c2             	movsbl %dl,%eax
    if(state == 0){
    3e7f:	74 c7                	je     3e48 <printf+0x28>
      }
    } else if(state == '%'){
    3e81:	83 ff 25             	cmp    $0x25,%edi
    3e84:	75 e5                	jne    3e6b <printf+0x4b>
      if(c == 'd' || c == 'u'){
    3e86:	83 fa 75             	cmp    $0x75,%edx
    3e89:	0f 84 99 00 00 00    	je     3f28 <printf+0x108>
    3e8f:	83 fa 64             	cmp    $0x64,%edx
    3e92:	0f 84 90 00 00 00    	je     3f28 <printf+0x108>
          // added unsigned - RJC
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3e98:	25 f7 00 00 00       	and    $0xf7,%eax
    3e9d:	83 f8 70             	cmp    $0x70,%eax
    3ea0:	0f 84 aa 00 00 00    	je     3f50 <printf+0x130>
    ...
    3ea6:	83 fa 73             	cmp    $0x73,%edx
    3ea9:	0f 84 e9 00 00 00    	je     3f98 <printf+0x178>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3eaf:	83 fa 63             	cmp    $0x63,%edx
    3eb2:	0f 84 2b 01 00 00    	je     3fe3 <printf+0x1c3>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3eb8:	83 fa 25             	cmp    $0x25,%edx
    3ebb:	0f 84 4f 01 00 00    	je     4010 <printf+0x1f0>
  write(fd, &c, 1);
    3ec1:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3ec4:	83 c3 01             	add    $0x1,%ebx
    3ec7:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ece:	00 
      } else {
      ...
      state = 0;
    3ecf:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    3ed1:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ed5:	89 34 24             	mov    %esi,(%esp)
    3ed8:	89 55 d0             	mov    %edx,-0x30(%ebp)
    3edb:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
    3edf:	e8 de fd ff ff       	call   3cc2 <write>
        putc(fd, c);
    3ee4:	8b 55 d0             	mov    -0x30(%ebp),%edx
  write(fd, &c, 1);
    3ee7:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3eea:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ef1:	00 
    3ef2:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ef6:	89 34 24             	mov    %esi,(%esp)
        putc(fd, c);
    3ef9:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3efc:	e8 c1 fd ff ff       	call   3cc2 <write>
  for(i = 0; fmt[i]; i++){
    3f01:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3f05:	84 d2                	test   %dl,%dl
    3f07:	0f 85 6d ff ff ff    	jne    3e7a <printf+0x5a>
    3f0d:	8d 76 00             	lea    0x0(%esi),%esi
    }
  }
}
    3f10:	83 c4 3c             	add    $0x3c,%esp
    3f13:	5b                   	pop    %ebx
    3f14:	5e                   	pop    %esi
    3f15:	5f                   	pop    %edi
    3f16:	5d                   	pop    %ebp
    3f17:	c3                   	ret    
        state = '%';
    3f18:	bf 25 00 00 00       	mov    $0x25,%edi
    3f1d:	e9 49 ff ff ff       	jmp    3e6b <printf+0x4b>
    3f22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    3f28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3f2f:	b9 0a 00 00 00       	mov    $0xa,%ecx
        printint(fd, *ap, 16, 0);
    3f34:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      state = 0;
    3f37:	31 ff                	xor    %edi,%edi
        printint(fd, *ap, 16, 0);
    3f39:	8b 10                	mov    (%eax),%edx
    3f3b:	89 f0                	mov    %esi,%eax
    3f3d:	e8 3e fe ff ff       	call   3d80 <printint>
        ap++;
    3f42:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3f46:	e9 20 ff ff ff       	jmp    3e6b <printf+0x4b>
    3f4b:	90                   	nop
    3f4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    3f50:	8d 45 e1             	lea    -0x1f(%ebp),%eax
    3f53:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f5a:	00 
    3f5b:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f5f:	89 34 24             	mov    %esi,(%esp)
    3f62:	c6 45 e1 30          	movb   $0x30,-0x1f(%ebp)
    3f66:	e8 57 fd ff ff       	call   3cc2 <write>
    3f6b:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    3f6e:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f75:	00 
    3f76:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f7a:	89 34 24             	mov    %esi,(%esp)
    3f7d:	c6 45 e2 78          	movb   $0x78,-0x1e(%ebp)
    3f81:	e8 3c fd ff ff       	call   3cc2 <write>
        printint(fd, *ap, 16, 0);
    3f86:	b9 10 00 00 00       	mov    $0x10,%ecx
    3f8b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3f92:	eb a0                	jmp    3f34 <printf+0x114>
    3f94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3f98:	8b 45 d4             	mov    -0x2c(%ebp),%eax
        ap++;
    3f9b:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
        s = (char*)*ap;
    3f9f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    3fa1:	b8 70 5a 00 00       	mov    $0x5a70,%eax
    3fa6:	85 ff                	test   %edi,%edi
    3fa8:	0f 44 f8             	cmove  %eax,%edi
        while(*s != 0){
    3fab:	0f b6 07             	movzbl (%edi),%eax
    3fae:	84 c0                	test   %al,%al
    3fb0:	74 2a                	je     3fdc <printf+0x1bc>
    3fb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3fb8:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    3fbb:	8d 45 e3             	lea    -0x1d(%ebp),%eax
          s++;
    3fbe:	83 c7 01             	add    $0x1,%edi
  write(fd, &c, 1);
    3fc1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3fc8:	00 
    3fc9:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fcd:	89 34 24             	mov    %esi,(%esp)
    3fd0:	e8 ed fc ff ff       	call   3cc2 <write>
        while(*s != 0){
    3fd5:	0f b6 07             	movzbl (%edi),%eax
    3fd8:	84 c0                	test   %al,%al
    3fda:	75 dc                	jne    3fb8 <printf+0x198>
      state = 0;
    3fdc:	31 ff                	xor    %edi,%edi
    3fde:	e9 88 fe ff ff       	jmp    3e6b <printf+0x4b>
        putc(fd, *ap);
    3fe3:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      state = 0;
    3fe6:	31 ff                	xor    %edi,%edi
        putc(fd, *ap);
    3fe8:	8b 00                	mov    (%eax),%eax
  write(fd, &c, 1);
    3fea:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ff1:	00 
    3ff2:	89 34 24             	mov    %esi,(%esp)
        putc(fd, *ap);
    3ff5:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    3ff8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    3ffb:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fff:	e8 be fc ff ff       	call   3cc2 <write>
        ap++;
    4004:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    4008:	e9 5e fe ff ff       	jmp    3e6b <printf+0x4b>
    400d:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    4010:	8d 45 e5             	lea    -0x1b(%ebp),%eax
      state = 0;
    4013:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    4015:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    401c:	00 
    401d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4021:	89 34 24             	mov    %esi,(%esp)
    4024:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
    4028:	e8 95 fc ff ff       	call   3cc2 <write>
    402d:	e9 39 fe ff ff       	jmp    3e6b <printf+0x4b>
    4032:	66 90                	xchg   %ax,%ax
    4034:	66 90                	xchg   %ax,%ax
    4036:	66 90                	xchg   %ax,%ax
    4038:	66 90                	xchg   %ax,%ax
    403a:	66 90                	xchg   %ax,%ax
    403c:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4041:	a1 c0 64 00 00       	mov    0x64c0,%eax
{
    4046:	89 e5                	mov    %esp,%ebp
    4048:	57                   	push   %edi
    4049:	56                   	push   %esi
    404a:	53                   	push   %ebx
    404b:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    404e:	8b 08                	mov    (%eax),%ecx
  bp = (Header*)ap - 1;
    4050:	8d 53 f8             	lea    -0x8(%ebx),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4053:	39 d0                	cmp    %edx,%eax
    4055:	72 11                	jb     4068 <free+0x28>
    4057:	90                   	nop
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4058:	39 c8                	cmp    %ecx,%eax
    405a:	72 04                	jb     4060 <free+0x20>
    405c:	39 ca                	cmp    %ecx,%edx
    405e:	72 10                	jb     4070 <free+0x30>
    4060:	89 c8                	mov    %ecx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4062:	39 d0                	cmp    %edx,%eax
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4064:	8b 08                	mov    (%eax),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4066:	73 f0                	jae    4058 <free+0x18>
    4068:	39 ca                	cmp    %ecx,%edx
    406a:	72 04                	jb     4070 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    406c:	39 c8                	cmp    %ecx,%eax
    406e:	72 f0                	jb     4060 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    4070:	8b 73 fc             	mov    -0x4(%ebx),%esi
    4073:	8d 3c f2             	lea    (%edx,%esi,8),%edi
    4076:	39 cf                	cmp    %ecx,%edi
    4078:	74 1e                	je     4098 <free+0x58>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    407a:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    407d:	8b 48 04             	mov    0x4(%eax),%ecx
    4080:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    4083:	39 f2                	cmp    %esi,%edx
    4085:	74 28                	je     40af <free+0x6f>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    4087:	89 10                	mov    %edx,(%eax)
  freep = p;
    4089:	a3 c0 64 00 00       	mov    %eax,0x64c0
}
    408e:	5b                   	pop    %ebx
    408f:	5e                   	pop    %esi
    4090:	5f                   	pop    %edi
    ...
    bp->s.size += p->s.ptr->s.size;
    4098:	03 71 04             	add    0x4(%ecx),%esi
    409b:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    409e:	8b 08                	mov    (%eax),%ecx
    40a0:	8b 09                	mov    (%ecx),%ecx
    40a2:	89 4b f8             	mov    %ecx,-0x8(%ebx)
  if(p + p->s.size == bp){
    40a5:	8b 48 04             	mov    0x4(%eax),%ecx
    40a8:	8d 34 c8             	lea    (%eax,%ecx,8),%esi
    40ab:	39 f2                	cmp    %esi,%edx
    40ad:	75 d8                	jne    4087 <free+0x47>
    p->s.size += bp->s.size;
    40af:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
    40b2:	a3 c0 64 00 00       	mov    %eax,0x64c0
    p->s.size += bp->s.size;
    40b7:	89 48 04             	mov    %ecx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    40ba:	8b 53 f8             	mov    -0x8(%ebx),%edx
    40bd:	89 10                	mov    %edx,(%eax)
}
    40bf:	5b                   	pop    %ebx
    40c0:	5e                   	pop    %esi
    40c1:	5f                   	pop    %edi
    40c2:	5d                   	pop    %ebp
    40c3:	c3                   	ret    
    40c4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    40ca:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40dc:	8b 1d c0 64 00 00    	mov    0x64c0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40e2:	8d 48 07             	lea    0x7(%eax),%ecx
    40e5:	c1 e9 03             	shr    $0x3,%ecx
  if((prevp = freep) == 0){
    40e8:	85 db                	test   %ebx,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40ea:	8d 71 01             	lea    0x1(%ecx),%esi
  if((prevp = freep) == 0){
    40ed:	0f 84 9b 00 00 00    	je     418e <malloc+0xbe>
    40f3:	8b 13                	mov    (%ebx),%edx
    40f5:	8b 7a 04             	mov    0x4(%edx),%edi
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    40f8:	39 fe                	cmp    %edi,%esi
    40fa:	76 64                	jbe    4160 <malloc+0x90>
    40fc:	8d 04 f5 00 00 00 00 	lea    0x0(,%esi,8),%eax
  if(nu < 4096)
    4103:	bb 00 80 00 00       	mov    $0x8000,%ebx
    4108:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    410b:	eb 0e                	jmp    411b <malloc+0x4b>
    410d:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4110:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    4112:	8b 78 04             	mov    0x4(%eax),%edi
    4115:	39 fe                	cmp    %edi,%esi
    4117:	76 4f                	jbe    4168 <malloc+0x98>
    ...
    if(p == freep)
    411b:	3b 15 c0 64 00 00    	cmp    0x64c0,%edx
    4121:	75 ed                	jne    4110 <malloc+0x40>
  if(nu < 4096)
    4123:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4126:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    412c:	bf 00 10 00 00       	mov    $0x1000,%edi
    4131:	0f 43 fe             	cmovae %esi,%edi
    4134:	0f 42 c3             	cmovb  %ebx,%eax
  p = sbrk(nu * sizeof(Header));
    4137:	89 04 24             	mov    %eax,(%esp)
    413a:	e8 eb fb ff ff       	call   3d2a <sbrk>
  if(p == (char*)-1)
    413f:	83 f8 ff             	cmp    $0xffffffff,%eax
    4142:	74 18                	je     415c <malloc+0x8c>
  hp->s.size = nu;
    4144:	89 78 04             	mov    %edi,0x4(%eax)
  free((void*)(hp + 1));
    4147:	83 c0 08             	add    $0x8,%eax
    414a:	89 04 24             	mov    %eax,(%esp)
    414d:	e8 ee fe ff ff       	call   4040 <free>
  return freep;
    4152:	8b 15 c0 64 00 00    	mov    0x64c0,%edx
      if((p = morecore(nunits)) == 0)
    4158:	85 d2                	test   %edx,%edx
    415a:	75 b4                	jne    4110 <malloc+0x40>
        return 0;
    415c:	31 c0                	xor    %eax,%eax
    415e:	eb 20                	jmp    4180 <malloc+0xb0>
    if(p->s.size >= nunits){
    4160:	89 d0                	mov    %edx,%eax
    4162:	89 da                	mov    %ebx,%edx
    4164:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    4168:	39 fe                	cmp    %edi,%esi
    416a:	74 1c                	je     4188 <malloc+0xb8>
        p->s.size -= nunits;
    416c:	29 f7                	sub    %esi,%edi
    416e:	89 78 04             	mov    %edi,0x4(%eax)
        p += p->s.size;
    4171:	8d 04 f8             	lea    (%eax,%edi,8),%eax
        p->s.size = nunits;
    4174:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    4177:	89 15 c0 64 00 00    	mov    %edx,0x64c0
      return (void*)(p + 1);
    417d:	83 c0 08             	add    $0x8,%eax
  }
}
    4180:	83 c4 1c             	add    $0x1c,%esp
    4183:	5b                   	pop    %ebx
    4184:	5e                   	pop    %esi
    4185:	5f                   	pop    %edi
    4186:	5d                   	pop    %ebp
    4187:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    4188:	8b 08                	mov    (%eax),%ecx
    418a:	89 0a                	mov    %ecx,(%edx)
    418c:	eb e9                	jmp    4177 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
    418e:	c7 05 c0 64 00 00 c4 	movl   $0x64c4,0x64c0
    4195:	64 00 00 
    base.s.size = 0;
    4198:	ba c4 64 00 00       	mov    $0x64c4,%edx
    base.s.ptr = freep = prevp = &base;
    419d:	c7 05 c4 64 00 00 c4 	movl   $0x64c4,0x64c4
    41a4:	64 00 00 
    base.s.size = 0;
    41a7:	c7 05 c8 64 00 00 00 	movl   $0x0,0x64c8
    41ae:	00 00 00 
    41b1:	e9 46 ff ff ff       	jmp    40fc <malloc+0x2c>
...
benny_thread_create(benny_thread_t *vbt, void (*func)(void*), void *arg_ptr)
{
    ...
    41c3:	53                   	push   %ebx
    41c4:	83 ec 24             	sub    $0x24,%esp
    struct benny_thread_s *bt = malloc(sizeof(struct benny_thread_s));
    41c7:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    41ce:	e8 fd fe ff ff       	call   40d0 <malloc>
    void *tstack = NULL;

    bt->tstack = tstack = malloc(PGSIZE * 2);
    41d3:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    struct benny_thread_s *bt = malloc(sizeof(struct benny_thread_s));
    41da:	89 c3                	mov    %eax,%ebx
    bt->tstack = tstack = malloc(PGSIZE * 2);
    41dc:	e8 ef fe ff ff       	call   40d0 <malloc>
    if (tstack == NULL) {
    41e1:	85 c0                	test   %eax,%eax
    bt->tstack = tstack = malloc(PGSIZE * 2);
    41e3:	89 c2                	mov    %eax,%edx
    41e5:	89 43 04             	mov    %eax,0x4(%ebx)
    if (tstack == NULL) {
    41e8:	0f 84 8a 00 00 00    	je     4278 <benny_thread_create+0xb8>
        return -1;
    }
    if (((uint) tstack) % PGSIZE != 0) {
    41ee:	25 ff 0f 00 00       	and    $0xfff,%eax
    41f3:	75 73                	jne    4268 <benny_thread_create+0xa8>
        tstack += (PGSIZE - ((uint) tstack) % PGSIZE);
    }
    bt->tid = kthread_create(func, arg_ptr, tstack);
    41f5:	8b 45 10             	mov    0x10(%ebp),%eax
    41f8:	89 54 24 08          	mov    %edx,0x8(%esp)
    41fc:	89 44 24 04          	mov    %eax,0x4(%esp)
    4200:	8b 45 0c             	mov    0xc(%ebp),%eax
    4203:	89 04 24             	mov    %eax,(%esp)
    4206:	e8 57 fb ff ff       	call   3d62 <kthread_create>
    420b:	89 03                	mov    %eax,(%ebx)
    printf(1, "\n%s %d: new thread %d\n", __FILE__, __LINE__, bt->tid);
    420d:	89 44 24 10          	mov    %eax,0x10(%esp)
    4211:	c7 44 24 0c 25 00 00 	movl   $0x25,0xc(%esp)
    4218:	00 
    4219:	c7 44 24 08 88 5a 00 	movl   $0x5a88,0x8(%esp)
    4220:	00 
    4221:	c7 44 24 04 97 5a 00 	movl   $0x5a97,0x4(%esp)
    4228:	00 
    4229:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4230:	e8 eb fb ff ff       	call   3e20 <printf>
    printf(1,"tid:: %u\n",bt->tid);
    4235:	8b 03                	mov    (%ebx),%eax
    4237:	c7 44 24 04 ae 5a 00 	movl   $0x5aae,0x4(%esp)
    423e:	00 
    423f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4246:	89 44 24 08          	mov    %eax,0x8(%esp)
    424a:	e8 d1 fb ff ff       	call   3e20 <printf>
    
    if (bt->tid != 0) {
    424f:	8b 03                	mov    (%ebx),%eax
    4251:	85 c0                	test   %eax,%eax
    4253:	74 23                	je     4278 <benny_thread_create+0xb8>
        *vbt = (benny_thread_t) bt;
    4255:	8b 45 08             	mov    0x8(%ebp),%eax
    4258:	89 18                	mov    %ebx,(%eax)
        return 0;
    425a:	31 c0                	xor    %eax,%eax
    }
    return -1;
}
    425c:	83 c4 24             	add    $0x24,%esp
    425f:	5b                   	pop    %ebx
    4260:	5d                   	pop    %ebp
    4261:	c3                   	ret    
    4262:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        tstack += (PGSIZE - ((uint) tstack) % PGSIZE);
    4268:	29 c2                	sub    %eax,%edx
    426a:	81 c2 00 10 00 00    	add    $0x1000,%edx
    4270:	eb 83                	jmp    41f5 <benny_thread_create+0x35>
    4272:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        return -1;
    4278:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    427d:	eb dd                	jmp    425c <benny_thread_create+0x9c>
    427f:	90                   	nop

00004280 <benny_thread_tid>:
...
benny_thread_tid(benny_thread_t vbt)
{
    ...
    4289:	c3                   	ret    
    428a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00004290 <benny_thread_join>:

int
benny_thread_join(benny_thread_t vbt)
{
    4290:	55                   	push   %ebp
    4291:	89 e5                	mov    %esp,%ebp
    4293:	53                   	push   %ebx
    4294:	83 ec 14             	sub    $0x14,%esp
    4297:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct benny_thread_s *bt = (struct benny_thread_s *) vbt;
    int retVal = -1;
    
    retVal = kthread_join(bt->tid);
    429a:	8b 03                	mov    (%ebx),%eax
    429c:	89 04 24             	mov    %eax,(%esp)
    429f:	e8 c6 fa ff ff       	call   3d6a <kthread_join>
    if (retVal == 0) {
    42a4:	85 c0                	test   %eax,%eax
    42a6:	75 11                	jne    42b9 <benny_thread_join+0x29>
        free(bt->tstack);
    42a8:	8b 53 04             	mov    0x4(%ebx),%edx
    42ab:	89 45 f4             	mov    %eax,-0xc(%ebp)
    42ae:	89 14 24             	mov    %edx,(%esp)
    42b1:	e8 8a fd ff ff       	call   4040 <free>
    42b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    }
    
    return retVal;
}
    42b9:	83 c4 14             	add    $0x14,%esp
    42bc:	5b                   	pop    %ebx
    42bd:	5d                   	pop    %ebp
    42be:	c3                   	ret    
    42bf:	90                   	nop

000042c0 <benny_thread_exit>:
