...
printint(int fd, int xx, int base, int sgn)
{
 ...
 439:	0f b6 92 75 08 00 00 	movzbl 0x875(%edx),%edx
  }while((x /= base) != 0);
 ...
 4ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 55f:	e8 fe fd ff ff       	call   362 <write>
        putc(fd, c);
 ...
 579:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 57c:	e8 e1 fd ff ff       	call   362 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5e6:	e8 77 fd ff ff       	call   362 <write>
 ...
 601:	e8 5c fd ff ff       	call   362 <write>
        printint(fd, *ap, 16, 0);
 ...
 61f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 621:	b8 6e 08 00 00       	mov    $0x86e,%eax
 ...
 67f:	e8 de fc ff ff       	call   362 <write>
        ap++;
 ...
 6a8:	e8 b5 fc ff ff       	call   362 <write>
