...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c 96 07 00 	movl   $0x796,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 98 07 00 	movl   $0x798,0x4(%esp)
  33:	00 
  ...
  4b:	c7 44 24 0c 9d 07 00 	movl   $0x79d,0xc(%esp)
  52:	00 
  53:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  57:	c7 44 24 04 98 07 00 	movl   $0x798,0x4(%esp)
  5e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 a6 07 00 00 	movzbl 0x7a6(%edx),%edx
  }while((x /= base) != 0);
 ...
 40e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 57f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 581:	b8 9f 07 00 00       	mov    $0x79f,%eax
...
free(void *ap)
{
 ...
 621:	a1 20 0a 00 00       	mov    0xa20,%eax
{
 ...
 667:	89 10                	mov    %edx,(%eax)
  freep = p;
 669:	a3 20 0a 00 00       	mov    %eax,0xa20
}
 66e:	5b                   	pop    %ebx
 66f:	5e                   	pop    %esi
 670:	5f                   	pop    %edi
 ...
 68f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 692:	a3 20 0a 00 00       	mov    %eax,0xa20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 1d 20 0a 00 00    	mov    0xa20,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6fb:	3b 15 20 0a 00 00    	cmp    0xa20,%edx
 ...
 72d:	e8 ee fe ff ff       	call   620 <free>
  return freep;
 732:	8b 15 20 0a 00 00    	mov    0xa20,%edx
 ...
 754:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 757:	89 15 20 0a 00 00    	mov    %edx,0xa20
      return (void*)(p + 1);
 ...
 76c:	eb e9                	jmp    757 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 05 20 0a 00 00 24 	movl   $0xa24,0xa20
 775:	0a 00 00 
    base.s.size = 0;
 778:	ba 24 0a 00 00       	mov    $0xa24,%edx
    base.s.ptr = freep = prevp = &base;
 77d:	c7 05 24 0a 00 00 24 	movl   $0xa24,0xa24
 784:	0a 00 00 
    base.s.size = 0;
 787:	c7 05 28 0a 00 00 00 	movl   $0x0,0xa28
 78e:	00 00 00 
