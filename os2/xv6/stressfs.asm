   ...
   b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "stressfs starting\n");
  16:	c7 44 24 04 56 08 00 	movl   $0x856,0x4(%esp)
  1d:	00 
  memset(data, 'a', sizeof(data));
  ...
  printf(1, "write %d\n", i);
  7e:	c7 44 24 04 69 08 00 	movl   $0x869,0x4(%esp)
  85:	00 
...
//    printf(fd, "%d\n", i);
  ...
  printf(1, "read\n");
  d6:	c7 44 24 04 73 08 00 	movl   $0x873,0x4(%esp)
  dd:	00 
 ...
 4ce:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 57f:	e8 fe fd ff ff       	call   382 <write>
        putc(fd, c);
 ...
 606:	e8 77 fd ff ff       	call   382 <write>
 ...
 621:	e8 5c fd ff ff       	call   382 <write>
        printint(fd, *ap, 16, 0);
 ...
 63f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 641:	b8 79 08 00 00       	mov    $0x879,%eax
 ...
 69f:	e8 de fc ff ff       	call   382 <write>
        ap++;
 ...
 6c8:	e8 b5 fc ff ff       	call   382 <write>
...
free(void *ap)
{
 ...
 6e1:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 727:	89 10                	mov    %edx,(%eax)
  freep = p;
 729:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 72e:	5b                   	pop    %ebx
 72f:	5e                   	pop    %esi
 730:	5f                   	pop    %edi
 ...
 74f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 752:	a3 fc 0a 00 00       	mov    %eax,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 1d fc 0a 00 00    	mov    0xafc,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 7bb:	3b 15 fc 0a 00 00    	cmp    0xafc,%edx
 ...
 7da:	e8 0b fc ff ff       	call   3ea <sbrk>
  if(p == (char*)-1)
 ...
 7ed:	e8 ee fe ff ff       	call   6e0 <free>
  return freep;
 7f2:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 814:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 817:	89 15 fc 0a 00 00    	mov    %edx,0xafc
      return (void*)(p + 1);
 ...
 82c:	eb e9                	jmp    817 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 82e:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 835:	0b 00 00 
    base.s.size = 0;
 838:	ba 00 0b 00 00       	mov    $0xb00,%edx
    base.s.ptr = freep = prevp = &base;
 83d:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 844:	0b 00 00 
    base.s.size = 0;
 847:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 84e:	00 00 00 
