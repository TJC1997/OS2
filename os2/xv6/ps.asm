   ...
   1:	31 c0                	xor    %eax,%eax
{
  ...
  22:	e8 d3 02 00 00       	call   2fa <cps>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 349:	0f b6 92 4d 07 00 00 	movzbl 0x74d(%edx),%edx
  }while((x /= base) != 0);
 ...
 3be:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 46f:	e8 fe fd ff ff       	call   272 <write>
        putc(fd, c);
 ...
 489:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 48c:	e8 e1 fd ff ff       	call   272 <write>
  for(i = 0; fmt[i]; i++){
 ...
 4f6:	e8 77 fd ff ff       	call   272 <write>
 ...
 511:	e8 5c fd ff ff       	call   272 <write>
        printint(fd, *ap, 16, 0);
 ...
 52f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 531:	b8 46 07 00 00       	mov    $0x746,%eax
 ...
 58f:	e8 de fc ff ff       	call   272 <write>
        ap++;
 ...
 5b8:	e8 b5 fc ff ff       	call   272 <write>
...
malloc(uint nbytes)
{
 ...
 6ca:	e8 0b fc ff ff       	call   2da <sbrk>
  if(p == (char*)-1)
