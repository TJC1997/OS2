   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  3f:	c7 44 24 04 aa 07 00 	movl   $0x7aa,0x4(%esp)
  46:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 ca 07 00 00 	movzbl 0x7ca(%edx),%edx
  }while((x /= base) != 0);
 ...
 40e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 57f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 581:	b8 c3 07 00 00       	mov    $0x7c3,%eax
...
free(void *ap)
{
 ...
 621:	a1 48 0a 00 00       	mov    0xa48,%eax
{
 ...
 68f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 692:	a3 48 0a 00 00       	mov    %eax,0xa48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 1d 48 0a 00 00    	mov    0xa48,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6fb:	3b 15 48 0a 00 00    	cmp    0xa48,%edx
 ...
 72d:	e8 ee fe ff ff       	call   620 <free>
  return freep;
 732:	8b 15 48 0a 00 00    	mov    0xa48,%edx
 ...
 754:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 757:	89 15 48 0a 00 00    	mov    %edx,0xa48
      return (void*)(p + 1);
 ...
 76c:	eb e9                	jmp    757 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 05 48 0a 00 00 4c 	movl   $0xa4c,0xa48
 775:	0a 00 00 
    base.s.size = 0;
 778:	ba 4c 0a 00 00       	mov    $0xa4c,%edx
    base.s.ptr = freep = prevp = &base;
 77d:	c7 05 4c 0a 00 00 4c 	movl   $0xa4c,0xa4c
 784:	0a 00 00 
    base.s.size = 0;
 787:	c7 05 50 0a 00 00 00 	movl   $0x0,0xa50
 78e:	00 00 00 
