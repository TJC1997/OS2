...
main(int argc, char *argv[])
{
  ...
  2a:	00 
  2b:	c7 44 24 08 98 07 00 	movl   $0x798,0x8(%esp)
  32:	00 
  33:	c7 44 24 04 bc 07 00 	movl   $0x7bc,0x4(%esp)
  3a:	00 
  3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  42:	e8 b9 03 00 00       	call   400 <printf>
  47:	e8 56 02 00 00       	call   2a2 <exit>
        printf(1, "test success: %d %d\n", ppid, cppid);
  4c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  50:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  54:	c7 44 24 04 a6 07 00 	movl   $0x7a6,0x4(%esp)
  5b:	00 
  5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  63:	e8 98 03 00 00       	call   400 <printf>
    }
    wait();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 e7 07 00 00 	movzbl 0x7e7(%edx),%edx
  }while((x /= base) != 0);
 ...
 40e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 57f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 581:	b8 e0 07 00 00       	mov    $0x7e0,%eax
 ...
 621:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 68f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 692:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 1d 5c 0a 00 00    	mov    0xa5c,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6fb:	3b 15 5c 0a 00 00    	cmp    0xa5c,%edx
 ...
 72d:	e8 ee fe ff ff       	call   620 <free>
  return freep;
 732:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 76c:	eb e9                	jmp    757 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 775:	0a 00 00 
    base.s.size = 0;
 778:	ba 60 0a 00 00       	mov    $0xa60,%edx
    base.s.ptr = freep = prevp = &base;
 77d:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 784:	0a 00 00 
    base.s.size = 0;
 787:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 78e:	00 00 00 
